(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();function ic(t,e){const n=Object.create(null),s=t.split(",");for(let i=0;i<s.length;i++)n[s[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const _e={},Ss=[],At=()=>{},Sy=()=>!1,Ay=/^on[^a-z]/,jo=t=>Ay.test(t),rc=t=>t.startsWith("onUpdate:"),Fe=Object.assign,oc=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},ky=Object.prototype.hasOwnProperty,ae=(t,e)=>ky.call(t,e),W=Array.isArray,As=t=>ur(t)==="[object Map]",Ho=t=>ur(t)==="[object Set]",Vu=t=>ur(t)==="[object Date]",ee=t=>typeof t=="function",Me=t=>typeof t=="string",Ui=t=>typeof t=="symbol",ve=t=>t!==null&&typeof t=="object",sf=t=>ve(t)&&ee(t.then)&&ee(t.catch),rf=Object.prototype.toString,ur=t=>rf.call(t),Ry=t=>ur(t).slice(8,-1),of=t=>ur(t)==="[object Object]",ac=t=>Me(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Jr=ic(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),qo=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Dy=/-(\w)/g,Kt=qo(t=>t.replace(Dy,(e,n)=>n?n.toUpperCase():"")),Py=/\B([A-Z])/g,ei=qo(t=>t.replace(Py,"-$1").toLowerCase()),zo=qo(t=>t.charAt(0).toUpperCase()+t.slice(1)),Ma=qo(t=>t?`on${zo(t)}`:""),Fi=(t,e)=>!Object.is(t,e),Xr=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},ho=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},fo=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let ju;const ul=()=>ju||(ju=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function lc(t){if(W(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],i=Me(s)?My(s):lc(s);if(i)for(const r in i)e[r]=i[r]}return e}else{if(Me(t))return t;if(ve(t))return t}}const Ny=/;(?![^(]*\))/g,Oy=/:([^]+)/,xy=/\/\*[^]*?\*\//g;function My(t){const e={};return t.replace(xy,"").split(Ny).forEach(n=>{if(n){const s=n.split(Oy);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Wt(t){let e="";if(Me(t))e=t;else if(W(t))for(let n=0;n<t.length;n++){const s=Wt(t[n]);s&&(e+=s+" ")}else if(ve(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Ly="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Uy=ic(Ly);function af(t){return!!t||t===""}function Fy(t,e){if(t.length!==e.length)return!1;let n=!0;for(let s=0;n&&s<t.length;s++)n=Us(t[s],e[s]);return n}function Us(t,e){if(t===e)return!0;let n=Vu(t),s=Vu(e);if(n||s)return n&&s?t.getTime()===e.getTime():!1;if(n=Ui(t),s=Ui(e),n||s)return t===e;if(n=W(t),s=W(e),n||s)return n&&s?Fy(t,e):!1;if(n=ve(t),s=ve(e),n||s){if(!n||!s)return!1;const i=Object.keys(t).length,r=Object.keys(e).length;if(i!==r)return!1;for(const o in t){const a=t.hasOwnProperty(o),l=e.hasOwnProperty(o);if(a&&!l||!a&&l||!Us(t[o],e[o]))return!1}}return String(t)===String(e)}function $y(t,e){return t.findIndex(n=>Us(n,e))}const oe=t=>Me(t)?t:t==null?"":W(t)||ve(t)&&(t.toString===rf||!ee(t.toString))?JSON.stringify(t,lf,2):String(t),lf=(t,e)=>e&&e.__v_isRef?lf(t,e.value):As(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,i])=>(n[`${s} =>`]=i,n),{})}:Ho(e)?{[`Set(${e.size})`]:[...e.values()]}:ve(e)&&!W(e)&&!of(e)?String(e):e;let Tt;class By{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Tt,!e&&Tt&&(this.index=(Tt.scopes||(Tt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=Tt;try{return Tt=this,e()}finally{Tt=n}}}on(){Tt=this}off(){Tt=this.parent}stop(e){if(this._active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function Vy(t,e=Tt){e&&e.active&&e.effects.push(t)}function jy(){return Tt}const cc=t=>{const e=new Set(t);return e.w=0,e.n=0,e},cf=t=>(t.w&On)>0,uf=t=>(t.n&On)>0,Hy=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=On},qy=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const i=e[s];cf(i)&&!uf(i)?i.delete(t):e[n++]=i,i.w&=~On,i.n&=~On}e.length=n}},hl=new WeakMap;let vi=0,On=1;const dl=30;let Ct;const Xn=Symbol(""),fl=Symbol("");class uc{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Vy(this,s)}run(){if(!this.active)return this.fn();let e=Ct,n=Cn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Ct,Ct=this,Cn=!0,On=1<<++vi,vi<=dl?Hy(this):Hu(this),this.fn()}finally{vi<=dl&&qy(this),On=1<<--vi,Ct=this.parent,Cn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Ct===this?this.deferStop=!0:this.active&&(Hu(this),this.onStop&&this.onStop(),this.active=!1)}}function Hu(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Cn=!0;const hf=[];function ti(){hf.push(Cn),Cn=!1}function ni(){const t=hf.pop();Cn=t===void 0?!0:t}function ft(t,e,n){if(Cn&&Ct){let s=hl.get(t);s||hl.set(t,s=new Map);let i=s.get(n);i||s.set(n,i=cc()),df(i)}}function df(t,e){let n=!1;vi<=dl?uf(t)||(t.n|=On,n=!cf(t)):n=!t.has(Ct),n&&(t.add(Ct),Ct.deps.push(t))}function nn(t,e,n,s,i,r){const o=hl.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&W(t)){const l=Number(s);o.forEach((c,u)=>{(u==="length"||u>=l)&&a.push(c)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":W(t)?ac(n)&&a.push(o.get("length")):(a.push(o.get(Xn)),As(t)&&a.push(o.get(fl)));break;case"delete":W(t)||(a.push(o.get(Xn)),As(t)&&a.push(o.get(fl)));break;case"set":As(t)&&a.push(o.get(Xn));break}if(a.length===1)a[0]&&pl(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);pl(cc(l))}}function pl(t,e){const n=W(t)?t:[...t];for(const s of n)s.computed&&qu(s);for(const s of n)s.computed||qu(s)}function qu(t,e){(t!==Ct||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const zy=ic("__proto__,__v_isRef,__isVue"),ff=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Ui)),Ky=hc(),Wy=hc(!1,!0),Gy=hc(!0),zu=Qy();function Qy(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=ue(this);for(let r=0,o=this.length;r<o;r++)ft(s,"get",r+"");const i=s[e](...n);return i===-1||i===!1?s[e](...n.map(ue)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){ti();const s=ue(this)[e].apply(this,n);return ni(),s}}),t}function Yy(t){const e=ue(this);return ft(e,"has",t),e.hasOwnProperty(t)}function hc(t=!1,e=!1){return function(s,i,r){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&r===(t?e?dv:vf:e?yf:mf).get(s))return s;const o=W(s);if(!t){if(o&&ae(zu,i))return Reflect.get(zu,i,r);if(i==="hasOwnProperty")return Yy}const a=Reflect.get(s,i,r);return(Ui(i)?ff.has(i):zy(i))||(t||ft(s,"get",i),e)?a:tt(a)?o&&ac(i)?a:a.value:ve(a)?t?_f(a):hr(a):a}}const Jy=pf(),Xy=pf(!0);function pf(t=!1){return function(n,s,i,r){let o=n[s];if(Fs(o)&&tt(o)&&!tt(i))return!1;if(!t&&(!po(i)&&!Fs(i)&&(o=ue(o),i=ue(i)),!W(n)&&tt(o)&&!tt(i)))return o.value=i,!0;const a=W(n)&&ac(s)?Number(s)<n.length:ae(n,s),l=Reflect.set(n,s,i,r);return n===ue(r)&&(a?Fi(i,o)&&nn(n,"set",s,i):nn(n,"add",s,i)),l}}function Zy(t,e){const n=ae(t,e);t[e];const s=Reflect.deleteProperty(t,e);return s&&n&&nn(t,"delete",e,void 0),s}function ev(t,e){const n=Reflect.has(t,e);return(!Ui(e)||!ff.has(e))&&ft(t,"has",e),n}function tv(t){return ft(t,"iterate",W(t)?"length":Xn),Reflect.ownKeys(t)}const gf={get:Ky,set:Jy,deleteProperty:Zy,has:ev,ownKeys:tv},nv={get:Gy,set(t,e){return!0},deleteProperty(t,e){return!0}},sv=Fe({},gf,{get:Wy,set:Xy}),dc=t=>t,Ko=t=>Reflect.getPrototypeOf(t);function Mr(t,e,n=!1,s=!1){t=t.__v_raw;const i=ue(t),r=ue(e);n||(e!==r&&ft(i,"get",e),ft(i,"get",r));const{has:o}=Ko(i),a=s?dc:n?gc:$i;if(o.call(i,e))return a(t.get(e));if(o.call(i,r))return a(t.get(r));t!==i&&t.get(e)}function Lr(t,e=!1){const n=this.__v_raw,s=ue(n),i=ue(t);return e||(t!==i&&ft(s,"has",t),ft(s,"has",i)),t===i?n.has(t):n.has(t)||n.has(i)}function Ur(t,e=!1){return t=t.__v_raw,!e&&ft(ue(t),"iterate",Xn),Reflect.get(t,"size",t)}function Ku(t){t=ue(t);const e=ue(this);return Ko(e).has.call(e,t)||(e.add(t),nn(e,"add",t,t)),this}function Wu(t,e){e=ue(e);const n=ue(this),{has:s,get:i}=Ko(n);let r=s.call(n,t);r||(t=ue(t),r=s.call(n,t));const o=i.call(n,t);return n.set(t,e),r?Fi(e,o)&&nn(n,"set",t,e):nn(n,"add",t,e),this}function Gu(t){const e=ue(this),{has:n,get:s}=Ko(e);let i=n.call(e,t);i||(t=ue(t),i=n.call(e,t)),s&&s.call(e,t);const r=e.delete(t);return i&&nn(e,"delete",t,void 0),r}function Qu(){const t=ue(this),e=t.size!==0,n=t.clear();return e&&nn(t,"clear",void 0,void 0),n}function Fr(t,e){return function(s,i){const r=this,o=r.__v_raw,a=ue(o),l=e?dc:t?gc:$i;return!t&&ft(a,"iterate",Xn),o.forEach((c,u)=>s.call(i,l(c),l(u),r))}}function $r(t,e,n){return function(...s){const i=this.__v_raw,r=ue(i),o=As(r),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=i[t](...s),u=n?dc:e?gc:$i;return!e&&ft(r,"iterate",l?fl:Xn),{next(){const{value:d,done:f}=c.next();return f?{value:d,done:f}:{value:a?[u(d[0]),u(d[1])]:u(d),done:f}},[Symbol.iterator](){return this}}}}function fn(t){return function(...e){return t==="delete"?!1:this}}function iv(){const t={get(r){return Mr(this,r)},get size(){return Ur(this)},has:Lr,add:Ku,set:Wu,delete:Gu,clear:Qu,forEach:Fr(!1,!1)},e={get(r){return Mr(this,r,!1,!0)},get size(){return Ur(this)},has:Lr,add:Ku,set:Wu,delete:Gu,clear:Qu,forEach:Fr(!1,!0)},n={get(r){return Mr(this,r,!0)},get size(){return Ur(this,!0)},has(r){return Lr.call(this,r,!0)},add:fn("add"),set:fn("set"),delete:fn("delete"),clear:fn("clear"),forEach:Fr(!0,!1)},s={get(r){return Mr(this,r,!0,!0)},get size(){return Ur(this,!0)},has(r){return Lr.call(this,r,!0)},add:fn("add"),set:fn("set"),delete:fn("delete"),clear:fn("clear"),forEach:Fr(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=$r(r,!1,!1),n[r]=$r(r,!0,!1),e[r]=$r(r,!1,!0),s[r]=$r(r,!0,!0)}),[t,n,e,s]}const[rv,ov,av,lv]=iv();function fc(t,e){const n=e?t?lv:av:t?ov:rv;return(s,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?s:Reflect.get(ae(n,i)&&i in s?n:s,i,r)}const cv={get:fc(!1,!1)},uv={get:fc(!1,!0)},hv={get:fc(!0,!1)},mf=new WeakMap,yf=new WeakMap,vf=new WeakMap,dv=new WeakMap;function fv(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function pv(t){return t.__v_skip||!Object.isExtensible(t)?0:fv(Ry(t))}function hr(t){return Fs(t)?t:pc(t,!1,gf,cv,mf)}function gv(t){return pc(t,!1,sv,uv,yf)}function _f(t){return pc(t,!0,nv,hv,vf)}function pc(t,e,n,s,i){if(!ve(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const o=pv(t);if(o===0)return t;const a=new Proxy(t,o===2?s:n);return i.set(t,a),a}function ks(t){return Fs(t)?ks(t.__v_raw):!!(t&&t.__v_isReactive)}function Fs(t){return!!(t&&t.__v_isReadonly)}function po(t){return!!(t&&t.__v_isShallow)}function wf(t){return ks(t)||Fs(t)}function ue(t){const e=t&&t.__v_raw;return e?ue(e):t}function bf(t){return ho(t,"__v_skip",!0),t}const $i=t=>ve(t)?hr(t):t,gc=t=>ve(t)?_f(t):t;function Ef(t){Cn&&Ct&&(t=ue(t),df(t.dep||(t.dep=cc())))}function If(t,e){t=ue(t);const n=t.dep;n&&pl(n)}function tt(t){return!!(t&&t.__v_isRef===!0)}function In(t){return Tf(t,!1)}function mv(t){return Tf(t,!0)}function Tf(t,e){return tt(t)?t:new yv(t,e)}class yv{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ue(e),this._value=n?e:$i(e)}get value(){return Ef(this),this._value}set value(e){const n=this.__v_isShallow||po(e)||Fs(e);e=n?e:ue(e),Fi(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:$i(e),If(this))}}function Rs(t){return tt(t)?t.value:t}const vv={get:(t,e,n)=>Rs(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const i=t[e];return tt(i)&&!tt(n)?(i.value=n,!0):Reflect.set(t,e,n,s)}};function Cf(t){return ks(t)?t:new Proxy(t,vv)}class _v{constructor(e,n,s,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new uc(e,()=>{this._dirty||(this._dirty=!0,If(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=s}get value(){const e=ue(this);return Ef(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function wv(t,e,n=!1){let s,i;const r=ee(t);return r?(s=t,i=At):(s=t.get,i=t.set),new _v(s,i,r||!i,n)}function Sn(t,e,n,s){let i;try{i=s?t(...s):t()}catch(r){Wo(r,e,n)}return i}function kt(t,e,n,s){if(ee(t)){const r=Sn(t,e,n,s);return r&&sf(r)&&r.catch(o=>{Wo(o,e,n)}),r}const i=[];for(let r=0;r<t.length;r++)i.push(kt(t[r],e,n,s));return i}function Wo(t,e,n,s=!0){const i=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,a=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}r=r.parent}const l=e.appContext.config.errorHandler;if(l){Sn(l,null,10,[t,o,a]);return}}bv(t,n,i,s)}function bv(t,e,n,s=!0){console.error(t)}let Bi=!1,gl=!1;const Ze=[];let Ft=0;const Ds=[];let Xt=null,zn=0;const Sf=Promise.resolve();let mc=null;function yc(t){const e=mc||Sf;return t?e.then(this?t.bind(this):t):e}function Ev(t){let e=Ft+1,n=Ze.length;for(;e<n;){const s=e+n>>>1;Vi(Ze[s])<t?e=s+1:n=s}return e}function vc(t){(!Ze.length||!Ze.includes(t,Bi&&t.allowRecurse?Ft+1:Ft))&&(t.id==null?Ze.push(t):Ze.splice(Ev(t.id),0,t),Af())}function Af(){!Bi&&!gl&&(gl=!0,mc=Sf.then(Rf))}function Iv(t){const e=Ze.indexOf(t);e>Ft&&Ze.splice(e,1)}function Tv(t){W(t)?Ds.push(...t):(!Xt||!Xt.includes(t,t.allowRecurse?zn+1:zn))&&Ds.push(t),Af()}function Yu(t,e=Bi?Ft+1:0){for(;e<Ze.length;e++){const n=Ze[e];n&&n.pre&&(Ze.splice(e,1),e--,n())}}function kf(t){if(Ds.length){const e=[...new Set(Ds)];if(Ds.length=0,Xt){Xt.push(...e);return}for(Xt=e,Xt.sort((n,s)=>Vi(n)-Vi(s)),zn=0;zn<Xt.length;zn++)Xt[zn]();Xt=null,zn=0}}const Vi=t=>t.id==null?1/0:t.id,Cv=(t,e)=>{const n=Vi(t)-Vi(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Rf(t){gl=!1,Bi=!0,Ze.sort(Cv);const e=At;try{for(Ft=0;Ft<Ze.length;Ft++){const n=Ze[Ft];n&&n.active!==!1&&Sn(n,null,14)}}finally{Ft=0,Ze.length=0,kf(),Bi=!1,mc=null,(Ze.length||Ds.length)&&Rf()}}function Sv(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||_e;let i=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in s){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:d,trim:f}=s[u]||_e;f&&(i=n.map(m=>Me(m)?m.trim():m)),d&&(i=n.map(fo))}let a,l=s[a=Ma(e)]||s[a=Ma(Kt(e))];!l&&r&&(l=s[a=Ma(ei(e))]),l&&kt(l,t,6,i);const c=s[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,kt(c,t,6,i)}}function Df(t,e,n=!1){const s=e.emitsCache,i=s.get(t);if(i!==void 0)return i;const r=t.emits;let o={},a=!1;if(!ee(t)){const l=c=>{const u=Df(c,e,!0);u&&(a=!0,Fe(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!r&&!a?(ve(t)&&s.set(t,null),null):(W(r)?r.forEach(l=>o[l]=null):Fe(o,r),ve(t)&&s.set(t,o),o)}function Go(t,e){return!t||!jo(e)?!1:(e=e.slice(2).replace(/Once$/,""),ae(t,e[0].toLowerCase()+e.slice(1))||ae(t,ei(e))||ae(t,e))}let Et=null,Pf=null;function go(t){const e=Et;return Et=t,Pf=t&&t.type.__scopeId||null,e}function Av(t,e=Et,n){if(!e||t._n)return t;const s=(...i)=>{s._d&&ah(-1);const r=go(e);let o;try{o=t(...i)}finally{go(r),s._d&&ah(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function La(t){const{type:e,vnode:n,proxy:s,withProxy:i,props:r,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:d,data:f,setupState:m,ctx:w,inheritAttrs:E}=t;let A,N;const O=go(t);try{if(n.shapeFlag&4){const F=i||s;A=Ut(u.call(F,F,d,r,m,f,w)),N=l}else{const F=e;A=Ut(F.length>1?F(r,{attrs:l,slots:a,emit:c}):F(r,null)),N=e.props?l:kv(l)}}catch(F){ki.length=0,Wo(F,t,1),A=Ne(ns)}let K=A;if(N&&E!==!1){const F=Object.keys(N),{shapeFlag:Ie}=K;F.length&&Ie&7&&(o&&F.some(rc)&&(N=Rv(N,o)),K=$s(K,N))}return n.dirs&&(K=$s(K),K.dirs=K.dirs?K.dirs.concat(n.dirs):n.dirs),n.transition&&(K.transition=n.transition),A=K,go(O),A}const kv=t=>{let e;for(const n in t)(n==="class"||n==="style"||jo(n))&&((e||(e={}))[n]=t[n]);return e},Rv=(t,e)=>{const n={};for(const s in t)(!rc(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function Dv(t,e,n){const{props:s,children:i,component:r}=t,{props:o,children:a,patchFlag:l}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return s?Ju(s,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let d=0;d<u.length;d++){const f=u[d];if(o[f]!==s[f]&&!Go(c,f))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Ju(s,o,c):!0:!!o;return!1}function Ju(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(e[r]!==t[r]&&!Go(n,r))return!0}return!1}function Pv({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const Nv=t=>t.__isSuspense;function Ov(t,e){e&&e.pendingBranch?W(t)?e.effects.push(...t):e.effects.push(t):Tv(t)}const Br={};function Si(t,e,n){return Nf(t,e,n)}function Nf(t,e,{immediate:n,deep:s,flush:i,onTrack:r,onTrigger:o}=_e){var a;const l=jy()===((a=qe)==null?void 0:a.scope)?qe:null;let c,u=!1,d=!1;if(tt(t)?(c=()=>t.value,u=po(t)):ks(t)?(c=()=>t,s=!0):W(t)?(d=!0,u=t.some(F=>ks(F)||po(F)),c=()=>t.map(F=>{if(tt(F))return F.value;if(ks(F))return Wn(F);if(ee(F))return Sn(F,l,2)})):ee(t)?e?c=()=>Sn(t,l,2):c=()=>{if(!(l&&l.isUnmounted))return f&&f(),kt(t,l,3,[m])}:c=At,e&&s){const F=c;c=()=>Wn(F())}let f,m=F=>{f=O.onStop=()=>{Sn(F,l,4)}},w;if(Hi)if(m=At,e?n&&kt(e,l,3,[c(),d?[]:void 0,m]):c(),i==="sync"){const F=S_();w=F.__watcherHandles||(F.__watcherHandles=[])}else return At;let E=d?new Array(t.length).fill(Br):Br;const A=()=>{if(O.active)if(e){const F=O.run();(s||u||(d?F.some((Ie,Ce)=>Fi(Ie,E[Ce])):Fi(F,E)))&&(f&&f(),kt(e,l,3,[F,E===Br?void 0:d&&E[0]===Br?[]:E,m]),E=F)}else O.run()};A.allowRecurse=!!e;let N;i==="sync"?N=A:i==="post"?N=()=>ut(A,l&&l.suspense):(A.pre=!0,l&&(A.id=l.uid),N=()=>vc(A));const O=new uc(c,N);e?n?A():E=O.run():i==="post"?ut(O.run.bind(O),l&&l.suspense):O.run();const K=()=>{O.stop(),l&&l.scope&&oc(l.scope.effects,O)};return w&&w.push(K),K}function xv(t,e,n){const s=this.proxy,i=Me(t)?t.includes(".")?Of(s,t):()=>s[t]:t.bind(s,s);let r;ee(e)?r=e:(r=e.handler,n=e);const o=qe;Bs(this);const a=Nf(i,r.bind(s),n);return o?Bs(o):Zn(),a}function Of(t,e){const n=e.split(".");return()=>{let s=t;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}function Wn(t,e){if(!ve(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),tt(t))Wn(t.value,e);else if(W(t))for(let n=0;n<t.length;n++)Wn(t[n],e);else if(Ho(t)||As(t))t.forEach(n=>{Wn(n,e)});else if(of(t))for(const n in t)Wn(t[n],e);return t}function te(t,e){const n=Et;if(n===null)return t;const s=Xo(n)||n.proxy,i=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[o,a,l,c=_e]=e[r];o&&(ee(o)&&(o={mounted:o,updated:o}),o.deep&&Wn(a),i.push({dir:o,instance:s,value:a,oldValue:void 0,arg:l,modifiers:c}))}return t}function jn(t,e,n,s){const i=t.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let l=a.dir[s];l&&(ti(),kt(l,n,8,[t.el,a,t,e]),ni())}}function xf(t,e){return ee(t)?(()=>Fe({name:t.name},e,{setup:t}))():t}const Zr=t=>!!t.type.__asyncLoader,Mf=t=>t.type.__isKeepAlive;function Mv(t,e){Lf(t,"a",e)}function Lv(t,e){Lf(t,"da",e)}function Lf(t,e,n=qe){const s=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(Qo(e,s,n),n){let i=n.parent;for(;i&&i.parent;)Mf(i.parent.vnode)&&Uv(s,e,n,i),i=i.parent}}function Uv(t,e,n,s){const i=Qo(e,t,s,!0);Uf(()=>{oc(s[e],i)},n)}function Qo(t,e,n=qe,s=!1){if(n){const i=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;ti(),Bs(n);const a=kt(e,n,t,o);return Zn(),ni(),a});return s?i.unshift(r):i.push(r),r}}const cn=t=>(e,n=qe)=>(!Hi||t==="sp")&&Qo(t,(...s)=>e(...s),n),Fv=cn("bm"),_c=cn("m"),$v=cn("bu"),Bv=cn("u"),Vv=cn("bum"),Uf=cn("um"),jv=cn("sp"),Hv=cn("rtg"),qv=cn("rtc");function zv(t,e=qe){Qo("ec",t,e)}const Ff="components";function wc(t,e){return Wv(Ff,t,!0,e)||t}const Kv=Symbol.for("v-ndc");function Wv(t,e,n=!0,s=!1){const i=Et||qe;if(i){const r=i.type;if(t===Ff){const a=I_(r,!1);if(a&&(a===e||a===Kt(e)||a===zo(Kt(e))))return r}const o=Xu(i[t]||r[t],e)||Xu(i.appContext[t],e);return!o&&s?r:o}}function Xu(t,e){return t&&(t[e]||t[Kt(e)]||t[zo(Kt(e))])}function Gn(t,e,n,s){let i;const r=n&&n[s];if(W(t)||Me(t)){i=new Array(t.length);for(let o=0,a=t.length;o<a;o++)i[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r&&r[o])}else if(ve(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,r&&r[a]));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];i[a]=e(t[c],c,a,r&&r[a])}}else i=[];return n&&(n[s]=i),i}const ml=t=>t?Qf(t)?Xo(t)||t.proxy:ml(t.parent):null,Ai=Fe(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>ml(t.parent),$root:t=>ml(t.root),$emit:t=>t.emit,$options:t=>bc(t),$forceUpdate:t=>t.f||(t.f=()=>vc(t.update)),$nextTick:t=>t.n||(t.n=yc.bind(t.proxy)),$watch:t=>xv.bind(t)}),Ua=(t,e)=>t!==_e&&!t.__isScriptSetup&&ae(t,e),Gv={get({_:t},e){const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const m=o[e];if(m!==void 0)switch(m){case 1:return s[e];case 2:return i[e];case 4:return n[e];case 3:return r[e]}else{if(Ua(s,e))return o[e]=1,s[e];if(i!==_e&&ae(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&ae(c,e))return o[e]=3,r[e];if(n!==_e&&ae(n,e))return o[e]=4,n[e];yl&&(o[e]=0)}}const u=Ai[e];let d,f;if(u)return e==="$attrs"&&ft(t,"get",e),u(t);if((d=a.__cssModules)&&(d=d[e]))return d;if(n!==_e&&ae(n,e))return o[e]=4,n[e];if(f=l.config.globalProperties,ae(f,e))return f[e]},set({_:t},e,n){const{data:s,setupState:i,ctx:r}=t;return Ua(i,e)?(i[e]=n,!0):s!==_e&&ae(s,e)?(s[e]=n,!0):ae(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:i,propsOptions:r}},o){let a;return!!n[o]||t!==_e&&ae(t,o)||Ua(e,o)||(a=r[0])&&ae(a,o)||ae(s,o)||ae(Ai,o)||ae(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:ae(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function Zu(t){return W(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let yl=!0;function Qv(t){const e=bc(t),n=t.proxy,s=t.ctx;yl=!1,e.beforeCreate&&eh(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:d,mounted:f,beforeUpdate:m,updated:w,activated:E,deactivated:A,beforeDestroy:N,beforeUnmount:O,destroyed:K,unmounted:F,render:Ie,renderTracked:Ce,renderTriggered:Ge,errorCaptured:pt,serverPrefetch:gt,expose:wt,inheritAttrs:hn,components:Vn,directives:Ot,filters:di}=e;if(c&&Yv(c,s,null),o)for(const me in o){const he=o[me];ee(he)&&(s[me]=he.bind(n))}if(i){const me=i.call(n,n);ve(me)&&(t.data=hr(me))}if(yl=!0,r)for(const me in r){const he=r[me],Yt=ee(he)?he.bind(n,n):ee(he.get)?he.get.bind(n,n):At,dn=!ee(he)&&ee(he.set)?he.set.bind(n):At,xt=yt({get:Yt,set:dn});Object.defineProperty(s,me,{enumerable:!0,configurable:!0,get:()=>xt.value,set:ct=>xt.value=ct})}if(a)for(const me in a)$f(a[me],s,n,me);if(l){const me=ee(l)?l.call(n):l;Reflect.ownKeys(me).forEach(he=>{eo(he,me[he])})}u&&eh(u,t,"c");function Le(me,he){W(he)?he.forEach(Yt=>me(Yt.bind(n))):he&&me(he.bind(n))}if(Le(Fv,d),Le(_c,f),Le($v,m),Le(Bv,w),Le(Mv,E),Le(Lv,A),Le(zv,pt),Le(qv,Ce),Le(Hv,Ge),Le(Vv,O),Le(Uf,F),Le(jv,gt),W(wt))if(wt.length){const me=t.exposed||(t.exposed={});wt.forEach(he=>{Object.defineProperty(me,he,{get:()=>n[he],set:Yt=>n[he]=Yt})})}else t.exposed||(t.exposed={});Ie&&t.render===At&&(t.render=Ie),hn!=null&&(t.inheritAttrs=hn),Vn&&(t.components=Vn),Ot&&(t.directives=Ot)}function Yv(t,e,n=At){W(t)&&(t=vl(t));for(const s in t){const i=t[s];let r;ve(i)?"default"in i?r=jt(i.from||s,i.default,!0):r=jt(i.from||s):r=jt(i),tt(r)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[s]=r}}function eh(t,e,n){kt(W(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function $f(t,e,n,s){const i=s.includes(".")?Of(n,s):()=>n[s];if(Me(t)){const r=e[t];ee(r)&&Si(i,r)}else if(ee(t))Si(i,t.bind(n));else if(ve(t))if(W(t))t.forEach(r=>$f(r,e,n,s));else{const r=ee(t.handler)?t.handler.bind(n):e[t.handler];ee(r)&&Si(i,r,t)}}function bc(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,a=r.get(e);let l;return a?l=a:!i.length&&!n&&!s?l=e:(l={},i.length&&i.forEach(c=>mo(l,c,o,!0)),mo(l,e,o)),ve(e)&&r.set(e,l),l}function mo(t,e,n,s=!1){const{mixins:i,extends:r}=e;r&&mo(t,r,n,!0),i&&i.forEach(o=>mo(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const a=Jv[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Jv={data:th,props:nh,emits:nh,methods:_i,computed:_i,beforeCreate:at,created:at,beforeMount:at,mounted:at,beforeUpdate:at,updated:at,beforeDestroy:at,beforeUnmount:at,destroyed:at,unmounted:at,activated:at,deactivated:at,errorCaptured:at,serverPrefetch:at,components:_i,directives:_i,watch:Zv,provide:th,inject:Xv};function th(t,e){return e?t?function(){return Fe(ee(t)?t.call(this,this):t,ee(e)?e.call(this,this):e)}:e:t}function Xv(t,e){return _i(vl(t),vl(e))}function vl(t){if(W(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function at(t,e){return t?[...new Set([].concat(t,e))]:e}function _i(t,e){return t?Fe(Object.create(null),t,e):e}function nh(t,e){return t?W(t)&&W(e)?[...new Set([...t,...e])]:Fe(Object.create(null),Zu(t),Zu(e??{})):e}function Zv(t,e){if(!t)return e;if(!e)return t;const n=Fe(Object.create(null),t);for(const s in e)n[s]=at(t[s],e[s]);return n}function Bf(){return{app:null,config:{isNativeTag:Sy,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let e_=0;function t_(t,e){return function(s,i=null){ee(s)||(s=Fe({},s)),i!=null&&!ve(i)&&(i=null);const r=Bf(),o=new Set;let a=!1;const l=r.app={_uid:e_++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:A_,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&ee(c.install)?(o.add(c),c.install(l,...u)):ee(c)&&(o.add(c),c(l,...u))),l},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),l},component(c,u){return u?(r.components[c]=u,l):r.components[c]},directive(c,u){return u?(r.directives[c]=u,l):r.directives[c]},mount(c,u,d){if(!a){const f=Ne(s,i);return f.appContext=r,u&&e?e(f,c):t(f,c,d),a=!0,l._container=c,c.__vue_app__=l,Xo(f.component)||f.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return r.provides[c]=u,l},runWithContext(c){yo=l;try{return c()}finally{yo=null}}};return l}}let yo=null;function eo(t,e){if(qe){let n=qe.provides;const s=qe.parent&&qe.parent.provides;s===n&&(n=qe.provides=Object.create(s)),n[t]=e}}function jt(t,e,n=!1){const s=qe||Et;if(s||yo){const i=s?s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:yo._context.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&ee(e)?e.call(s&&s.proxy):e}}function n_(t,e,n,s=!1){const i={},r={};ho(r,Jo,1),t.propsDefaults=Object.create(null),Vf(t,e,i,r);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=s?i:gv(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function s_(t,e,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=t,a=ue(i),[l]=t.propsOptions;let c=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let d=0;d<u.length;d++){let f=u[d];if(Go(t.emitsOptions,f))continue;const m=e[f];if(l)if(ae(r,f))m!==r[f]&&(r[f]=m,c=!0);else{const w=Kt(f);i[w]=_l(l,a,w,m,t,!1)}else m!==r[f]&&(r[f]=m,c=!0)}}}else{Vf(t,e,i,r)&&(c=!0);let u;for(const d in a)(!e||!ae(e,d)&&((u=ei(d))===d||!ae(e,u)))&&(l?n&&(n[d]!==void 0||n[u]!==void 0)&&(i[d]=_l(l,a,d,void 0,t,!0)):delete i[d]);if(r!==a)for(const d in r)(!e||!ae(e,d))&&(delete r[d],c=!0)}c&&nn(t,"set","$attrs")}function Vf(t,e,n,s){const[i,r]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Jr(l))continue;const c=e[l];let u;i&&ae(i,u=Kt(l))?!r||!r.includes(u)?n[u]=c:(a||(a={}))[u]=c:Go(t.emitsOptions,l)||(!(l in s)||c!==s[l])&&(s[l]=c,o=!0)}if(r){const l=ue(n),c=a||_e;for(let u=0;u<r.length;u++){const d=r[u];n[d]=_l(i,l,d,c[d],t,!ae(c,d))}}return o}function _l(t,e,n,s,i,r){const o=t[n];if(o!=null){const a=ae(o,"default");if(a&&s===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&ee(l)){const{propsDefaults:c}=i;n in c?s=c[n]:(Bs(i),s=c[n]=l.call(null,e),Zn())}else s=l}o[0]&&(r&&!a?s=!1:o[1]&&(s===""||s===ei(n))&&(s=!0))}return s}function jf(t,e,n=!1){const s=e.propsCache,i=s.get(t);if(i)return i;const r=t.props,o={},a=[];let l=!1;if(!ee(t)){const u=d=>{l=!0;const[f,m]=jf(d,e,!0);Fe(o,f),m&&a.push(...m)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!l)return ve(t)&&s.set(t,Ss),Ss;if(W(r))for(let u=0;u<r.length;u++){const d=Kt(r[u]);sh(d)&&(o[d]=_e)}else if(r)for(const u in r){const d=Kt(u);if(sh(d)){const f=r[u],m=o[d]=W(f)||ee(f)?{type:f}:Fe({},f);if(m){const w=oh(Boolean,m.type),E=oh(String,m.type);m[0]=w>-1,m[1]=E<0||w<E,(w>-1||ae(m,"default"))&&a.push(d)}}}const c=[o,a];return ve(t)&&s.set(t,c),c}function sh(t){return t[0]!=="$"}function ih(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function rh(t,e){return ih(t)===ih(e)}function oh(t,e){return W(e)?e.findIndex(n=>rh(n,t)):ee(e)&&rh(e,t)?0:-1}const Hf=t=>t[0]==="_"||t==="$stable",Ec=t=>W(t)?t.map(Ut):[Ut(t)],i_=(t,e,n)=>{if(e._n)return e;const s=Av((...i)=>Ec(e(...i)),n);return s._c=!1,s},qf=(t,e,n)=>{const s=t._ctx;for(const i in t){if(Hf(i))continue;const r=t[i];if(ee(r))e[i]=i_(i,r,s);else if(r!=null){const o=Ec(r);e[i]=()=>o}}},zf=(t,e)=>{const n=Ec(e);t.slots.default=()=>n},r_=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ue(e),ho(e,"_",n)):qf(e,t.slots={})}else t.slots={},e&&zf(t,e);ho(t.slots,Jo,1)},o_=(t,e,n)=>{const{vnode:s,slots:i}=t;let r=!0,o=_e;if(s.shapeFlag&32){const a=e._;a?n&&a===1?r=!1:(Fe(i,e),!n&&a===1&&delete i._):(r=!e.$stable,qf(e,i)),o=e}else e&&(zf(t,e),o={default:1});if(r)for(const a in i)!Hf(a)&&!(a in o)&&delete i[a]};function wl(t,e,n,s,i=!1){if(W(t)){t.forEach((f,m)=>wl(f,e&&(W(e)?e[m]:e),n,s,i));return}if(Zr(s)&&!i)return;const r=s.shapeFlag&4?Xo(s.component)||s.component.proxy:s.el,o=i?null:r,{i:a,r:l}=t,c=e&&e.r,u=a.refs===_e?a.refs={}:a.refs,d=a.setupState;if(c!=null&&c!==l&&(Me(c)?(u[c]=null,ae(d,c)&&(d[c]=null)):tt(c)&&(c.value=null)),ee(l))Sn(l,a,12,[o,u]);else{const f=Me(l),m=tt(l);if(f||m){const w=()=>{if(t.f){const E=f?ae(d,l)?d[l]:u[l]:l.value;i?W(E)&&oc(E,r):W(E)?E.includes(r)||E.push(r):f?(u[l]=[r],ae(d,l)&&(d[l]=u[l])):(l.value=[r],t.k&&(u[t.k]=l.value))}else f?(u[l]=o,ae(d,l)&&(d[l]=o)):m&&(l.value=o,t.k&&(u[t.k]=o))};o?(w.id=-1,ut(w,n)):w()}}}const ut=Ov;function a_(t){return l_(t)}function l_(t,e){const n=ul();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:d,nextSibling:f,setScopeId:m=At,insertStaticContent:w}=t,E=(p,g,y,v=null,b=null,I=null,x=!1,k=null,R=!!g.dynamicChildren)=>{if(p===g)return;p&&!pi(p,g)&&(v=_(p),ct(p,b,I,!0),p=null),g.patchFlag===-2&&(R=!1,g.dynamicChildren=null);const{type:C,ref:j,shapeFlag:$}=g;switch(C){case Yo:A(p,g,y,v);break;case ns:N(p,g,y,v);break;case to:p==null&&O(g,y,v,x);break;case ke:Vn(p,g,y,v,b,I,x,k,R);break;default:$&1?Ie(p,g,y,v,b,I,x,k,R):$&6?Ot(p,g,y,v,b,I,x,k,R):($&64||$&128)&&C.process(p,g,y,v,b,I,x,k,R,D)}j!=null&&b&&wl(j,p&&p.ref,I,g||p,!g)},A=(p,g,y,v)=>{if(p==null)s(g.el=a(g.children),y,v);else{const b=g.el=p.el;g.children!==p.children&&c(b,g.children)}},N=(p,g,y,v)=>{p==null?s(g.el=l(g.children||""),y,v):g.el=p.el},O=(p,g,y,v)=>{[p.el,p.anchor]=w(p.children,g,y,v,p.el,p.anchor)},K=({el:p,anchor:g},y,v)=>{let b;for(;p&&p!==g;)b=f(p),s(p,y,v),p=b;s(g,y,v)},F=({el:p,anchor:g})=>{let y;for(;p&&p!==g;)y=f(p),i(p),p=y;i(g)},Ie=(p,g,y,v,b,I,x,k,R)=>{x=x||g.type==="svg",p==null?Ce(g,y,v,b,I,x,k,R):gt(p,g,b,I,x,k,R)},Ce=(p,g,y,v,b,I,x,k)=>{let R,C;const{type:j,props:$,shapeFlag:H,transition:J,dirs:ne}=p;if(R=p.el=o(p.type,I,$&&$.is,$),H&8?u(R,p.children):H&16&&pt(p.children,R,null,v,b,I&&j!=="foreignObject",x,k),ne&&jn(p,null,v,"created"),Ge(R,p,p.scopeId,x,v),$){for(const ge in $)ge!=="value"&&!Jr(ge)&&r(R,ge,null,$[ge],I,p.children,v,b,Qe);"value"in $&&r(R,"value",null,$.value),(C=$.onVnodeBeforeMount)&&Lt(C,v,p)}ne&&jn(p,null,v,"beforeMount");const ye=(!b||b&&!b.pendingBranch)&&J&&!J.persisted;ye&&J.beforeEnter(R),s(R,g,y),((C=$&&$.onVnodeMounted)||ye||ne)&&ut(()=>{C&&Lt(C,v,p),ye&&J.enter(R),ne&&jn(p,null,v,"mounted")},b)},Ge=(p,g,y,v,b)=>{if(y&&m(p,y),v)for(let I=0;I<v.length;I++)m(p,v[I]);if(b){let I=b.subTree;if(g===I){const x=b.vnode;Ge(p,x,x.scopeId,x.slotScopeIds,b.parent)}}},pt=(p,g,y,v,b,I,x,k,R=0)=>{for(let C=R;C<p.length;C++){const j=p[C]=k?mn(p[C]):Ut(p[C]);E(null,j,g,y,v,b,I,x,k)}},gt=(p,g,y,v,b,I,x)=>{const k=g.el=p.el;let{patchFlag:R,dynamicChildren:C,dirs:j}=g;R|=p.patchFlag&16;const $=p.props||_e,H=g.props||_e;let J;y&&Hn(y,!1),(J=H.onVnodeBeforeUpdate)&&Lt(J,y,g,p),j&&jn(g,p,y,"beforeUpdate"),y&&Hn(y,!0);const ne=b&&g.type!=="foreignObject";if(C?wt(p.dynamicChildren,C,k,y,v,ne,I):x||he(p,g,k,null,y,v,ne,I,!1),R>0){if(R&16)hn(k,g,$,H,y,v,b);else if(R&2&&$.class!==H.class&&r(k,"class",null,H.class,b),R&4&&r(k,"style",$.style,H.style,b),R&8){const ye=g.dynamicProps;for(let ge=0;ge<ye.length;ge++){const Re=ye[ge],It=$[Re],vs=H[Re];(vs!==It||Re==="value")&&r(k,Re,It,vs,b,p.children,y,v,Qe)}}R&1&&p.children!==g.children&&u(k,g.children)}else!x&&C==null&&hn(k,g,$,H,y,v,b);((J=H.onVnodeUpdated)||j)&&ut(()=>{J&&Lt(J,y,g,p),j&&jn(g,p,y,"updated")},v)},wt=(p,g,y,v,b,I,x)=>{for(let k=0;k<g.length;k++){const R=p[k],C=g[k],j=R.el&&(R.type===ke||!pi(R,C)||R.shapeFlag&70)?d(R.el):y;E(R,C,j,null,v,b,I,x,!0)}},hn=(p,g,y,v,b,I,x)=>{if(y!==v){if(y!==_e)for(const k in y)!Jr(k)&&!(k in v)&&r(p,k,y[k],null,x,g.children,b,I,Qe);for(const k in v){if(Jr(k))continue;const R=v[k],C=y[k];R!==C&&k!=="value"&&r(p,k,C,R,x,g.children,b,I,Qe)}"value"in v&&r(p,"value",y.value,v.value)}},Vn=(p,g,y,v,b,I,x,k,R)=>{const C=g.el=p?p.el:a(""),j=g.anchor=p?p.anchor:a("");let{patchFlag:$,dynamicChildren:H,slotScopeIds:J}=g;J&&(k=k?k.concat(J):J),p==null?(s(C,y,v),s(j,y,v),pt(g.children,y,j,b,I,x,k,R)):$>0&&$&64&&H&&p.dynamicChildren?(wt(p.dynamicChildren,H,y,b,I,x,k),(g.key!=null||b&&g===b.subTree)&&Kf(p,g,!0)):he(p,g,y,j,b,I,x,k,R)},Ot=(p,g,y,v,b,I,x,k,R)=>{g.slotScopeIds=k,p==null?g.shapeFlag&512?b.ctx.activate(g,y,v,x,R):di(g,y,v,b,I,x,R):gs(p,g,R)},di=(p,g,y,v,b,I,x)=>{const k=p.component=v_(p,v,b);if(Mf(p)&&(k.ctx.renderer=D),__(k),k.asyncDep){if(b&&b.registerDep(k,Le),!p.el){const R=k.subTree=Ne(ns);N(null,R,g,y)}return}Le(k,p,g,y,b,I,x)},gs=(p,g,y)=>{const v=g.component=p.component;if(Dv(p,g,y))if(v.asyncDep&&!v.asyncResolved){me(v,g,y);return}else v.next=g,Iv(v.update),v.update();else g.el=p.el,v.vnode=g},Le=(p,g,y,v,b,I,x)=>{const k=()=>{if(p.isMounted){let{next:j,bu:$,u:H,parent:J,vnode:ne}=p,ye=j,ge;Hn(p,!1),j?(j.el=ne.el,me(p,j,x)):j=ne,$&&Xr($),(ge=j.props&&j.props.onVnodeBeforeUpdate)&&Lt(ge,J,j,ne),Hn(p,!0);const Re=La(p),It=p.subTree;p.subTree=Re,E(It,Re,d(It.el),_(It),p,b,I),j.el=Re.el,ye===null&&Pv(p,Re.el),H&&ut(H,b),(ge=j.props&&j.props.onVnodeUpdated)&&ut(()=>Lt(ge,J,j,ne),b)}else{let j;const{el:$,props:H}=g,{bm:J,m:ne,parent:ye}=p,ge=Zr(g);if(Hn(p,!1),J&&Xr(J),!ge&&(j=H&&H.onVnodeBeforeMount)&&Lt(j,ye,g),Hn(p,!0),$&&de){const Re=()=>{p.subTree=La(p),de($,p.subTree,p,b,null)};ge?g.type.__asyncLoader().then(()=>!p.isUnmounted&&Re()):Re()}else{const Re=p.subTree=La(p);E(null,Re,y,v,p,b,I),g.el=Re.el}if(ne&&ut(ne,b),!ge&&(j=H&&H.onVnodeMounted)){const Re=g;ut(()=>Lt(j,ye,Re),b)}(g.shapeFlag&256||ye&&Zr(ye.vnode)&&ye.vnode.shapeFlag&256)&&p.a&&ut(p.a,b),p.isMounted=!0,g=y=v=null}},R=p.effect=new uc(k,()=>vc(C),p.scope),C=p.update=()=>R.run();C.id=p.uid,Hn(p,!0),C()},me=(p,g,y)=>{g.component=p;const v=p.vnode.props;p.vnode=g,p.next=null,s_(p,g.props,v,y),o_(p,g.children,y),ti(),Yu(),ni()},he=(p,g,y,v,b,I,x,k,R=!1)=>{const C=p&&p.children,j=p?p.shapeFlag:0,$=g.children,{patchFlag:H,shapeFlag:J}=g;if(H>0){if(H&128){dn(C,$,y,v,b,I,x,k,R);return}else if(H&256){Yt(C,$,y,v,b,I,x,k,R);return}}J&8?(j&16&&Qe(C,b,I),$!==C&&u(y,$)):j&16?J&16?dn(C,$,y,v,b,I,x,k,R):Qe(C,b,I,!0):(j&8&&u(y,""),J&16&&pt($,y,v,b,I,x,k,R))},Yt=(p,g,y,v,b,I,x,k,R)=>{p=p||Ss,g=g||Ss;const C=p.length,j=g.length,$=Math.min(C,j);let H;for(H=0;H<$;H++){const J=g[H]=R?mn(g[H]):Ut(g[H]);E(p[H],J,y,null,b,I,x,k,R)}C>j?Qe(p,b,I,!0,!1,$):pt(g,y,v,b,I,x,k,R,$)},dn=(p,g,y,v,b,I,x,k,R)=>{let C=0;const j=g.length;let $=p.length-1,H=j-1;for(;C<=$&&C<=H;){const J=p[C],ne=g[C]=R?mn(g[C]):Ut(g[C]);if(pi(J,ne))E(J,ne,y,null,b,I,x,k,R);else break;C++}for(;C<=$&&C<=H;){const J=p[$],ne=g[H]=R?mn(g[H]):Ut(g[H]);if(pi(J,ne))E(J,ne,y,null,b,I,x,k,R);else break;$--,H--}if(C>$){if(C<=H){const J=H+1,ne=J<j?g[J].el:v;for(;C<=H;)E(null,g[C]=R?mn(g[C]):Ut(g[C]),y,ne,b,I,x,k,R),C++}}else if(C>H)for(;C<=$;)ct(p[C],b,I,!0),C++;else{const J=C,ne=C,ye=new Map;for(C=ne;C<=H;C++){const mt=g[C]=R?mn(g[C]):Ut(g[C]);mt.key!=null&&ye.set(mt.key,C)}let ge,Re=0;const It=H-ne+1;let vs=!1,Fu=0;const fi=new Array(It);for(C=0;C<It;C++)fi[C]=0;for(C=J;C<=$;C++){const mt=p[C];if(Re>=It){ct(mt,b,I,!0);continue}let Mt;if(mt.key!=null)Mt=ye.get(mt.key);else for(ge=ne;ge<=H;ge++)if(fi[ge-ne]===0&&pi(mt,g[ge])){Mt=ge;break}Mt===void 0?ct(mt,b,I,!0):(fi[Mt-ne]=C+1,Mt>=Fu?Fu=Mt:vs=!0,E(mt,g[Mt],y,null,b,I,x,k,R),Re++)}const $u=vs?c_(fi):Ss;for(ge=$u.length-1,C=It-1;C>=0;C--){const mt=ne+C,Mt=g[mt],Bu=mt+1<j?g[mt+1].el:v;fi[C]===0?E(null,Mt,y,Bu,b,I,x,k,R):vs&&(ge<0||C!==$u[ge]?xt(Mt,y,Bu,2):ge--)}}},xt=(p,g,y,v,b=null)=>{const{el:I,type:x,transition:k,children:R,shapeFlag:C}=p;if(C&6){xt(p.component.subTree,g,y,v);return}if(C&128){p.suspense.move(g,y,v);return}if(C&64){x.move(p,g,y,D);return}if(x===ke){s(I,g,y);for(let $=0;$<R.length;$++)xt(R[$],g,y,v);s(p.anchor,g,y);return}if(x===to){K(p,g,y);return}if(v!==2&&C&1&&k)if(v===0)k.beforeEnter(I),s(I,g,y),ut(()=>k.enter(I),b);else{const{leave:$,delayLeave:H,afterLeave:J}=k,ne=()=>s(I,g,y),ye=()=>{$(I,()=>{ne(),J&&J()})};H?H(I,ne,ye):ye()}else s(I,g,y)},ct=(p,g,y,v=!1,b=!1)=>{const{type:I,props:x,ref:k,children:R,dynamicChildren:C,shapeFlag:j,patchFlag:$,dirs:H}=p;if(k!=null&&wl(k,null,y,p,!0),j&256){g.ctx.deactivate(p);return}const J=j&1&&H,ne=!Zr(p);let ye;if(ne&&(ye=x&&x.onVnodeBeforeUnmount)&&Lt(ye,g,p),j&6)xr(p.component,y,v);else{if(j&128){p.suspense.unmount(y,v);return}J&&jn(p,null,g,"beforeUnmount"),j&64?p.type.remove(p,g,y,b,D,v):C&&(I!==ke||$>0&&$&64)?Qe(C,g,y,!1,!0):(I===ke&&$&384||!b&&j&16)&&Qe(R,g,y),v&&ms(p)}(ne&&(ye=x&&x.onVnodeUnmounted)||J)&&ut(()=>{ye&&Lt(ye,g,p),J&&jn(p,null,g,"unmounted")},y)},ms=p=>{const{type:g,el:y,anchor:v,transition:b}=p;if(g===ke){ys(y,v);return}if(g===to){F(p);return}const I=()=>{i(y),b&&!b.persisted&&b.afterLeave&&b.afterLeave()};if(p.shapeFlag&1&&b&&!b.persisted){const{leave:x,delayLeave:k}=b,R=()=>x(y,I);k?k(p.el,I,R):R()}else I()},ys=(p,g)=>{let y;for(;p!==g;)y=f(p),i(p),p=y;i(g)},xr=(p,g,y)=>{const{bum:v,scope:b,update:I,subTree:x,um:k}=p;v&&Xr(v),b.stop(),I&&(I.active=!1,ct(x,p,g,y)),k&&ut(k,g),ut(()=>{p.isUnmounted=!0},g),g&&g.pendingBranch&&!g.isUnmounted&&p.asyncDep&&!p.asyncResolved&&p.suspenseId===g.pendingId&&(g.deps--,g.deps===0&&g.resolve())},Qe=(p,g,y,v=!1,b=!1,I=0)=>{for(let x=I;x<p.length;x++)ct(p[x],g,y,v,b)},_=p=>p.shapeFlag&6?_(p.component.subTree):p.shapeFlag&128?p.suspense.next():f(p.anchor||p.el),U=(p,g,y)=>{p==null?g._vnode&&ct(g._vnode,null,null,!0):E(g._vnode||null,p,g,null,null,null,y),Yu(),kf(),g._vnode=p},D={p:E,um:ct,m:xt,r:ms,mt:di,mc:pt,pc:he,pbc:wt,n:_,o:t};let V,de;return e&&([V,de]=e(D)),{render:U,hydrate:V,createApp:t_(U,V)}}function Hn({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Kf(t,e,n=!1){const s=t.children,i=e.children;if(W(s)&&W(i))for(let r=0;r<s.length;r++){const o=s[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=mn(i[r]),a.el=o.el),n||Kf(o,a)),a.type===Yo&&(a.el=o.el)}}function c_(t){const e=t.slice(),n=[0];let s,i,r,o,a;const l=t.length;for(s=0;s<l;s++){const c=t[s];if(c!==0){if(i=n[n.length-1],t[i]<c){e[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,t[n[a]]<c?r=a+1:o=a;c<t[n[r]]&&(r>0&&(e[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const u_=t=>t.__isTeleport,ke=Symbol.for("v-fgt"),Yo=Symbol.for("v-txt"),ns=Symbol.for("v-cmt"),to=Symbol.for("v-stc"),ki=[];let St=null;function M(t=!1){ki.push(St=t?null:[])}function h_(){ki.pop(),St=ki[ki.length-1]||null}let ji=1;function ah(t){ji+=t}function Wf(t){return t.dynamicChildren=ji>0?St||Ss:null,h_(),ji>0&&St&&St.push(t),t}function L(t,e,n,s,i,r){return Wf(h(t,e,n,s,i,r,!0))}function d_(t,e,n,s,i){return Wf(Ne(t,e,n,s,i,!0))}function bl(t){return t?t.__v_isVNode===!0:!1}function pi(t,e){return t.type===e.type&&t.key===e.key}const Jo="__vInternal",Gf=({key:t})=>t??null,no=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?Me(t)||tt(t)||ee(t)?{i:Et,r:t,k:e,f:!!n}:t:null);function h(t,e=null,n=null,s=0,i=null,r=t===ke?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Gf(e),ref:e&&no(e),scopeId:Pf,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Et};return a?(Ic(l,n),r&128&&t.normalize(l)):n&&(l.shapeFlag|=Me(n)?8:16),ji>0&&!o&&St&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&St.push(l),l}const Ne=f_;function f_(t,e=null,n=null,s=0,i=null,r=!1){if((!t||t===Kv)&&(t=ns),bl(t)){const a=$s(t,e,!0);return n&&Ic(a,n),ji>0&&!r&&St&&(a.shapeFlag&6?St[St.indexOf(t)]=a:St.push(a)),a.patchFlag|=-2,a}if(T_(t)&&(t=t.__vccOpts),e){e=p_(e);let{class:a,style:l}=e;a&&!Me(a)&&(e.class=Wt(a)),ve(l)&&(wf(l)&&!W(l)&&(l=Fe({},l)),e.style=lc(l))}const o=Me(t)?1:Nv(t)?128:u_(t)?64:ve(t)?4:ee(t)?2:0;return h(t,e,n,s,i,o,r,!0)}function p_(t){return t?wf(t)||Jo in t?Fe({},t):t:null}function $s(t,e,n=!1){const{props:s,ref:i,patchFlag:r,children:o}=t,a=e?g_(s||{},e):s;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Gf(a),ref:e&&e.ref?n&&i?W(i)?i.concat(no(e)):[i,no(e)]:no(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==ke?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&$s(t.ssContent),ssFallback:t.ssFallback&&$s(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function be(t=" ",e=0){return Ne(Yo,null,t,e)}function us(t,e){const n=Ne(to,null,t);return n.staticCount=e,n}function je(t="",e=!1){return e?(M(),d_(ns,null,t)):Ne(ns,null,t)}function Ut(t){return t==null||typeof t=="boolean"?Ne(ns):W(t)?Ne(ke,null,t.slice()):typeof t=="object"?mn(t):Ne(Yo,null,String(t))}function mn(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:$s(t)}function Ic(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(W(e))n=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),Ic(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(Jo in e)?e._ctx=Et:i===3&&Et&&(Et.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ee(e)?(e={default:e,_ctx:Et},n=32):(e=String(e),s&64?(n=16,e=[be(e)]):n=8);t.children=e,t.shapeFlag|=n}function g_(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=Wt([e.class,s.class]));else if(i==="style")e.style=lc([e.style,s.style]);else if(jo(i)){const r=e[i],o=s[i];o&&r!==o&&!(W(r)&&r.includes(o))&&(e[i]=r?[].concat(r,o):o)}else i!==""&&(e[i]=s[i])}return e}function Lt(t,e,n,s=null){kt(t,e,7,[n,s])}const m_=Bf();let y_=0;function v_(t,e,n){const s=t.type,i=(e?e.appContext:t.appContext)||m_,r={uid:y_++,vnode:t,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new By(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:jf(s,i),emitsOptions:Df(s,i),emit:null,emitted:null,propsDefaults:_e,inheritAttrs:s.inheritAttrs,ctx:_e,data:_e,props:_e,attrs:_e,slots:_e,refs:_e,setupState:_e,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Sv.bind(null,r),t.ce&&t.ce(r),r}let qe=null,Tc,_s,lh="__VUE_INSTANCE_SETTERS__";(_s=ul()[lh])||(_s=ul()[lh]=[]),_s.push(t=>qe=t),Tc=t=>{_s.length>1?_s.forEach(e=>e(t)):_s[0](t)};const Bs=t=>{Tc(t),t.scope.on()},Zn=()=>{qe&&qe.scope.off(),Tc(null)};function Qf(t){return t.vnode.shapeFlag&4}let Hi=!1;function __(t,e=!1){Hi=e;const{props:n,children:s}=t.vnode,i=Qf(t);n_(t,n,i,e),r_(t,s);const r=i?w_(t,e):void 0;return Hi=!1,r}function w_(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=bf(new Proxy(t.ctx,Gv));const{setup:s}=n;if(s){const i=t.setupContext=s.length>1?E_(t):null;Bs(t),ti();const r=Sn(s,t,0,[t.props,i]);if(ni(),Zn(),sf(r)){if(r.then(Zn,Zn),e)return r.then(o=>{ch(t,o,e)}).catch(o=>{Wo(o,t,0)});t.asyncDep=r}else ch(t,r,e)}else Yf(t,e)}function ch(t,e,n){ee(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:ve(e)&&(t.setupState=Cf(e)),Yf(t,n)}let uh;function Yf(t,e,n){const s=t.type;if(!t.render){if(!e&&uh&&!s.render){const i=s.template||bc(t).template;if(i){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=s,c=Fe(Fe({isCustomElement:r,delimiters:a},o),l);s.render=uh(i,c)}}t.render=s.render||At}Bs(t),ti(),Qv(t),ni(),Zn()}function b_(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return ft(t,"get","$attrs"),e[n]}}))}function E_(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return b_(t)},slots:t.slots,emit:t.emit,expose:e}}function Xo(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Cf(bf(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Ai)return Ai[n](t)},has(e,n){return n in e||n in Ai}}))}function I_(t,e=!0){return ee(t)?t.displayName||t.name:t.name||e&&t.__name}function T_(t){return ee(t)&&"__vccOpts"in t}const yt=(t,e)=>wv(t,e,Hi);function Jf(t,e,n){const s=arguments.length;return s===2?ve(e)&&!W(e)?bl(e)?Ne(t,null,[e]):Ne(t,e):Ne(t,null,e):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&bl(n)&&(n=[n]),Ne(t,e,n))}const C_=Symbol.for("v-scx"),S_=()=>jt(C_),A_="3.3.4",k_="http://www.w3.org/2000/svg",Kn=typeof document<"u"?document:null,hh=Kn&&Kn.createElement("template"),R_={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const i=e?Kn.createElementNS(k_,t):Kn.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:t=>Kn.createTextNode(t),createComment:t=>Kn.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Kn.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,s,i,r){const o=n?n.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{hh.innerHTML=s?`<svg>${t}</svg>`:t;const a=hh.content;if(s){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function D_(t,e,n){const s=t._vtc;s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function P_(t,e,n){const s=t.style,i=Me(n);if(n&&!i){if(e&&!Me(e))for(const r in e)n[r]==null&&El(s,r,"");for(const r in n)El(s,r,n[r])}else{const r=s.display;i?e!==n&&(s.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(s.display=r)}}const dh=/\s*!important$/;function El(t,e,n){if(W(n))n.forEach(s=>El(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=N_(t,e);dh.test(n)?t.setProperty(ei(s),n.replace(dh,""),"important"):t[s]=n}}const fh=["Webkit","Moz","ms"],Fa={};function N_(t,e){const n=Fa[e];if(n)return n;let s=Kt(e);if(s!=="filter"&&s in t)return Fa[e]=s;s=zo(s);for(let i=0;i<fh.length;i++){const r=fh[i]+s;if(r in t)return Fa[e]=r}return e}const ph="http://www.w3.org/1999/xlink";function O_(t,e,n,s,i){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(ph,e.slice(6,e.length)):t.setAttributeNS(ph,e,n);else{const r=Uy(e);n==null||r&&!af(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function x_(t,e,n,s,i,r,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,i,r),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const c=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";c!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let l=!1;if(n===""||n==null){const c=typeof t[e];c==="boolean"?n=af(n):n==null&&c==="string"?(n="",l=!0):c==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}function vn(t,e,n,s){t.addEventListener(e,n,s)}function M_(t,e,n,s){t.removeEventListener(e,n,s)}function L_(t,e,n,s,i=null){const r=t._vei||(t._vei={}),o=r[e];if(s&&o)o.value=s;else{const[a,l]=U_(e);if(s){const c=r[e]=B_(s,i);vn(t,a,c,l)}else o&&(M_(t,a,o,l),r[e]=void 0)}}const gh=/(?:Once|Passive|Capture)$/;function U_(t){let e;if(gh.test(t)){e={};let s;for(;s=t.match(gh);)t=t.slice(0,t.length-s[0].length),e[s[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):ei(t.slice(2)),e]}let $a=0;const F_=Promise.resolve(),$_=()=>$a||(F_.then(()=>$a=0),$a=Date.now());function B_(t,e){const n=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=n.attached)return;kt(V_(s,n.value),e,5,[s])};return n.value=t,n.attached=$_(),n}function V_(t,e){if(W(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>i=>!i._stopped&&s&&s(i))}else return e}const mh=/^on[a-z]/,j_=(t,e,n,s,i=!1,r,o,a,l)=>{e==="class"?D_(t,s,i):e==="style"?P_(t,n,s):jo(e)?rc(e)||L_(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):H_(t,e,s,i))?x_(t,e,s,r,o,a,l):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),O_(t,e,s,i))};function H_(t,e,n,s){return s?!!(e==="innerHTML"||e==="textContent"||e in t&&mh.test(e)&&ee(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||mh.test(e)&&Me(n)?!1:e in t}const Vs=t=>{const e=t.props["onUpdate:modelValue"]||!1;return W(e)?n=>Xr(e,n):e};function q_(t){t.target.composing=!0}function yh(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const re={created(t,{modifiers:{lazy:e,trim:n,number:s}},i){t._assign=Vs(i);const r=s||i.props&&i.props.type==="number";vn(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),r&&(a=fo(a)),t._assign(a)}),n&&vn(t,"change",()=>{t.value=t.value.trim()}),e||(vn(t,"compositionstart",q_),vn(t,"compositionend",yh),vn(t,"change",yh))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:s,number:i}},r){if(t._assign=Vs(r),t.composing||document.activeElement===t&&t.type!=="range"&&(n||s&&t.value.trim()===e||(i||t.type==="number")&&fo(t.value)===e))return;const o=e??"";t.value!==o&&(t.value=o)}},vh={created(t,{value:e},n){t.checked=Us(e,n.props.value),t._assign=Vs(n),vn(t,"change",()=>{t._assign(qi(t))})},beforeUpdate(t,{value:e,oldValue:n},s){t._assign=Vs(s),e!==n&&(t.checked=Us(e,s.props.value))}},so={deep:!0,created(t,{value:e,modifiers:{number:n}},s){const i=Ho(e);vn(t,"change",()=>{const r=Array.prototype.filter.call(t.options,o=>o.selected).map(o=>n?fo(qi(o)):qi(o));t._assign(t.multiple?i?new Set(r):r:r[0])}),t._assign=Vs(s)},mounted(t,{value:e}){_h(t,e)},beforeUpdate(t,e,n){t._assign=Vs(n)},updated(t,{value:e}){_h(t,e)}};function _h(t,e){const n=t.multiple;if(!(n&&!W(e)&&!Ho(e))){for(let s=0,i=t.options.length;s<i;s++){const r=t.options[s],o=qi(r);if(n)W(e)?r.selected=$y(e,o)>-1:r.selected=e.has(o);else if(Us(qi(r),e)){t.selectedIndex!==s&&(t.selectedIndex=s);return}}!n&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function qi(t){return"_value"in t?t._value:t.value}const z_=["ctrl","shift","alt","meta"],K_={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>z_.some(n=>t[`${n}Key`]&&!e.includes(n))},Zo=(t,e)=>(n,...s)=>{for(let i=0;i<e.length;i++){const r=K_[e[i]];if(r&&r(n,e))return}return t(n,...s)},W_=Fe({patchProp:j_},R_);let wh;function G_(){return wh||(wh=a_(W_))}const Q_=(...t)=>{const e=G_().createApp(...t),{mount:n}=e;return e.mount=s=>{const i=Y_(s);if(!i)return;const r=e._component;!ee(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function Y_(t){return Me(t)?document.querySelector(t):t}/*!
  * vue-router v4.2.2
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const bs=typeof window<"u";function J_(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const fe=Object.assign;function Ba(t,e){const n={};for(const s in e){const i=e[s];n[s]=Dt(i)?i.map(t):t(i)}return n}const Ri=()=>{},Dt=Array.isArray,X_=/\/$/,Z_=t=>t.replace(X_,"");function Va(t,e,n="/"){let s,i={},r="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(s=e.slice(0,l),r=e.slice(l+1,a>-1?a:e.length),i=t(r)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=s0(s??e,n),{fullPath:s+(r&&"?")+r+o,path:s,query:i,hash:o}}function e0(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function bh(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function t0(t,e,n){const s=e.matched.length-1,i=n.matched.length-1;return s>-1&&s===i&&js(e.matched[s],n.matched[i])&&Xf(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function js(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Xf(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!n0(t[n],e[n]))return!1;return!0}function n0(t,e){return Dt(t)?Eh(t,e):Dt(e)?Eh(e,t):t===e}function Eh(t,e){return Dt(e)?t.length===e.length&&t.every((n,s)=>n===e[s]):t.length===1&&t[0]===e}function s0(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),s=t.split("/"),i=s[s.length-1];(i===".."||i===".")&&s.push("");let r=n.length-1,o,a;for(o=0;o<s.length;o++)if(a=s[o],a!==".")if(a==="..")r>1&&r--;else break;return n.slice(0,r).join("/")+"/"+s.slice(o-(o===s.length?1:0)).join("/")}var zi;(function(t){t.pop="pop",t.push="push"})(zi||(zi={}));var Di;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Di||(Di={}));function i0(t){if(!t)if(bs){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Z_(t)}const r0=/^[^#]+#/;function o0(t,e){return t.replace(r0,"#")+e}function a0(t,e){const n=document.documentElement.getBoundingClientRect(),s=t.getBoundingClientRect();return{behavior:e.behavior,left:s.left-n.left-(e.left||0),top:s.top-n.top-(e.top||0)}}const ea=()=>({left:window.pageXOffset,top:window.pageYOffset});function l0(t){let e;if("el"in t){const n=t.el,s=typeof n=="string"&&n.startsWith("#"),i=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;e=a0(i,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Ih(t,e){return(history.state?history.state.position-e:-1)+t}const Il=new Map;function c0(t,e){Il.set(t,e)}function u0(t){const e=Il.get(t);return Il.delete(t),e}let h0=()=>location.protocol+"//"+location.host;function Zf(t,e){const{pathname:n,search:s,hash:i}=e,r=t.indexOf("#");if(r>-1){let a=i.includes(t.slice(r))?t.slice(r).length:1,l=i.slice(a);return l[0]!=="/"&&(l="/"+l),bh(l,"")}return bh(n,t)+s+i}function d0(t,e,n,s){let i=[],r=[],o=null;const a=({state:f})=>{const m=Zf(t,location),w=n.value,E=e.value;let A=0;if(f){if(n.value=m,e.value=f,o&&o===w){o=null;return}A=E?f.position-E.position:0}else s(m);i.forEach(N=>{N(n.value,w,{delta:A,type:zi.pop,direction:A?A>0?Di.forward:Di.back:Di.unknown})})};function l(){o=n.value}function c(f){i.push(f);const m=()=>{const w=i.indexOf(f);w>-1&&i.splice(w,1)};return r.push(m),m}function u(){const{history:f}=window;f.state&&f.replaceState(fe({},f.state,{scroll:ea()}),"")}function d(){for(const f of r)f();r=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",u,{passive:!0}),{pauseListeners:l,listen:c,destroy:d}}function Th(t,e,n,s=!1,i=!1){return{back:t,current:e,forward:n,replaced:s,position:window.history.length,scroll:i?ea():null}}function f0(t){const{history:e,location:n}=window,s={value:Zf(t,n)},i={value:e.state};i.value||r(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function r(l,c,u){const d=t.indexOf("#"),f=d>-1?(n.host&&document.querySelector("base")?t:t.slice(d))+l:h0()+t+l;try{e[u?"replaceState":"pushState"](c,"",f),i.value=c}catch(m){console.error(m),n[u?"replace":"assign"](f)}}function o(l,c){const u=fe({},e.state,Th(i.value.back,l,i.value.forward,!0),c,{position:i.value.position});r(l,u,!0),s.value=l}function a(l,c){const u=fe({},i.value,e.state,{forward:l,scroll:ea()});r(u.current,u,!0);const d=fe({},Th(s.value,l,null),{position:u.position+1},c);r(l,d,!1),s.value=l}return{location:s,state:i,push:a,replace:o}}function p0(t){t=i0(t);const e=f0(t),n=d0(t,e.state,e.location,e.replace);function s(r,o=!0){o||n.pauseListeners(),history.go(r)}const i=fe({location:"",base:t,go:s,createHref:o0.bind(null,t)},e,n);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>e.state.value}),i}function g0(t){return typeof t=="string"||t&&typeof t=="object"}function ep(t){return typeof t=="string"||typeof t=="symbol"}const pn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},tp=Symbol("");var Ch;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Ch||(Ch={}));function Hs(t,e){return fe(new Error,{type:t,[tp]:!0},e)}function Jt(t,e){return t instanceof Error&&tp in t&&(e==null||!!(t.type&e))}const Sh="[^/]+?",m0={sensitive:!1,strict:!1,start:!0,end:!0},y0=/[.+*?^${}()[\]/\\]/g;function v0(t,e){const n=fe({},m0,e),s=[];let i=n.start?"^":"";const r=[];for(const c of t){const u=c.length?[]:[90];n.strict&&!c.length&&(i+="/");for(let d=0;d<c.length;d++){const f=c[d];let m=40+(n.sensitive?.25:0);if(f.type===0)d||(i+="/"),i+=f.value.replace(y0,"\\$&"),m+=40;else if(f.type===1){const{value:w,repeatable:E,optional:A,regexp:N}=f;r.push({name:w,repeatable:E,optional:A});const O=N||Sh;if(O!==Sh){m+=10;try{new RegExp(`(${O})`)}catch(F){throw new Error(`Invalid custom RegExp for param "${w}" (${O}): `+F.message)}}let K=E?`((?:${O})(?:/(?:${O}))*)`:`(${O})`;d||(K=A&&c.length<2?`(?:/${K})`:"/"+K),A&&(K+="?"),i+=K,m+=20,A&&(m+=-8),E&&(m+=-20),O===".*"&&(m+=-50)}u.push(m)}s.push(u)}if(n.strict&&n.end){const c=s.length-1;s[c][s[c].length-1]+=.7000000000000001}n.strict||(i+="/?"),n.end?i+="$":n.strict&&(i+="(?:/|$)");const o=new RegExp(i,n.sensitive?"":"i");function a(c){const u=c.match(o),d={};if(!u)return null;for(let f=1;f<u.length;f++){const m=u[f]||"",w=r[f-1];d[w.name]=m&&w.repeatable?m.split("/"):m}return d}function l(c){let u="",d=!1;for(const f of t){(!d||!u.endsWith("/"))&&(u+="/"),d=!1;for(const m of f)if(m.type===0)u+=m.value;else if(m.type===1){const{value:w,repeatable:E,optional:A}=m,N=w in c?c[w]:"";if(Dt(N)&&!E)throw new Error(`Provided param "${w}" is an array but it is not repeatable (* or + modifiers)`);const O=Dt(N)?N.join("/"):N;if(!O)if(A)f.length<2&&(u.endsWith("/")?u=u.slice(0,-1):d=!0);else throw new Error(`Missing required param "${w}"`);u+=O}}return u||"/"}return{re:o,score:s,keys:r,parse:a,stringify:l}}function _0(t,e){let n=0;for(;n<t.length&&n<e.length;){const s=e[n]-t[n];if(s)return s;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function w0(t,e){let n=0;const s=t.score,i=e.score;for(;n<s.length&&n<i.length;){const r=_0(s[n],i[n]);if(r)return r;n++}if(Math.abs(i.length-s.length)===1){if(Ah(s))return 1;if(Ah(i))return-1}return i.length-s.length}function Ah(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const b0={type:0,value:""},E0=/[a-zA-Z0-9_]/;function I0(t){if(!t)return[[]];if(t==="/")return[[b0]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(m){throw new Error(`ERR (${n})/"${c}": ${m}`)}let n=0,s=n;const i=[];let r;function o(){r&&i.push(r),r=[]}let a=0,l,c="",u="";function d(){c&&(n===0?r.push({type:0,value:c}):n===1||n===2||n===3?(r.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),r.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function f(){c+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){s=n,n=4;continue}switch(n){case 0:l==="/"?(c&&d(),o()):l===":"?(d(),n=1):f();break;case 4:f(),n=s;break;case 1:l==="("?n=2:E0.test(l)?f():(d(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:n=3:u+=l;break;case 3:d(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${c}"`),d(),o(),i}function T0(t,e,n){const s=v0(I0(t.path),n),i=fe(s,{record:t,parent:e,children:[],alias:[]});return e&&!i.record.aliasOf==!e.record.aliasOf&&e.children.push(i),i}function C0(t,e){const n=[],s=new Map;e=Dh({strict:!1,end:!0,sensitive:!1},e);function i(u){return s.get(u)}function r(u,d,f){const m=!f,w=S0(u);w.aliasOf=f&&f.record;const E=Dh(e,u),A=[w];if("alias"in u){const K=typeof u.alias=="string"?[u.alias]:u.alias;for(const F of K)A.push(fe({},w,{components:f?f.record.components:w.components,path:F,aliasOf:f?f.record:w}))}let N,O;for(const K of A){const{path:F}=K;if(d&&F[0]!=="/"){const Ie=d.record.path,Ce=Ie[Ie.length-1]==="/"?"":"/";K.path=d.record.path+(F&&Ce+F)}if(N=T0(K,d,E),f?f.alias.push(N):(O=O||N,O!==N&&O.alias.push(N),m&&u.name&&!Rh(N)&&o(u.name)),w.children){const Ie=w.children;for(let Ce=0;Ce<Ie.length;Ce++)r(Ie[Ce],N,f&&f.children[Ce])}f=f||N,(N.record.components&&Object.keys(N.record.components).length||N.record.name||N.record.redirect)&&l(N)}return O?()=>{o(O)}:Ri}function o(u){if(ep(u)){const d=s.get(u);d&&(s.delete(u),n.splice(n.indexOf(d),1),d.children.forEach(o),d.alias.forEach(o))}else{const d=n.indexOf(u);d>-1&&(n.splice(d,1),u.record.name&&s.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function l(u){let d=0;for(;d<n.length&&w0(u,n[d])>=0&&(u.record.path!==n[d].record.path||!np(u,n[d]));)d++;n.splice(d,0,u),u.record.name&&!Rh(u)&&s.set(u.record.name,u)}function c(u,d){let f,m={},w,E;if("name"in u&&u.name){if(f=s.get(u.name),!f)throw Hs(1,{location:u});E=f.record.name,m=fe(kh(d.params,f.keys.filter(O=>!O.optional).map(O=>O.name)),u.params&&kh(u.params,f.keys.map(O=>O.name))),w=f.stringify(m)}else if("path"in u)w=u.path,f=n.find(O=>O.re.test(w)),f&&(m=f.parse(w),E=f.record.name);else{if(f=d.name?s.get(d.name):n.find(O=>O.re.test(d.path)),!f)throw Hs(1,{location:u,currentLocation:d});E=f.record.name,m=fe({},d.params,u.params),w=f.stringify(m)}const A=[];let N=f;for(;N;)A.unshift(N.record),N=N.parent;return{name:E,path:w,params:m,matched:A,meta:k0(A)}}return t.forEach(u=>r(u)),{addRoute:r,resolve:c,removeRoute:o,getRoutes:a,getRecordMatcher:i}}function kh(t,e){const n={};for(const s of e)s in t&&(n[s]=t[s]);return n}function S0(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:A0(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function A0(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const s in t.components)e[s]=typeof n=="boolean"?n:n[s];return e}function Rh(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function k0(t){return t.reduce((e,n)=>fe(e,n.meta),{})}function Dh(t,e){const n={};for(const s in t)n[s]=s in e?e[s]:t[s];return n}function np(t,e){return e.children.some(n=>n===t||np(t,n))}const sp=/#/g,R0=/&/g,D0=/\//g,P0=/=/g,N0=/\?/g,ip=/\+/g,O0=/%5B/g,x0=/%5D/g,rp=/%5E/g,M0=/%60/g,op=/%7B/g,L0=/%7C/g,ap=/%7D/g,U0=/%20/g;function Cc(t){return encodeURI(""+t).replace(L0,"|").replace(O0,"[").replace(x0,"]")}function F0(t){return Cc(t).replace(op,"{").replace(ap,"}").replace(rp,"^")}function Tl(t){return Cc(t).replace(ip,"%2B").replace(U0,"+").replace(sp,"%23").replace(R0,"%26").replace(M0,"`").replace(op,"{").replace(ap,"}").replace(rp,"^")}function $0(t){return Tl(t).replace(P0,"%3D")}function B0(t){return Cc(t).replace(sp,"%23").replace(N0,"%3F")}function V0(t){return t==null?"":B0(t).replace(D0,"%2F")}function vo(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function j0(t){const e={};if(t===""||t==="?")return e;const s=(t[0]==="?"?t.slice(1):t).split("&");for(let i=0;i<s.length;++i){const r=s[i].replace(ip," "),o=r.indexOf("="),a=vo(o<0?r:r.slice(0,o)),l=o<0?null:vo(r.slice(o+1));if(a in e){let c=e[a];Dt(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function Ph(t){let e="";for(let n in t){const s=t[n];if(n=$0(n),s==null){s!==void 0&&(e+=(e.length?"&":"")+n);continue}(Dt(s)?s.map(r=>r&&Tl(r)):[s&&Tl(s)]).forEach(r=>{r!==void 0&&(e+=(e.length?"&":"")+n,r!=null&&(e+="="+r))})}return e}function H0(t){const e={};for(const n in t){const s=t[n];s!==void 0&&(e[n]=Dt(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return e}const q0=Symbol(""),Nh=Symbol(""),ta=Symbol(""),lp=Symbol(""),Cl=Symbol("");function gi(){let t=[];function e(s){return t.push(s),()=>{const i=t.indexOf(s);i>-1&&t.splice(i,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function yn(t,e,n,s,i){const r=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((o,a)=>{const l=d=>{d===!1?a(Hs(4,{from:n,to:e})):d instanceof Error?a(d):g0(d)?a(Hs(2,{from:e,to:d})):(r&&s.enterCallbacks[i]===r&&typeof d=="function"&&r.push(d),o())},c=t.call(s&&s.instances[i],e,n,l);let u=Promise.resolve(c);t.length<3&&(u=u.then(l)),u.catch(d=>a(d))})}function ja(t,e,n,s){const i=[];for(const r of t)for(const o in r.components){let a=r.components[o];if(!(e!=="beforeRouteEnter"&&!r.instances[o]))if(z0(a)){const c=(a.__vccOpts||a)[e];c&&i.push(yn(c,n,s,r,o))}else{let l=a();i.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${r.path}"`));const u=J_(c)?c.default:c;r.components[o]=u;const f=(u.__vccOpts||u)[e];return f&&yn(f,n,s,r,o)()}))}}return i}function z0(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function Oh(t){const e=jt(ta),n=jt(lp),s=yt(()=>e.resolve(Rs(t.to))),i=yt(()=>{const{matched:l}=s.value,{length:c}=l,u=l[c-1],d=n.matched;if(!u||!d.length)return-1;const f=d.findIndex(js.bind(null,u));if(f>-1)return f;const m=xh(l[c-2]);return c>1&&xh(u)===m&&d[d.length-1].path!==m?d.findIndex(js.bind(null,l[c-2])):f}),r=yt(()=>i.value>-1&&Q0(n.params,s.value.params)),o=yt(()=>i.value>-1&&i.value===n.matched.length-1&&Xf(n.params,s.value.params));function a(l={}){return G0(l)?e[Rs(t.replace)?"replace":"push"](Rs(t.to)).catch(Ri):Promise.resolve()}return{route:s,href:yt(()=>s.value.href),isActive:r,isExactActive:o,navigate:a}}const K0=xf({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Oh,setup(t,{slots:e}){const n=hr(Oh(t)),{options:s}=jt(ta),i=yt(()=>({[Mh(t.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[Mh(t.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const r=e.default&&e.default(n);return t.custom?r:Jf("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},r)}}}),W0=K0;function G0(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function Q0(t,e){for(const n in e){const s=e[n],i=t[n];if(typeof s=="string"){if(s!==i)return!1}else if(!Dt(i)||i.length!==s.length||s.some((r,o)=>r!==i[o]))return!1}return!0}function xh(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const Mh=(t,e,n)=>t??e??n,Y0=xf({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const s=jt(Cl),i=yt(()=>t.route||s.value),r=jt(Nh,0),o=yt(()=>{let c=Rs(r);const{matched:u}=i.value;let d;for(;(d=u[c])&&!d.components;)c++;return c}),a=yt(()=>i.value.matched[o.value]);eo(Nh,yt(()=>o.value+1)),eo(q0,a),eo(Cl,i);const l=In();return Si(()=>[l.value,a.value,t.name],([c,u,d],[f,m,w])=>{u&&(u.instances[d]=c,m&&m!==u&&c&&c===f&&(u.leaveGuards.size||(u.leaveGuards=m.leaveGuards),u.updateGuards.size||(u.updateGuards=m.updateGuards))),c&&u&&(!m||!js(u,m)||!f)&&(u.enterCallbacks[d]||[]).forEach(E=>E(c))},{flush:"post"}),()=>{const c=i.value,u=t.name,d=a.value,f=d&&d.components[u];if(!f)return Lh(n.default,{Component:f,route:c});const m=d.props[u],w=m?m===!0?c.params:typeof m=="function"?m(c):m:null,A=Jf(f,fe({},w,e,{onVnodeUnmounted:N=>{N.component.isUnmounted&&(d.instances[u]=null)},ref:l}));return Lh(n.default,{Component:A,route:c})||A}}});function Lh(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const J0=Y0;function X0(t){const e=C0(t.routes,t),n=t.parseQuery||j0,s=t.stringifyQuery||Ph,i=t.history,r=gi(),o=gi(),a=gi(),l=mv(pn);let c=pn;bs&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Ba.bind(null,_=>""+_),d=Ba.bind(null,V0),f=Ba.bind(null,vo);function m(_,U){let D,V;return ep(_)?(D=e.getRecordMatcher(_),V=U):V=_,e.addRoute(V,D)}function w(_){const U=e.getRecordMatcher(_);U&&e.removeRoute(U)}function E(){return e.getRoutes().map(_=>_.record)}function A(_){return!!e.getRecordMatcher(_)}function N(_,U){if(U=fe({},U||l.value),typeof _=="string"){const y=Va(n,_,U.path),v=e.resolve({path:y.path},U),b=i.createHref(y.fullPath);return fe(y,v,{params:f(v.params),hash:vo(y.hash),redirectedFrom:void 0,href:b})}let D;if("path"in _)D=fe({},_,{path:Va(n,_.path,U.path).path});else{const y=fe({},_.params);for(const v in y)y[v]==null&&delete y[v];D=fe({},_,{params:d(y)}),U.params=d(U.params)}const V=e.resolve(D,U),de=_.hash||"";V.params=u(f(V.params));const p=e0(s,fe({},_,{hash:F0(de),path:V.path})),g=i.createHref(p);return fe({fullPath:p,hash:de,query:s===Ph?H0(_.query):_.query||{}},V,{redirectedFrom:void 0,href:g})}function O(_){return typeof _=="string"?Va(n,_,l.value.path):fe({},_)}function K(_,U){if(c!==_)return Hs(8,{from:U,to:_})}function F(_){return Ge(_)}function Ie(_){return F(fe(O(_),{replace:!0}))}function Ce(_){const U=_.matched[_.matched.length-1];if(U&&U.redirect){const{redirect:D}=U;let V=typeof D=="function"?D(_):D;return typeof V=="string"&&(V=V.includes("?")||V.includes("#")?V=O(V):{path:V},V.params={}),fe({query:_.query,hash:_.hash,params:"path"in V?{}:_.params},V)}}function Ge(_,U){const D=c=N(_),V=l.value,de=_.state,p=_.force,g=_.replace===!0,y=Ce(D);if(y)return Ge(fe(O(y),{state:typeof y=="object"?fe({},de,y.state):de,force:p,replace:g}),U||D);const v=D;v.redirectedFrom=U;let b;return!p&&t0(s,V,D)&&(b=Hs(16,{to:v,from:V}),xt(V,V,!0,!1)),(b?Promise.resolve(b):wt(v,V)).catch(I=>Jt(I)?Jt(I,2)?I:dn(I):he(I,v,V)).then(I=>{if(I){if(Jt(I,2))return Ge(fe({replace:g},O(I.to),{state:typeof I.to=="object"?fe({},de,I.to.state):de,force:p}),U||v)}else I=Vn(v,V,!0,g,de);return hn(v,V,I),I})}function pt(_,U){const D=K(_,U);return D?Promise.reject(D):Promise.resolve()}function gt(_){const U=ys.values().next().value;return U&&typeof U.runWithContext=="function"?U.runWithContext(_):_()}function wt(_,U){let D;const[V,de,p]=Z0(_,U);D=ja(V.reverse(),"beforeRouteLeave",_,U);for(const y of V)y.leaveGuards.forEach(v=>{D.push(yn(v,_,U))});const g=pt.bind(null,_,U);return D.push(g),Qe(D).then(()=>{D=[];for(const y of r.list())D.push(yn(y,_,U));return D.push(g),Qe(D)}).then(()=>{D=ja(de,"beforeRouteUpdate",_,U);for(const y of de)y.updateGuards.forEach(v=>{D.push(yn(v,_,U))});return D.push(g),Qe(D)}).then(()=>{D=[];for(const y of _.matched)if(y.beforeEnter&&!U.matched.includes(y))if(Dt(y.beforeEnter))for(const v of y.beforeEnter)D.push(yn(v,_,U));else D.push(yn(y.beforeEnter,_,U));return D.push(g),Qe(D)}).then(()=>(_.matched.forEach(y=>y.enterCallbacks={}),D=ja(p,"beforeRouteEnter",_,U),D.push(g),Qe(D))).then(()=>{D=[];for(const y of o.list())D.push(yn(y,_,U));return D.push(g),Qe(D)}).catch(y=>Jt(y,8)?y:Promise.reject(y))}function hn(_,U,D){for(const V of a.list())gt(()=>V(_,U,D))}function Vn(_,U,D,V,de){const p=K(_,U);if(p)return p;const g=U===pn,y=bs?history.state:{};D&&(V||g?i.replace(_.fullPath,fe({scroll:g&&y&&y.scroll},de)):i.push(_.fullPath,de)),l.value=_,xt(_,U,D,g),dn()}let Ot;function di(){Ot||(Ot=i.listen((_,U,D)=>{if(!xr.listening)return;const V=N(_),de=Ce(V);if(de){Ge(fe(de,{replace:!0}),V).catch(Ri);return}c=V;const p=l.value;bs&&c0(Ih(p.fullPath,D.delta),ea()),wt(V,p).catch(g=>Jt(g,12)?g:Jt(g,2)?(Ge(g.to,V).then(y=>{Jt(y,20)&&!D.delta&&D.type===zi.pop&&i.go(-1,!1)}).catch(Ri),Promise.reject()):(D.delta&&i.go(-D.delta,!1),he(g,V,p))).then(g=>{g=g||Vn(V,p,!1),g&&(D.delta&&!Jt(g,8)?i.go(-D.delta,!1):D.type===zi.pop&&Jt(g,20)&&i.go(-1,!1)),hn(V,p,g)}).catch(Ri)}))}let gs=gi(),Le=gi(),me;function he(_,U,D){dn(_);const V=Le.list();return V.length?V.forEach(de=>de(_,U,D)):console.error(_),Promise.reject(_)}function Yt(){return me&&l.value!==pn?Promise.resolve():new Promise((_,U)=>{gs.add([_,U])})}function dn(_){return me||(me=!_,di(),gs.list().forEach(([U,D])=>_?D(_):U()),gs.reset()),_}function xt(_,U,D,V){const{scrollBehavior:de}=t;if(!bs||!de)return Promise.resolve();const p=!D&&u0(Ih(_.fullPath,0))||(V||!D)&&history.state&&history.state.scroll||null;return yc().then(()=>de(_,U,p)).then(g=>g&&l0(g)).catch(g=>he(g,_,U))}const ct=_=>i.go(_);let ms;const ys=new Set,xr={currentRoute:l,listening:!0,addRoute:m,removeRoute:w,hasRoute:A,getRoutes:E,resolve:N,options:t,push:F,replace:Ie,go:ct,back:()=>ct(-1),forward:()=>ct(1),beforeEach:r.add,beforeResolve:o.add,afterEach:a.add,onError:Le.add,isReady:Yt,install(_){const U=this;_.component("RouterLink",W0),_.component("RouterView",J0),_.config.globalProperties.$router=U,Object.defineProperty(_.config.globalProperties,"$route",{enumerable:!0,get:()=>Rs(l)}),bs&&!ms&&l.value===pn&&(ms=!0,F(i.location).catch(de=>{}));const D={};for(const de in pn)D[de]=yt(()=>l.value[de]);_.provide(ta,U),_.provide(lp,hr(D)),_.provide(Cl,l);const V=_.unmount;ys.add(_),_.unmount=function(){ys.delete(_),ys.size<1&&(c=pn,Ot&&Ot(),Ot=null,l.value=pn,ms=!1,me=!1),V()}}};function Qe(_){return _.reduce((U,D)=>U.then(()=>gt(D)),Promise.resolve())}return xr}function Z0(t,e){const n=[],s=[],i=[],r=Math.max(e.matched.length,t.matched.length);for(let o=0;o<r;o++){const a=e.matched[o];a&&(t.matched.find(c=>js(c,a))?s.push(a):n.push(a));const l=t.matched[o];l&&(e.matched.find(c=>js(c,l))||i.push(l))}return[n,s,i]}function cp(){return jt(ta)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bo=new Map,Dl=new Map;function m1(t,e){try{t.container.addComponent(e)}catch(n){is.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function qs(t){const e=t.name;if(Dl.has(e))return is.debug(`There were multiple attempts to register component ${e}.`),!1;Dl.set(e,t);for(const n of bo.values())m1(n,t);return!0}function Rc(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const si=p1;function vp(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Rl,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw kn.create("bad-app-name",{appName:String(i)});if(n||(n=pp()),!n)throw kn.create("no-options");const r=bo.get(i);if(r){if(wo(n,r.options)&&wo(s,r.config))return r;throw kn.create("duplicate-app",{appName:i})}const o=new Sw(i);for(const l of Dl.values())o.addComponent(l);const a=new v1(n,s,o);return bo.set(i,a),a}function _p(t=Rl){const e=bo.get(t);if(!e&&t===Rl&&pp())return vp();if(!e)throw kn.create("no-app",{appName:t});return e}function Rn(t,e,n){var s;let i=(s=g1[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),is.warn(a.join(" "));return}qs(new ss(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo=new Ac("@firebase/auth");function R1(t,...e){Eo.logLevel<=le.WARN&&Eo.warn(`Auth (${si}): ${t}`,...e)}function io(t,...e){Eo.logLevel<=le.ERROR&&Eo.error(`Auth (${si}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M1=new pr(3e4,6e4);function ii(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function hs(t,e,n,s,i={}){return Cp(t,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const a=fr(Object.assign({key:t.config.apiKey},o)).slice(1),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode),Tp.fetch()(Sp(t,t.config.apiHost,n,a),Object.assign({method:e,headers:l,referrerPolicy:"no-referrer"},r))})}async function Cp(t,e,n){t._canInitEmulator=!1;const s=Object.assign(Object.assign({},x1),e);try{const i=new L1(t),r=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Vr(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw Vr(t,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw Vr(t,"email-already-in-use",o);if(l==="USER_DISABLED")throw Vr(t,"user-disabled",o);const u=s[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw D1(t,u,c);Pt(t,u)}}catch(i){if(i instanceof un)throw i;Pt(t,"network-request-failed",{message:String(i)})}}async function gr(t,e,n,s,i={}){const r=await hs(t,e,n,s,i);return"mfaPendingCredential"in r&&Pt(t,"multi-factor-auth-required",{_serverResponse:r}),r}function Sp(t,e,n,s){const i=`${e}${n}?${s}`;return t.config.emulator?Nc(t.config,i):`${t.config.apiScheme}://${i}`}class L1{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(Ht(this.auth,"network-request-failed")),M1.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Vr(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const i=Ht(t,e,s);return i.customData._tokenResponse=n,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function U1(t,e){return hs(t,"POST","/v1/accounts:delete",e)}async function F1(t,e){return hs(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zs(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof un&&V1(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function V1({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ro(t,e,n){return`firebase:${t}:${e}:${n}`}class Ps{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:i,name:r}=this.auth;this.fullUserKey=ro(this.userKey,i.apiKey,r),this.fullPersistenceKey=ro("persistence",i.apiKey,r),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?es._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new Ps(en(Wh),e,s);const i=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let r=i[0]||en(Wh);const o=ro(s,e.config.apiKey,e.name);let a=null;for(const c of n)try{const u=await c._get(o);if(u){const d=es._fromJSON(e,u);c!==r&&(a=d),r=c;break}}catch{}const l=i.filter(c=>c._shouldAllowMigration);return!r._shouldAllowMigration||!l.length?new Ps(r,e,s):(r=l[0],a&&await r._set(o,a.toJSON()),await Promise.all(n.map(async c=>{if(c!==r)try{await c._remove(o)}catch{}})),new Ps(r,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gh(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Pp(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Rp(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Op(e))return"Blackberry";if(xp(e))return"Webos";if(xc(e))return"Safari";if((e.includes("chrome/")||Dp(e))&&!e.includes("edge/"))return"Chrome";if(Np(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Rp(t=rt()){return/firefox\//i.test(t)}function xc(t=rt()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Dp(t=rt()){return/crios\//i.test(t)}function Pp(t=rt()){return/iemobile/i.test(t)}function Np(t=rt()){return/android/i.test(t)}function Op(t=rt()){return/blackberry/i.test(t)}function xp(t=rt()){return/webos/i.test(t)}function na(t=rt()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function W1(t=rt()){var e;return na(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function G1(){return fw()&&document.documentMode===10}function Mp(t=rt()){return na(t)||Np(t)||xp(t)||Op(t)||/windows phone/i.test(t)||Pp(t)}function Q1(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sb(t,e){const n=Rc(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),r=n.getOptions();if(wo(r,e??{}))return i;Pt(i,"already-initialized")}return n.initialize({options:e})}function ib(t,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(en);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function rb(t,e,n){const s=ri(t);G(s._canInitEmulator,s,"emulator-config-failed"),G(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!!(n!=null&&n.disableWarnings),r=Vp(e),{host:o,port:a}=ob(e),l=a===null?"":`:${a}`;s.config.emulator={url:`${r}//${o}${l}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})}),i||ab()}function Vp(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function ob(t){const e=Vp(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:Jh(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:Jh(o)}}}function Jh(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function ab(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qa(t,e){return gr(t,"POST","/v1/accounts:signInWithPassword",ii(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ns(t,e){return gr(t,"POST","/v1/accounts:signInWithIdp",ii(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ya(t,e){return gr(t,"POST","/v1/accounts:signUp",ii(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co extends un{constructor(e,n,s,i){var r;super(n.code,n.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,Co.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,i){return new Co(e,n,s,i)}}function Hp(t,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?Co._fromErrorAndOperation(t,r,e,s):r})}async function pb(t,e,n=!1){const s=await zs(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return os._forOperation(t,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _b(t,e){return hs(t,"POST","/v1/accounts:update",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wb(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const s=Ke(t),r={idToken:await s.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await zs(s,_b(s.auth,r));s.displayName=o.displayName||null,s.photoURL=o.photoUrl||null;const a=s.providerData.find(({providerId:l})=>l==="password");a&&(a.displayName=s.displayName,a.photoURL=s.photoURL),await s._updateTokensIfNecessary(o)}function bb(t,e,n,s){return Ke(t).onIdTokenChanged(e,n,s)}function Eb(t,e,n){return Ke(t).beforeAuthStateChanged(e,n)}function Ib(t){return Ke(t).signOut()}const So="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zb="pendingRedirect",oo=new Map;class Kb extends Zp{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=oo.get(this.auth._key());if(!e){try{const s=await Wb(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}oo.set(this.auth._key(),e)}return this.bypassAuthState||oo.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Wb(t,e){const n=Yb(e),s=Qb(t);if(!await s._isAvailable())return!1;const i=await s._get(n)==="true";return await s._remove(n),i}function Gb(t,e){oo.set(t._key(),e)}function Qb(t){return en(t._redirectPersistence)}function Yb(t){return ro(zb,t.config.apiKey,t.name)}async function Jb(t,e,n=!1){const s=ri(t),i=Bb(s,e),o=await new Kb(s,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tE(t,e={}){return hs(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ja="webStorageSupport";class AE{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Gp,this._completeRedirectFn=Jb,this._overrideRedirectResult=Gb}async _openPopup(e,n,s,i){var r;sn((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await id(e,n,s,Pl(),i);return bE(e,o,Uc())}async _openRedirect(e,n,s,i){await this._originValidation(e);const r=await id(e,n,s,Pl(),i);return Db(r),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:r}=this.eventManagers[n];return i?Promise.resolve(i):(sn(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await gE(e),s=new Zb(e);return n.register("authEvent",i=>(G(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Ja,{type:Ja},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[Ja];o!==void 0&&n(!!o),Pt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=iE(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Mp()||xc()||na()}}const kE=AE;var rd="@firebase/auth",od="0.23.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DE(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function PE(t){qs(new ss("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=s.options;G(o&&!o.includes(":"),"invalid-api-key",{appName:s.name});const l={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Lp(t)},c=new nb(s,i,r,l);return ib(c,n),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),qs(new ss("auth-internal",e=>{const n=ri(e.getProvider("auth").getImmediate());return(s=>new RE(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Rn(rd,od,DE(t)),Rn(rd,od,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),e}function nu(t,e,n){e:{for(s in n){var s=!1;break e}s=!0}s||(n=jg(n),typeof t=="string"?n!=null&&encodeURIComponent(String(n)):we(t,e,n))}function mi(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function Hg(t){this.Ga=0,this.j=[],this.l=new ua,this.pa=this.wa=this.I=this.Y=this.g=this.Da=this.F=this.na=this.o=this.U=this.s=null,this.fb=this.W=0,this.cb=mi("failFast",!1,t),this.G=this.v=this.u=this.m=this.h=null,this.aa=!0,this.Fa=this.V=-1,this.ba=this.A=this.C=0,this.ab=mi("baseRetryDelayMs",5e3,t),this.hb=mi("retryDelaySeedMs",1e4,t),this.eb=mi("forwardChannelMaxRetries",2,t),this.xa=mi("forwardChannelRequestTimeoutMs",2e4,t),this.va=t&&t.xmlHttpFactory||void 0,this.Ha=t&&t.dc||!1,this.L=void 0,this.J=t&&t.supportsCrossDomainXhr||!1,this.K="",this.i=new Ng(t&&t.concurrentRequestLimit),this.Ja=new CI,this.P=t&&t.fastHandshake||!1,this.O=t&&t.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.bb=t&&t.bc||!1,t&&t.Ea&&this.l.Ea(),t&&t.forceLongPolling&&(this.aa=!1),this.ca=!this.P&&this.aa&&t&&t.detectBufferingProxy||!1,this.qa=void 0,t&&t.longPollingTimeout&&0<t.longPollingTimeout&&(this.qa=t.longPollingTimeout),this.oa=void 0,this.S=0,this.M=!1,this.ma=this.B=null}P=Hg.prototype;P.ra=8;P.H=1;function su(t){if(qg(t),t.H==3){var e=t.W++,n=rn(t.I);if(we(n,"SID",t.K),we(n,"RID",e),we(n,"TYPE","terminate"),Sr(t,n),e=new Er(t,t.l,e),e.L=2,e.v=ga(rn(n)),n=!1,Q.navigator&&Q.navigator.sendBeacon)try{n=Q.navigator.sendBeacon(e.v.toString(),"")}catch{}!n&&Q.Image&&(new Image().src=e.v,n=!0),n||(e.g=Xg(e.l,null),e.g.ha(e.v)),e.G=Date.now(),Ir(e)}Yg(t)}function va(t){t.g&&(ru(t),t.g.cancel(),t.g=null)}function qg(t){va(t),t.u&&(Q.clearTimeout(t.u),t.u=null),Po(t),t.i.cancel(),t.m&&(typeof t.m=="number"&&Q.clearTimeout(t.m),t.m=null)}function _a(t){if(!Og(t.i)&&!t.m){t.m=!0;var e=t.Na;Ji||fg(),Xi||(Ji(),Xi=!0),Gc.add(e,t),t.C=0}}function OI(t,e){return xg(t.i)>=t.i.j-(t.m?1:0)?!1:t.m?(t.j=e.F.concat(t.j),!0):t.H==1||t.H==2||t.C>=(t.cb?0:t.eb)?!1:(t.m=wr(nt(t.Na,t,e),Qg(t,t.C)),t.C++,!0)}P.Na=function(t){if(this.m)if(this.m=null,this.H==1){if(!t){this.W=Math.floor(1e5*Math.random()),t=this.W++;const i=new Er(this,this.l,t);let r=this.s;if(this.U&&(r?(r=rg(r),og(r,this.U)):r=this.U),this.o!==null||this.O||(i.I=r,r=null),this.P)e:{for(var e=0,n=0;n<this.j.length;n++){t:{var s=this.j[n];if("__data__"in s.map&&(s=s.map.__data__,typeof s=="string")){s=s.length;break t}s=void 0}if(s===void 0)break;if(e+=s,4096<e){e=n;break e}if(e===4096||n===this.j.length-1){e=n+1;break e}}e=1e3}else e=1e3;e=zg(this,i,e),n=rn(this.I),we(n,"RID",t),we(n,"CVER",22),this.F&&we(n,"X-HTTP-Session-Id",this.F),Sr(this,n),r&&(this.O?e="headers="+encodeURIComponent(String(jg(r)))+"&"+e:this.o&&nu(n,this.o,r)),eu(this.i,i),this.bb&&we(n,"TYPE","init"),this.P?(we(n,"$req",e),we(n,"SID","null"),i.aa=!0,Bl(i,n,null)):Bl(i,n,e),this.H=2}}else this.H==3&&(t?vd(this,t):this.j.length==0||Og(this.i)||vd(this))};function vd(t,e){var n;e?n=e.m:n=t.W++;const s=rn(t.I);we(s,"SID",t.K),we(s,"RID",n),we(s,"AID",t.V),Sr(t,s),t.o&&t.s&&nu(s,t.o,t.s),n=new Er(t,t.l,n,t.C+1),t.o===null&&(n.I=t.s),e&&(t.j=e.F.concat(t.j)),e=zg(t,n,1e3),n.setTimeout(Math.round(.5*t.xa)+Math.round(.5*t.xa*Math.random())),eu(t.i,n),Bl(n,s,e)}function Sr(t,e){t.na&&jc(t.na,function(n,s){we(e,s,n)}),t.h&&Ag({},function(n,s){we(e,s,n)})}function zg(t,e,n){n=Math.min(t.j.length,n);var s=t.h?nt(t.h.Va,t.h,t):null;e:{var i=t.j;let r=-1;for(;;){const o=["count="+n];r==-1?0<n?(r=i[0].g,o.push("ofs="+r)):r=0:o.push("ofs="+r);let a=!0;for(let l=0;l<n;l++){let c=i[l].g;const u=i[l].map;if(c-=r,0>c)r=Math.max(0,i[l].g-100),a=!1;else try{SI(u,o,"req"+c+"_")}catch{s&&s(u)}}if(a){s=o.join("&");break e}}}return t=t.j.splice(0,n),e.F=t,s}function Kg(t){if(!t.g&&!t.u){t.ba=1;var e=t.Ma;Ji||fg(),Xi||(Ji(),Xi=!0),Gc.add(e,t),t.A=0}}function iu(t){return t.g||t.u||3<=t.A?!1:(t.ba++,t.u=wr(nt(t.Ma,t),Qg(t,t.A)),t.A++,!0)}P.Ma=function(){if(this.u=null,Wg(this),this.ca&&!(this.M||this.g==null||0>=this.S)){var t=2*this.S;this.l.info("BP detection timer enabled: "+t),this.B=wr(nt(this.jb,this),t)}};P.jb=function(){this.B&&(this.B=null,this.l.info("BP detection timeout reached."),this.l.info("Buffering proxy detected and switch to long-polling!"),this.G=!1,this.M=!0,lt(10),va(this),Wg(this))};function ru(t){t.B!=null&&(Q.clearTimeout(t.B),t.B=null)}function Wg(t){t.g=new Er(t,t.l,"rpc",t.ba),t.o===null&&(t.g.I=t.s),t.g.O=0;var e=rn(t.wa);we(e,"RID","rpc"),we(e,"SID",t.K),we(e,"AID",t.V),we(e,"CI",t.G?"0":"1"),!t.G&&t.qa&&we(e,"TO",t.qa),we(e,"TYPE","xmlhttp"),Sr(t,e),t.o&&t.s&&nu(e,t.o,t.s),t.L&&t.g.setTimeout(t.L);var n=t.g;t=t.pa,n.L=1,n.v=ga(rn(e)),n.s=null,n.S=!0,Ig(n,t)}P.ib=function(){this.v!=null&&(this.v=null,va(this),iu(this),lt(19))};function Po(t){t.v!=null&&(Q.clearTimeout(t.v),t.v=null)}function Gg(t,e){var n=null;if(t.g==e){Po(t),ru(t),t.g=null;var s=2}else if(jl(t.i,e))n=e.F,Mg(t.i,e),s=1;else return;if(t.H!=0){if(e.i)if(s==1){n=e.s?e.s.length:0,e=Date.now()-e.G;var i=t.C;s=ha(),ze(s,new _g(s,n)),_a(t)}else Kg(t);else if(i=e.o,i==3||i==0&&0<e.ca||!(s==1&&OI(t,e)||s==2&&iu(t)))switch(n&&0<n.length&&(e=t.i,e.i=e.i.concat(n)),i){case 1:Yn(t,5);break;case 4:Yn(t,10);break;case 3:Yn(t,6);break;default:Yn(t,2)}}}function Qg(t,e){let n=t.ab+Math.floor(Math.random()*t.hb);return t.isActive()||(n*=2),n*e}function Yn(t,e){if(t.l.info("Error code "+e),e==2){var n=null;t.h&&(n=null);var s=nt(t.pb,t);n||(n=new ts("//www.google.com/images/cleardot.gif"),Q.location&&Q.location.protocol=="http"||Ro(n,"https"),ga(n)),AI(n.toString(),s)}else lt(2);t.H=0,t.h&&t.h.za(e),Yg(t),qg(t)}P.pb=function(t){t?(this.l.info("Successfully pinged google.com"),lt(2)):(this.l.info("Failed to ping google.com"),lt(1))};function Yg(t){if(t.H=0,t.ma=[],t.h){const e=Lg(t.i);(e.length!=0||t.j.length!=0)&&(ld(t.ma,e),ld(t.ma,t.j),t.i.i.length=0,Bc(t.j),t.j.length=0),t.h.ya()}}function Jg(t,e,n){var s=n instanceof ts?rn(n):new ts(n);if(s.g!="")e&&(s.g=e+"."+s.g),Do(s,s.m);else{var i=Q.location;s=i.protocol,e=e?e+"."+i.hostname:i.hostname,i=+i.port;var r=new ts(null);s&&Ro(r,s),e&&(r.g=e),i&&Do(r,i),n&&(r.l=n),s=r}return n=t.F,e=t.Da,n&&e&&we(s,n,e),we(s,"VER",t.ra),Sr(t,s),s}function Xg(t,e,n){if(e&&!t.J)throw Error("Can't create secondary domain capable XhrIo object.");return e=n&&t.Ha&&!t.va?new Ae(new Tr({ob:!0})):new Ae(t.va),e.Oa(t.J),e}P.isActive=function(){return!!this.h&&this.h.isActive(this)};function Zg(){}P=Zg.prototype;P.Ba=function(){};P.Aa=function(){};P.za=function(){};P.ya=function(){};P.isActive=function(){return!0};P.Va=function(){};function No(){if(Ks&&!(10<=Number(KE)))throw Error("Environmental error: no available transport.")}No.prototype.g=function(t,e){return new _t(t,e)};function _t(t,e){$e.call(this),this.g=new Hg(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.Ca&&(t?t["X-WebChannel-Client-Profile"]=e.Ca:t={"X-WebChannel-Client-Profile":e.Ca}),this.g.U=t,(t=e&&e.cc)&&!Qi(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!Qi(e)&&(this.g.F=e,t=this.h,t!==null&&e in t&&(t=this.h,e in t&&delete t[e])),this.j=new li(this)}Be(_t,$e);_t.prototype.m=function(){this.g.h=this.j,this.A&&(this.g.J=!0);var t=this.g,e=this.l,n=this.h||void 0;lt(0),t.Y=e,t.na=n||{},t.G=t.aa,t.I=Jg(t,null,t.Y),_a(t)};_t.prototype.close=function(){su(this.g)};_t.prototype.u=function(t){var e=this.g;if(typeof t=="string"){var n={};n.__data__=t,t=n}else this.v&&(n={},n.__data__=Wc(t),t=n);e.j.push(new EI(e.fb++,t)),e.H==3&&_a(e)};_t.prototype.N=function(){this.g.h=null,delete this.j,su(this.g),delete this.g,_t.$.N.call(this)};function em(t){Xc.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var e=t.__sm__;if(e){e:{for(const n in e){t=n;break e}t=void 0}(this.i=t)&&(t=this.i,e=e!==null&&t in e?e[t]:void 0),this.data=e}else this.data=t}Be(em,Xc);function tm(){Zc.call(this),this.status=1}Be(tm,Zc);function li(t){this.g=t}Be(li,Zg);li.prototype.Ba=function(){ze(this.g,"a")};li.prototype.Aa=function(t){ze(this.g,new em(t))};li.prototype.za=function(t){ze(this.g,new tm)};li.prototype.ya=function(){ze(this.g,"b")};function xI(){this.blockSize=-1}function Nt(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.m=Array(this.blockSize),this.i=this.h=0,this.reset()}Be(Nt,xI);Nt.prototype.reset=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.i=this.h=0};function il(t,e,n){n||(n=0);var s=Array(16);if(typeof e=="string")for(var i=0;16>i;++i)s[i]=e.charCodeAt(n++)|e.charCodeAt(n++)<<8|e.charCodeAt(n++)<<16|e.charCodeAt(n++)<<24;else for(i=0;16>i;++i)s[i]=e[n++]|e[n++]<<8|e[n++]<<16|e[n++]<<24;e=t.g[0],n=t.g[1],i=t.g[2];var r=t.g[3],o=e+(r^n&(i^r))+s[0]+3614090360&4294967295;e=n+(o<<7&4294967295|o>>>25),o=r+(i^e&(n^i))+s[1]+3905402710&4294967295,r=e+(o<<12&4294967295|o>>>20),o=i+(n^r&(e^n))+s[2]+606105819&4294967295,i=r+(o<<17&4294967295|o>>>15),o=n+(e^i&(r^e))+s[3]+3250441966&4294967295,n=i+(o<<22&4294967295|o>>>10),o=e+(r^n&(i^r))+s[4]+4118548399&4294967295,e=n+(o<<7&4294967295|o>>>25),o=r+(i^e&(n^i))+s[5]+1200080426&4294967295,r=e+(o<<12&4294967295|o>>>20),o=i+(n^r&(e^n))+s[6]+2821735955&4294967295,i=r+(o<<17&4294967295|o>>>15),o=n+(e^i&(r^e))+s[7]+4249261313&4294967295,n=i+(o<<22&4294967295|o>>>10),o=e+(r^n&(i^r))+s[8]+1770035416&4294967295,e=n+(o<<7&4294967295|o>>>25),o=r+(i^e&(n^i))+s[9]+2336552879&4294967295,r=e+(o<<12&4294967295|o>>>20),o=i+(n^r&(e^n))+s[10]+4294925233&4294967295,i=r+(o<<17&4294967295|o>>>15),o=n+(e^i&(r^e))+s[11]+2304563134&4294967295,n=i+(o<<22&4294967295|o>>>10),o=e+(r^n&(i^r))+s[12]+1804603682&4294967295,e=n+(o<<7&4294967295|o>>>25),o=r+(i^e&(n^i))+s[13]+4254626195&4294967295,r=e+(o<<12&4294967295|o>>>20),o=i+(n^r&(e^n))+s[14]+2792965006&4294967295,i=r+(o<<17&4294967295|o>>>15),o=n+(e^i&(r^e))+s[15]+1236535329&4294967295,n=i+(o<<22&4294967295|o>>>10),o=e+(i^r&(n^i))+s[1]+4129170786&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^i&(e^n))+s[6]+3225465664&4294967295,r=e+(o<<9&4294967295|o>>>23),o=i+(e^n&(r^e))+s[11]+643717713&4294967295,i=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(i^r))+s[0]+3921069994&4294967295,n=i+(o<<20&4294967295|o>>>12),o=e+(i^r&(n^i))+s[5]+3593408605&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^i&(e^n))+s[10]+38016083&4294967295,r=e+(o<<9&4294967295|o>>>23),o=i+(e^n&(r^e))+s[15]+3634488961&4294967295,i=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(i^r))+s[4]+3889429448&4294967295,n=i+(o<<20&4294967295|o>>>12),o=e+(i^r&(n^i))+s[9]+568446438&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^i&(e^n))+s[14]+3275163606&4294967295,r=e+(o<<9&4294967295|o>>>23),o=i+(e^n&(r^e))+s[3]+4107603335&4294967295,i=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(i^r))+s[8]+1163531501&4294967295,n=i+(o<<20&4294967295|o>>>12),o=e+(i^r&(n^i))+s[13]+2850285829&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^i&(e^n))+s[2]+4243563512&4294967295,r=e+(o<<9&4294967295|o>>>23),o=i+(e^n&(r^e))+s[7]+1735328473&4294967295,i=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(i^r))+s[12]+2368359562&4294967295,n=i+(o<<20&4294967295|o>>>12),o=e+(n^i^r)+s[5]+4294588738&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^i)+s[8]+2272392833&4294967295,r=e+(o<<11&4294967295|o>>>21),o=i+(r^e^n)+s[11]+1839030562&4294967295,i=r+(o<<16&4294967295|o>>>16),o=n+(i^r^e)+s[14]+4259657740&4294967295,n=i+(o<<23&4294967295|o>>>9),o=e+(n^i^r)+s[1]+2763975236&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^i)+s[4]+1272893353&4294967295,r=e+(o<<11&4294967295|o>>>21),o=i+(r^e^n)+s[7]+4139469664&4294967295,i=r+(o<<16&4294967295|o>>>16),o=n+(i^r^e)+s[10]+3200236656&4294967295,n=i+(o<<23&4294967295|o>>>9),o=e+(n^i^r)+s[13]+681279174&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^i)+s[0]+3936430074&4294967295,r=e+(o<<11&4294967295|o>>>21),o=i+(r^e^n)+s[3]+3572445317&4294967295,i=r+(o<<16&4294967295|o>>>16),o=n+(i^r^e)+s[6]+76029189&4294967295,n=i+(o<<23&4294967295|o>>>9),o=e+(n^i^r)+s[9]+3654602809&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^i)+s[12]+3873151461&4294967295,r=e+(o<<11&4294967295|o>>>21),o=i+(r^e^n)+s[15]+530742520&4294967295,i=r+(o<<16&4294967295|o>>>16),o=n+(i^r^e)+s[2]+3299628645&4294967295,n=i+(o<<23&4294967295|o>>>9),o=e+(i^(n|~r))+s[0]+4096336452&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~i))+s[7]+1126891415&4294967295,r=e+(o<<10&4294967295|o>>>22),o=i+(e^(r|~n))+s[14]+2878612391&4294967295,i=r+(o<<15&4294967295|o>>>17),o=n+(r^(i|~e))+s[5]+4237533241&4294967295,n=i+(o<<21&4294967295|o>>>11),o=e+(i^(n|~r))+s[12]+1700485571&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~i))+s[3]+2399980690&4294967295,r=e+(o<<10&4294967295|o>>>22),o=i+(e^(r|~n))+s[10]+4293915773&4294967295,i=r+(o<<15&4294967295|o>>>17),o=n+(r^(i|~e))+s[1]+2240044497&4294967295,n=i+(o<<21&4294967295|o>>>11),o=e+(i^(n|~r))+s[8]+1873313359&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~i))+s[15]+4264355552&4294967295,r=e+(o<<10&4294967295|o>>>22),o=i+(e^(r|~n))+s[6]+2734768916&4294967295,i=r+(o<<15&4294967295|o>>>17),o=n+(r^(i|~e))+s[13]+1309151649&4294967295,n=i+(o<<21&4294967295|o>>>11),o=e+(i^(n|~r))+s[4]+4149444226&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~i))+s[11]+3174756917&4294967295,r=e+(o<<10&4294967295|o>>>22),o=i+(e^(r|~n))+s[2]+718787259&4294967295,i=r+(o<<15&4294967295|o>>>17),o=n+(r^(i|~e))+s[9]+3951481745&4294967295,t.g[0]=t.g[0]+e&4294967295,t.g[1]=t.g[1]+(i+(o<<21&4294967295|o>>>11))&4294967295,t.g[2]=t.g[2]+i&4294967295,t.g[3]=t.g[3]+r&4294967295}Nt.prototype.j=function(t,e){e===void 0&&(e=t.length);for(var n=e-this.blockSize,s=this.m,i=this.h,r=0;r<e;){if(i==0)for(;r<=n;)il(this,t,r),r+=this.blockSize;if(typeof t=="string"){for(;r<e;)if(s[i++]=t.charCodeAt(r++),i==this.blockSize){il(this,s),i=0;break}}else for(;r<e;)if(s[i++]=t[r++],i==this.blockSize){il(this,s),i=0;break}}this.h=i,this.i+=e};Nt.prototype.l=function(){var t=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);t[0]=128;for(var e=1;e<t.length-8;++e)t[e]=0;var n=8*this.i;for(e=t.length-8;e<t.length;++e)t[e]=n&255,n/=256;for(this.j(t),t=Array(16),e=n=0;4>e;++e)for(var s=0;32>s;s+=8)t[n++]=this.g[e]>>>s&255;return t};function pe(t,e){this.h=e;for(var n=[],s=!0,i=t.length-1;0<=i;i--){var r=t[i]|0;s&&r==e||(n[i]=r,s=!1)}this.g=n}var MI={};function ou(t){return-128<=t&&128>t?HE(t,function(e){return new pe([e|0],0>e?-1:0)}):new pe([t|0],0>t?-1:0)}function Vt(t){if(isNaN(t)||!isFinite(t))return Os;if(0>t)return He(Vt(-t));for(var e=[],n=1,s=0;t>=n;s++)e[s]=t/n|0,n*=Hl;return new pe(e,0)}function nm(t,e){if(t.length==0)throw Error("number format error: empty string");if(e=e||10,2>e||36<e)throw Error("radix out of range: "+e);if(t.charAt(0)=="-")return He(nm(t.substring(1),e));if(0<=t.indexOf("-"))throw Error('number format error: interior "-" character');for(var n=Vt(Math.pow(e,8)),s=Os,i=0;i<t.length;i+=8){var r=Math.min(8,t.length-i),o=parseInt(t.substring(i,i+r),e);8>r?(r=Vt(Math.pow(e,r)),s=s.R(r).add(Vt(o))):(s=s.R(n),s=s.add(Vt(o)))}return s}var Hl=4294967296,Os=ou(0),ql=ou(1),_d=ou(16777216);P=pe.prototype;P.ea=function(){if(bt(this))return-He(this).ea();for(var t=0,e=1,n=0;n<this.g.length;n++){var s=this.D(n);t+=(0<=s?s:Hl+s)*e,e*=Hl}return t};P.toString=function(t){if(t=t||10,2>t||36<t)throw Error("radix out of range: "+t);if(tn(this))return"0";if(bt(this))return"-"+He(this).toString(t);for(var e=Vt(Math.pow(t,6)),n=this,s="";;){var i=xo(n,e).g;n=Oo(n,i.R(e));var r=((0<n.g.length?n.g[0]:n.h)>>>0).toString(t);if(n=i,tn(n))return r+s;for(;6>r.length;)r="0"+r;s=r+s}};P.D=function(t){return 0>t?0:t<this.g.length?this.g[t]:this.h};function tn(t){if(t.h!=0)return!1;for(var e=0;e<t.g.length;e++)if(t.g[e]!=0)return!1;return!0}function bt(t){return t.h==-1}P.X=function(t){return t=Oo(this,t),bt(t)?-1:tn(t)?0:1};function He(t){for(var e=t.g.length,n=[],s=0;s<e;s++)n[s]=~t.g[s];return new pe(n,~t.h).add(ql)}P.abs=function(){return bt(this)?He(this):this};P.add=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],s=0,i=0;i<=e;i++){var r=s+(this.D(i)&65535)+(t.D(i)&65535),o=(r>>>16)+(this.D(i)>>>16)+(t.D(i)>>>16);s=o>>>16,r&=65535,o&=65535,n[i]=o<<16|r}return new pe(n,n[n.length-1]&-2147483648?-1:0)};function Oo(t,e){return t.add(He(e))}P.R=function(t){if(tn(this)||tn(t))return Os;if(bt(this))return bt(t)?He(this).R(He(t)):He(He(this).R(t));if(bt(t))return He(this.R(He(t)));if(0>this.X(_d)&&0>t.X(_d))return Vt(this.ea()*t.ea());for(var e=this.g.length+t.g.length,n=[],s=0;s<2*e;s++)n[s]=0;for(s=0;s<this.g.length;s++)for(var i=0;i<t.g.length;i++){var r=this.D(s)>>>16,o=this.D(s)&65535,a=t.D(i)>>>16,l=t.D(i)&65535;n[2*s+2*i]+=o*l,zr(n,2*s+2*i),n[2*s+2*i+1]+=r*l,zr(n,2*s+2*i+1),n[2*s+2*i+1]+=o*a,zr(n,2*s+2*i+1),n[2*s+2*i+2]+=r*a,zr(n,2*s+2*i+2)}for(s=0;s<e;s++)n[s]=n[2*s+1]<<16|n[2*s];for(s=e;s<2*e;s++)n[s]=0;return new pe(n,0)};function zr(t,e){for(;(t[e]&65535)!=t[e];)t[e+1]+=t[e]>>>16,t[e]&=65535,e++}function yi(t,e){this.g=t,this.h=e}function xo(t,e){if(tn(e))throw Error("division by zero");if(tn(t))return new yi(Os,Os);if(bt(t))return e=xo(He(t),e),new yi(He(e.g),He(e.h));if(bt(e))return e=xo(t,He(e)),new yi(He(e.g),e.h);if(30<t.g.length){if(bt(t)||bt(e))throw Error("slowDivide_ only works with positive integers.");for(var n=ql,s=e;0>=s.X(t);)n=wd(n),s=wd(s);var i=ws(n,1),r=ws(s,1);for(s=ws(s,2),n=ws(n,2);!tn(s);){var o=r.add(s);0>=o.X(t)&&(i=i.add(n),r=o),s=ws(s,1),n=ws(n,1)}return e=Oo(t,i.R(e)),new yi(i,e)}for(i=Os;0<=t.X(e);){for(n=Math.max(1,Math.floor(t.ea()/e.ea())),s=Math.ceil(Math.log(n)/Math.LN2),s=48>=s?1:Math.pow(2,s-48),r=Vt(n),o=r.R(e);bt(o)||0<o.X(t);)n-=s,r=Vt(n),o=r.R(e);tn(r)&&(r=ql),i=i.add(r),t=Oo(t,o)}return new yi(i,t)}P.gb=function(t){return xo(this,t).h};P.and=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],s=0;s<e;s++)n[s]=this.D(s)&t.D(s);return new pe(n,this.h&t.h)};P.or=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],s=0;s<e;s++)n[s]=this.D(s)|t.D(s);return new pe(n,this.h|t.h)};P.xor=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],s=0;s<e;s++)n[s]=this.D(s)^t.D(s);return new pe(n,this.h^t.h)};function wd(t){for(var e=t.g.length+1,n=[],s=0;s<e;s++)n[s]=t.D(s)<<1|t.D(s-1)>>>31;return new pe(n,t.h)}function ws(t,e){var n=e>>5;e%=32;for(var s=t.g.length-n,i=[],r=0;r<s;r++)i[r]=0<e?t.D(r+n)>>>e|t.D(r+n+1)<<32-e:t.D(r+n);return new pe(i,t.h)}No.prototype.createWebChannel=No.prototype.g;_t.prototype.send=_t.prototype.u;_t.prototype.open=_t.prototype.m;_t.prototype.close=_t.prototype.close;da.NO_ERROR=0;da.TIMEOUT=8;da.HTTP_ERROR=6;wg.COMPLETE="complete";bg.EventType=br;br.OPEN="a";br.CLOSE="b";br.ERROR="c";br.MESSAGE="d";$e.prototype.listen=$e.prototype.O;Ae.prototype.listenOnce=Ae.prototype.P;Ae.prototype.getLastError=Ae.prototype.Sa;Ae.prototype.getLastErrorCode=Ae.prototype.Ia;Ae.prototype.getStatus=Ae.prototype.da;Ae.prototype.getResponseJson=Ae.prototype.Wa;Ae.prototype.getResponseText=Ae.prototype.ja;Ae.prototype.send=Ae.prototype.ha;Ae.prototype.setWithCredentials=Ae.prototype.Oa;Nt.prototype.digest=Nt.prototype.l;Nt.prototype.reset=Nt.prototype.reset;Nt.prototype.update=Nt.prototype.j;pe.prototype.add=pe.prototype.add;pe.prototype.multiply=pe.prototype.R;pe.prototype.modulo=pe.prototype.gb;pe.prototype.compare=pe.prototype.X;pe.prototype.toNumber=pe.prototype.ea;pe.prototype.toString=pe.prototype.toString;pe.prototype.getBits=pe.prototype.D;pe.fromNumber=Vt;pe.fromString=nm;var LI=function(){return new No},UI=function(){return ha()},rl=da,FI=wg,$I=ds,bd={xb:0,Ab:1,Bb:2,Ub:3,Zb:4,Wb:5,Xb:6,Vb:7,Tb:8,Yb:9,PROXY:10,NOPROXY:11,Rb:12,Nb:13,Ob:14,Mb:15,Pb:16,Qb:17,tb:18,sb:19,ub:20},BI=Tr,Kr=bg,VI=Ae,jI=Nt,xs=pe;const Ed="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as=new Ac("@firebase/firestore");function Id(){return as.logLevel}function B(t,...e){if(as.logLevel<=le.DEBUG){const n=e.map(au);as.debug(`Firestore (${ci}): ${t}`,...n)}}function on(t,...e){if(as.logLevel<=le.ERROR){const n=e.map(au);as.error(`Firestore (${ci}): ${t}`,...n)}}function Ws(t,...e){if(as.logLevel<=le.WARN){const n=e.map(au);as.warn(`Firestore (${ci}): ${t}`,...n)}}function au(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Td(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function fs(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function rm(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(e){this.value=e}static empty(){return new ht({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let s=0;s<e.length-1;++s)if(n=(n.mapValue.fields||{})[e.get(s)],!lo(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=Oi(n)}setAll(e){let n=et.emptyPath(),s={},i=[];e.forEach((o,a)=>{if(!n.isImmediateParentOf(a)){const l=this.getFieldsMap(n);this.applyChanges(l,s,i),s={},i=[],n=a.popLast()}o?s[a.lastSegment()]=Oi(o):i.push(a.lastSegment())});const r=this.getFieldsMap(n);this.applyChanges(r,s,i)}delete(e){const n=this.field(e.popLast());lo(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return Gt(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let s=0;s<e.length;++s){let i=n.mapValue.fields[e.get(s)];lo(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},n.mapValue.fields[e.get(s)]=i),n=i}return n.mapValue.fields}applyChanges(e,n,s){fs(n,(i,r)=>e[i]=r);for(const i of s)delete e[i]}clone(){return new ht(Oi(this.value))}}function am(t){const e=[];return fs(t.fields,(n,s)=>{const i=new et([n]);if(lo(s)){const r=am(s.mapValue).fields;if(r.length===0)e.push(i);else for(const o of r)e.push(i.child(o))}else e.push(i)}),new vt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ba{constructor(e,n=null,s=[],i=[],r=null,o="F",a=null,l=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=s,this.filters=i,this.limit=r,this.limitType=o,this.startAt=a,this.endAt=l,this.wt=null,this._t=null,this.startAt,this.endAt}}function yT(t,e,n,s,i,r,o,a){return new ba(t,e,n,s,i,r,o,a)}function pu(t){return new ba(t)}function Nd(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function vT(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function _T(t){for(const e of t.filters){const n=e.getFirstInequalityField();if(n!==null)return n}return null}function wT(t){return t.collectionGroup!==null}function Ms(t){const e=Z(t);if(e.wt===null){e.wt=[];const n=_T(e),s=vT(e);if(n!==null&&s===null)n.isKeyField()||e.wt.push(new xi(n)),e.wt.push(new xi(et.keyField(),"asc"));else{let i=!1;for(const r of e.explicitOrderBy)e.wt.push(r),r.field.isKeyField()&&(i=!0);if(!i){const r=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.wt.push(new xi(et.keyField(),r))}}}return e.wt}function an(t){const e=Z(t);if(!e._t)if(e.limitType==="F")e._t=Pd(e.path,e.collectionGroup,Ms(e),e.filters,e.limit,e.startAt,e.endAt);else{const n=[];for(const r of Ms(e)){const o=r.dir==="desc"?"asc":"desc";n.push(new xi(r.field,o))}const s=e.endAt?new Lo(e.endAt.position,e.endAt.inclusive):null,i=e.startAt?new Lo(e.startAt.position,e.startAt.inclusive):null;e._t=Pd(e.path,e.collectionGroup,n,e.filters,e.limit,s,i)}return e._t}function Ql(t,e,n){return new ba(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Ea(t,e){return fu(an(t),an(e))&&t.limitType===e.limitType}function pm(t){return`${du(an(t))}|lt:${t.limitType}`}function Yl(t){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(s=>dm(s)).join(", ")}]`),wa(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(s=>function(i){return`${i.field.canonicalString()} (${i.dir})`}(s)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(s=>Ys(s)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(s=>Ys(s)).join(",")),`Target(${n})`}(an(t))}; limitType=${t.limitType})`}function Ia(t,e){return e.isFoundDocument()&&function(n,s){const i=s.key.path;return n.collectionGroup!==null?s.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(i):z.isDocumentKey(n.path)?n.path.isEqual(i):n.path.isImmediateParentOf(i)}(t,e)&&function(n,s){for(const i of Ms(n))if(!i.field.isKeyField()&&s.data.field(i.field)===null)return!1;return!0}(t,e)&&function(n,s){for(const i of n.filters)if(!i.matches(s))return!1;return!0}(t,e)&&function(n,s){return!(n.startAt&&!function(i,r,o){const a=Rd(i,r,o);return i.inclusive?a<=0:a<0}(n.startAt,Ms(n),s)||n.endAt&&!function(i,r,o){const a=Rd(i,r,o);return i.inclusive?a>=0:a>0}(n.endAt,Ms(n),s))}(t,e)}function bT(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function gm(t){return(e,n)=>{let s=!1;for(const i of Ms(t)){const r=ET(i,e,n);if(r!==0)return r;s=s||i.field.isKeyField()}return 0}}function ET(t,e,n){const s=t.field.isKeyField()?z.comparator(e.key,n.key):function(i,r,o){const a=r.data.field(i),l=o.data.field(i);return a!==null&&l!==null?Qs(a,l):Y()}(t.field,e,n);switch(t.dir){case"asc":return s;case"desc":return-1*s;default:return Y()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(e,n){this.mapKeyFn=e,this.equalsFn=n,this.inner={},this.innerSize=0}get(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s!==void 0){for(const[i,r]of s)if(this.equalsFn(i,e))return r}}has(e){return this.get(e)!==void 0}set(e,n){const s=this.mapKeyFn(e),i=this.inner[s];if(i===void 0)return this.inner[s]=[[e,n]],void this.innerSize++;for(let r=0;r<i.length;r++)if(this.equalsFn(i[r][0],e))return void(i[r]=[e,n]);i.push([e,n]),this.innerSize++}delete(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s===void 0)return!1;for(let i=0;i<s.length;i++)if(this.equalsFn(s[i][0],e))return s.length===1?delete this.inner[n]:s.splice(i,1),this.innerSize--,!0;return!1}forEach(e){fs(this.inner,(n,s)=>{for(const[i,r]of s)e(i,r)})}isEmpty(){return rm(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VT=new xs([4294967295,4294967295],0);function Ud(t){const e=BT().encode(t),n=new jI;return n.update(e),new Uint8Array(n.digest())}function Fd(t){const e=new DataView(t.buffer),n=e.getUint32(0,!0),s=e.getUint32(4,!0),i=e.getUint32(8,!0),r=e.getUint32(12,!0);return[new xs([n,s],0),new xs([i,r],0)]}class yu{constructor(e,n,s){if(this.bitmap=e,this.padding=n,this.hashCount=s,n<0||n>=8)throw new Ci(`Invalid padding: ${n}`);if(s<0)throw new Ci(`Invalid hash count: ${s}`);if(e.length>0&&this.hashCount===0)throw new Ci(`Invalid hash count: ${s}`);if(e.length===0&&n!==0)throw new Ci(`Invalid padding when bitmap length is 0: ${n}`);this.It=8*e.length-n,this.Tt=xs.fromNumber(this.It)}Et(e,n,s){let i=e.add(n.multiply(xs.fromNumber(s)));return i.compare(VT)===1&&(i=new xs([i.getBits(0),i.getBits(1)],0)),i.modulo(this.Tt).toNumber()}At(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}vt(e){if(this.It===0)return!1;const n=Ud(e),[s,i]=Fd(n);for(let r=0;r<this.hashCount;r++){const o=this.Et(s,i,r);if(!this.At(o))return!1}return!0}static create(e,n,s){const i=e%8==0?0:8-e%8,r=new Uint8Array(Math.ceil(e/8)),o=new yu(r,i,n);return s.forEach(a=>o.insert(a)),o}insert(e){if(this.It===0)return;const n=Ud(e),[s,i]=Fd(n);for(let r=0;r<this.hashCount;r++){const o=this.Et(s,i,r);this.Rt(o)}}Rt(e){const n=Math.floor(e/8),s=e%8;this.bitmap[n]|=1<<s}}class Ci extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa{constructor(e,n,s,i,r){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=i,this.resolvedLimboDocuments=r}static createSynthesizedRemoteEventForCurrentChange(e,n,s){const i=new Map;return i.set(e,Dr.createSynthesizedTargetChangeForCurrentChange(e,n,s)),new Sa(X.min(),i,new Se(ce),ln(),se())}}class Dr{constructor(e,n,s,i,r){this.resumeToken=e,this.current=n,this.addedDocuments=s,this.modifiedDocuments=i,this.removedDocuments=r}static createSynthesizedTargetChangeForCurrentChange(e,n,s){return new Dr(s,n,se(),se(),se())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye="WebChannelConnection";class xC extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const n=e.ssl?"https":"http";this.mo=n+"://"+e.host,this.yo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get po(){return!1}Io(e,n,s,i,r){const o=al(),a=this.To(e,n);B("RestConnection",`Sending RPC '${e}' ${o}:`,a,s);const l={};return this.Eo(l,i,r),this.Ao(e,a,l,s).then(c=>(B("RestConnection",`Received RPC '${e}' ${o}: `,c),c),c=>{throw Ws("RestConnection",`RPC '${e}' ${o} failed with error: `,c,"url: ",a,"request:",s),c})}vo(e,n,s,i,r,o){return this.Io(e,n,s,i,r)}Eo(e,n,s){e["X-Goog-Api-Client"]="gl-js/ fire/"+ci,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((i,r)=>e[r]=i),s&&s.headers.forEach((i,r)=>e[r]=i)}To(e,n){const s=NC[e];return`${this.mo}/v1/${n}:${s}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Ao(e,n,s,i){const r=al();return new Promise((o,a)=>{const l=new VI;l.setWithCredentials(!0),l.listenOnce(FI.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case rl.NO_ERROR:const u=l.getResponseJson();B(Ye,`XHR for RPC '${e}' ${r} received:`,JSON.stringify(u)),o(u);break;case rl.TIMEOUT:B(Ye,`RPC '${e}' ${r} timed out`),a(new q(T.DEADLINE_EXCEEDED,"Request time out"));break;case rl.HTTP_ERROR:const d=l.getStatus();if(B(Ye,`RPC '${e}' ${r} failed with status:`,d,"response text:",l.getResponseText()),d>0){let f=l.getResponseJson();Array.isArray(f)&&(f=f[0]);const m=f==null?void 0:f.error;if(m&&m.status&&m.message){const w=function(E){const A=E.toLowerCase().replace(/_/g,"-");return Object.values(T).indexOf(A)>=0?A:T.UNKNOWN}(m.status);a(new q(w,m.message))}else a(new q(T.UNKNOWN,"Server responded with status "+l.getStatus()))}else a(new q(T.UNAVAILABLE,"Connection failed."));break;default:Y()}}finally{B(Ye,`RPC '${e}' ${r} completed.`)}});const c=JSON.stringify(i);B(Ye,`RPC '${e}' ${r} sending request:`,i),l.send(n,"POST",c,s,15)})}Ro(e,n,s){const i=al(),r=[this.mo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=LI(),a=UI(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(l.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(l.xmlHttpFactory=new BI({})),this.Eo(l.initMessageHeaders,n,s),l.encodeInitMessageHeaders=!0;const u=r.join("");B(Ye,`Creating RPC '${e}' stream ${i}: ${u}`,l);const d=o.createWebChannel(u,l);let f=!1,m=!1;const w=new OC({ro:A=>{m?B(Ye,`Not sending because RPC '${e}' stream ${i} is closed:`,A):(f||(B(Ye,`Opening RPC '${e}' stream ${i} transport.`),d.open(),f=!0),B(Ye,`RPC '${e}' stream ${i} sending:`,A),d.send(A))},oo:()=>d.close()}),E=(A,N,O)=>{A.listen(N,K=>{try{O(K)}catch(F){setTimeout(()=>{throw F},0)}})};return E(d,Kr.EventType.OPEN,()=>{m||B(Ye,`RPC '${e}' stream ${i} transport opened.`)}),E(d,Kr.EventType.CLOSE,()=>{m||(m=!0,B(Ye,`RPC '${e}' stream ${i} transport closed`),w.wo())}),E(d,Kr.EventType.ERROR,A=>{m||(m=!0,Ws(Ye,`RPC '${e}' stream ${i} transport errored:`,A),w.wo(new q(T.UNAVAILABLE,"The operation could not be completed")))}),E(d,Kr.EventType.MESSAGE,A=>{var N;if(!m){const O=A.data[0];Ee(!!O);const K=O,F=K.error||((N=K[0])===null||N===void 0?void 0:N.error);if(F){B(Ye,`RPC '${e}' stream ${i} received error:`,F);const Ie=F.status;let Ce=function(pt){const gt=De[pt];if(gt!==void 0)return km(gt)}(Ie),Ge=F.message;Ce===void 0&&(Ce=T.INTERNAL,Ge="Unknown error status: "+Ie+" with message "+F.message),m=!0,w.wo(new q(Ce,Ge)),d.close()}else B(Ye,`RPC '${e}' stream ${i} received:`,O),w._o(O)}}),E(a,$I.STAT_EVENT,A=>{A.stat===bd.PROXY?B(Ye,`RPC '${e}' stream ${i} detected buffering proxy`):A.stat===bd.NOPROXY&&B(Ye,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{w.fo()},0),w}}function ll(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls{constructor(e){this.comparator=e?(n,s)=>e(n,s)||z.comparator(n.key,s.key):(n,s)=>z.comparator(n.key,s.key),this.keyedMap=Ti(),this.sortedSet=new Se(this.comparator)}static emptySet(e){return new Ls(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,s)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof Ls)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),s=e.sortedSet.getIterator();for(;n.hasNext();){const i=n.getNext().key,r=s.getNext().key;if(!i.isEqual(r))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(){this.Cu=new Se(z.comparator)}track(e){const n=e.doc.key,s=this.Cu.get(n);s?e.type!==0&&s.type===3?this.Cu=this.Cu.insert(n,e):e.type===3&&s.type!==1?this.Cu=this.Cu.insert(n,{type:s.type,doc:e.doc}):e.type===2&&s.type===2?this.Cu=this.Cu.insert(n,{type:2,doc:e.doc}):e.type===2&&s.type===0?this.Cu=this.Cu.insert(n,{type:0,doc:e.doc}):e.type===1&&s.type===0?this.Cu=this.Cu.remove(n):e.type===1&&s.type===2?this.Cu=this.Cu.insert(n,{type:1,doc:s.doc}):e.type===0&&s.type===1?this.Cu=this.Cu.insert(n,{type:2,doc:e.doc}):Y():this.Cu=this.Cu.insert(n,e)}xu(){const e=[];return this.Cu.inorderTraversal((n,s)=>{e.push(s)}),e}}class Xs{constructor(e,n,s,i,r,o,a,l,c){this.query=e,this.docs=n,this.oldDocs=s,this.docChanges=i,this.mutatedKeys=r,this.fromCache=o,this.syncStateChanged=a,this.excludesMetadataChanges=l,this.hasCachedResults=c}static fromInitialDocuments(e,n,s,i,r){const o=[];return n.forEach(a=>{o.push({type:0,doc:a})}),new Xs(e,n,Ls.emptySet(n),o,s,i,!0,!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Ea(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const n=this.docChanges,s=e.docChanges;if(n.length!==s.length)return!1;for(let i=0;i<n.length;i++)if(n[i].type!==s[i].type||!n[i].doc.isEqual(s[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zs{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Zs(ot.fromBase64String(e))}catch(n){throw new q(T.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Zs(ot.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Na{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new q(T.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new et(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
