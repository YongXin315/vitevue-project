(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();function Il(t,e){const n=Object.create(null),s=t.split(",");for(let i=0;i<s.length;i++)n[s[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const pe={},ds=[],Tt=()=>{},rm=()=>!1,om=/^on[^a-z]/,wo=t=>om.test(t),Tl=t=>t.startsWith("onUpdate:"),De=Object.assign,Al=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},am=Object.prototype.hasOwnProperty,Z=(t,e)=>am.call(t,e),j=Array.isArray,fs=t=>ji(t)==="[object Map]",Qh=t=>ji(t)==="[object Set]",qc=t=>ji(t)==="[object Date]",W=t=>typeof t=="function",Ce=t=>typeof t=="string",yi=t=>typeof t=="symbol",de=t=>t!==null&&typeof t=="object",Yh=t=>de(t)&&W(t.then)&&W(t.catch),Jh=Object.prototype.toString,ji=t=>Jh.call(t),lm=t=>ji(t).slice(8,-1),Xh=t=>ji(t)==="[object Object]",Sl=t=>Ce(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Sr=Il(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Eo=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},cm=/-(\w)/g,jt=Eo(t=>t.replace(cm,(e,n)=>n?n.toUpperCase():"")),um=/\B([A-Z])/g,Fs=Eo(t=>t.replace(um,"-$1").toLowerCase()),bo=Eo(t=>t.charAt(0).toUpperCase()+t.slice(1)),aa=Eo(t=>t?`on${bo(t)}`:""),vi=(t,e)=>!Object.is(t,e),Cr=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},$r=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},xa=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let zc;const La=()=>zc||(zc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Cl(t){if(j(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],i=Ce(s)?pm(s):Cl(s);if(i)for(const r in i)e[r]=i[r]}return e}else{if(Ce(t))return t;if(de(t))return t}}const hm=/;(?![^(]*\))/g,dm=/:([^]+)/,fm=/\/\*[^]*?\*\//g;function pm(t){const e={};return t.replace(fm,"").split(hm).forEach(n=>{if(n){const s=n.split(dm);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Jn(t){let e="";if(Ce(t))e=t;else if(j(t))for(let n=0;n<t.length;n++){const s=Jn(t[n]);s&&(e+=s+" ")}else if(de(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const gm="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",mm=Il(gm);function Zh(t){return!!t||t===""}function ym(t,e){if(t.length!==e.length)return!1;let n=!0;for(let s=0;n&&s<t.length;s++)n=Br(t[s],e[s]);return n}function Br(t,e){if(t===e)return!0;let n=qc(t),s=qc(e);if(n||s)return n&&s?t.getTime()===e.getTime():!1;if(n=yi(t),s=yi(e),n||s)return t===e;if(n=j(t),s=j(e),n||s)return n&&s?ym(t,e):!1;if(n=de(t),s=de(e),n||s){if(!n||!s)return!1;const i=Object.keys(t).length,r=Object.keys(e).length;if(i!==r)return!1;for(const o in t){const a=t.hasOwnProperty(o),l=e.hasOwnProperty(o);if(a&&!l||!a&&l||!Br(t[o],e[o]))return!1}}return String(t)===String(e)}const We=t=>Ce(t)?t:t==null?"":j(t)||de(t)&&(t.toString===Jh||!W(t.toString))?JSON.stringify(t,ed,2):String(t),ed=(t,e)=>e&&e.__v_isRef?ed(t,e.value):fs(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,i])=>(n[`${s} =>`]=i,n),{})}:Qh(e)?{[`Set(${e.size})`]:[...e.values()]}:de(e)&&!j(e)&&!Xh(e)?String(e):e;let vt;class vm{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=vt,!e&&vt&&(this.index=(vt.scopes||(vt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=vt;try{return vt=this,e()}finally{vt=n}}}on(){vt=this}off(){vt=this.parent}stop(e){if(this._active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0,this._active=!1}}}function _m(t,e=vt){e&&e.active&&e.effects.push(t)}function wm(){return vt}const kl=t=>{const e=new Set(t);return e.w=0,e.n=0,e},td=t=>(t.w&En)>0,nd=t=>(t.n&En)>0,Em=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=En},bm=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const i=e[s];td(i)&&!nd(i)?i.delete(t):e[n++]=i,i.w&=~En,i.n&=~En}e.length=n}},Ua=new WeakMap;let ti=0,En=1;const Fa=30;let wt;const Fn=Symbol(""),$a=Symbol("");class Rl{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,_m(this,s)}run(){if(!this.active)return this.fn();let e=wt,n=gn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=wt,wt=this,gn=!0,En=1<<++ti,ti<=Fa?Em(this):Kc(this),this.fn()}finally{ti<=Fa&&bm(this),En=1<<--ti,wt=this.parent,gn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){wt===this?this.deferStop=!0:this.active&&(Kc(this),this.onStop&&this.onStop(),this.active=!1)}}function Kc(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let gn=!0;const sd=[];function $s(){sd.push(gn),gn=!1}function Bs(){const t=sd.pop();gn=t===void 0?!0:t}function ot(t,e,n){if(gn&&wt){let s=Ua.get(t);s||Ua.set(t,s=new Map);let i=s.get(n);i||s.set(n,i=kl()),id(i)}}function id(t,e){let n=!1;ti<=Fa?nd(t)||(t.n|=En,n=!td(t)):n=!t.has(wt),n&&(t.add(wt),wt.deps.push(t))}function Jt(t,e,n,s,i,r){const o=Ua.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&j(t)){const l=Number(s);o.forEach((c,u)=>{(u==="length"||u>=l)&&a.push(c)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":j(t)?Sl(n)&&a.push(o.get("length")):(a.push(o.get(Fn)),fs(t)&&a.push(o.get($a)));break;case"delete":j(t)||(a.push(o.get(Fn)),fs(t)&&a.push(o.get($a)));break;case"set":fs(t)&&a.push(o.get(Fn));break}if(a.length===1)a[0]&&Ba(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);Ba(kl(l))}}function Ba(t,e){const n=j(t)?t:[...t];for(const s of n)s.computed&&Wc(s);for(const s of n)s.computed||Wc(s)}function Wc(t,e){(t!==wt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const Im=Il("__proto__,__v_isRef,__isVue"),rd=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(yi)),Tm=Pl(),Am=Pl(!1,!0),Sm=Pl(!0),Gc=Cm();function Cm(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=se(this);for(let r=0,o=this.length;r<o;r++)ot(s,"get",r+"");const i=s[e](...n);return i===-1||i===!1?s[e](...n.map(se)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){$s();const s=se(this)[e].apply(this,n);return Bs(),s}}),t}function km(t){const e=se(this);return ot(e,"has",t),e.hasOwnProperty(t)}function Pl(t=!1,e=!1){return function(s,i,r){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&r===(t?e?qm:ud:e?cd:ld).get(s))return s;const o=j(s);if(!t){if(o&&Z(Gc,i))return Reflect.get(Gc,i,r);if(i==="hasOwnProperty")return km}const a=Reflect.get(s,i,r);return(yi(i)?rd.has(i):Im(i))||(t||ot(s,"get",i),e)?a:Ye(a)?o&&Sl(i)?a:a.value:de(a)?t?hd(a):Hi(a):a}}const Rm=od(),Pm=od(!0);function od(t=!1){return function(n,s,i,r){let o=n[s];if(Ts(o)&&Ye(o)&&!Ye(i))return!1;if(!t&&(!Vr(i)&&!Ts(i)&&(o=se(o),i=se(i)),!j(n)&&Ye(o)&&!Ye(i)))return o.value=i,!0;const a=j(n)&&Sl(s)?Number(s)<n.length:Z(n,s),l=Reflect.set(n,s,i,r);return n===se(r)&&(a?vi(i,o)&&Jt(n,"set",s,i):Jt(n,"add",s,i)),l}}function Om(t,e){const n=Z(t,e);t[e];const s=Reflect.deleteProperty(t,e);return s&&n&&Jt(t,"delete",e,void 0),s}function Dm(t,e){const n=Reflect.has(t,e);return(!yi(e)||!rd.has(e))&&ot(t,"has",e),n}function Nm(t){return ot(t,"iterate",j(t)?"length":Fn),Reflect.ownKeys(t)}const ad={get:Tm,set:Rm,deleteProperty:Om,has:Dm,ownKeys:Nm},Mm={get:Sm,set(t,e){return!0},deleteProperty(t,e){return!0}},xm=De({},ad,{get:Am,set:Pm}),Ol=t=>t,Io=t=>Reflect.getPrototypeOf(t);function ur(t,e,n=!1,s=!1){t=t.__v_raw;const i=se(t),r=se(e);n||(e!==r&&ot(i,"get",e),ot(i,"get",r));const{has:o}=Io(i),a=s?Ol:n?Ml:_i;if(o.call(i,e))return a(t.get(e));if(o.call(i,r))return a(t.get(r));t!==i&&t.get(e)}function hr(t,e=!1){const n=this.__v_raw,s=se(n),i=se(t);return e||(t!==i&&ot(s,"has",t),ot(s,"has",i)),t===i?n.has(t):n.has(t)||n.has(i)}function dr(t,e=!1){return t=t.__v_raw,!e&&ot(se(t),"iterate",Fn),Reflect.get(t,"size",t)}function Qc(t){t=se(t);const e=se(this);return Io(e).has.call(e,t)||(e.add(t),Jt(e,"add",t,t)),this}function Yc(t,e){e=se(e);const n=se(this),{has:s,get:i}=Io(n);let r=s.call(n,t);r||(t=se(t),r=s.call(n,t));const o=i.call(n,t);return n.set(t,e),r?vi(e,o)&&Jt(n,"set",t,e):Jt(n,"add",t,e),this}function Jc(t){const e=se(this),{has:n,get:s}=Io(e);let i=n.call(e,t);i||(t=se(t),i=n.call(e,t)),s&&s.call(e,t);const r=e.delete(t);return i&&Jt(e,"delete",t,void 0),r}function Xc(){const t=se(this),e=t.size!==0,n=t.clear();return e&&Jt(t,"clear",void 0,void 0),n}function fr(t,e){return function(s,i){const r=this,o=r.__v_raw,a=se(o),l=e?Ol:t?Ml:_i;return!t&&ot(a,"iterate",Fn),o.forEach((c,u)=>s.call(i,l(c),l(u),r))}}function pr(t,e,n){return function(...s){const i=this.__v_raw,r=se(i),o=fs(r),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=i[t](...s),u=n?Ol:e?Ml:_i;return!e&&ot(r,"iterate",l?$a:Fn),{next(){const{value:h,done:g}=c.next();return g?{value:h,done:g}:{value:a?[u(h[0]),u(h[1])]:u(h),done:g}},[Symbol.iterator](){return this}}}}function on(t){return function(...e){return t==="delete"?!1:this}}function Lm(){const t={get(r){return ur(this,r)},get size(){return dr(this)},has:hr,add:Qc,set:Yc,delete:Jc,clear:Xc,forEach:fr(!1,!1)},e={get(r){return ur(this,r,!1,!0)},get size(){return dr(this)},has:hr,add:Qc,set:Yc,delete:Jc,clear:Xc,forEach:fr(!1,!0)},n={get(r){return ur(this,r,!0)},get size(){return dr(this,!0)},has(r){return hr.call(this,r,!0)},add:on("add"),set:on("set"),delete:on("delete"),clear:on("clear"),forEach:fr(!0,!1)},s={get(r){return ur(this,r,!0,!0)},get size(){return dr(this,!0)},has(r){return hr.call(this,r,!0)},add:on("add"),set:on("set"),delete:on("delete"),clear:on("clear"),forEach:fr(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=pr(r,!1,!1),n[r]=pr(r,!0,!1),e[r]=pr(r,!1,!0),s[r]=pr(r,!0,!0)}),[t,n,e,s]}const[Um,Fm,$m,Bm]=Lm();function Dl(t,e){const n=e?t?Bm:$m:t?Fm:Um;return(s,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?s:Reflect.get(Z(n,i)&&i in s?n:s,i,r)}const Vm={get:Dl(!1,!1)},jm={get:Dl(!1,!0)},Hm={get:Dl(!0,!1)},ld=new WeakMap,cd=new WeakMap,ud=new WeakMap,qm=new WeakMap;function zm(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Km(t){return t.__v_skip||!Object.isExtensible(t)?0:zm(lm(t))}function Hi(t){return Ts(t)?t:Nl(t,!1,ad,Vm,ld)}function Wm(t){return Nl(t,!1,xm,jm,cd)}function hd(t){return Nl(t,!0,Mm,Hm,ud)}function Nl(t,e,n,s,i){if(!de(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const o=Km(t);if(o===0)return t;const a=new Proxy(t,o===2?s:n);return i.set(t,a),a}function ps(t){return Ts(t)?ps(t.__v_raw):!!(t&&t.__v_isReactive)}function Ts(t){return!!(t&&t.__v_isReadonly)}function Vr(t){return!!(t&&t.__v_isShallow)}function dd(t){return ps(t)||Ts(t)}function se(t){const e=t&&t.__v_raw;return e?se(e):t}function fd(t){return $r(t,"__v_skip",!0),t}const _i=t=>de(t)?Hi(t):t,Ml=t=>de(t)?hd(t):t;function pd(t){gn&&wt&&(t=se(t),id(t.dep||(t.dep=kl())))}function gd(t,e){t=se(t);const n=t.dep;n&&Ba(n)}function Ye(t){return!!(t&&t.__v_isRef===!0)}function md(t){return yd(t,!1)}function Gm(t){return yd(t,!0)}function yd(t,e){return Ye(t)?t:new Qm(t,e)}class Qm{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:se(e),this._value=n?e:_i(e)}get value(){return pd(this),this._value}set value(e){const n=this.__v_isShallow||Vr(e)||Ts(e);e=n?e:se(e),vi(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:_i(e),gd(this))}}function gs(t){return Ye(t)?t.value:t}const Ym={get:(t,e,n)=>gs(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const i=t[e];return Ye(i)&&!Ye(n)?(i.value=n,!0):Reflect.set(t,e,n,s)}};function vd(t){return ps(t)?t:new Proxy(t,Ym)}class Jm{constructor(e,n,s,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Rl(e,()=>{this._dirty||(this._dirty=!0,gd(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=s}get value(){const e=se(this);return pd(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Xm(t,e,n=!1){let s,i;const r=W(t);return r?(s=t,i=Tt):(s=t.get,i=t.set),new Jm(s,i,r||!i,n)}function mn(t,e,n,s){let i;try{i=s?t(...s):t()}catch(r){To(r,e,n)}return i}function At(t,e,n,s){if(W(t)){const r=mn(t,e,n,s);return r&&Yh(r)&&r.catch(o=>{To(o,e,n)}),r}const i=[];for(let r=0;r<t.length;r++)i.push(At(t[r],e,n,s));return i}function To(t,e,n,s=!0){const i=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,a=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}r=r.parent}const l=e.appContext.config.errorHandler;if(l){mn(l,null,10,[t,o,a]);return}}Zm(t,n,i,s)}function Zm(t,e,n,s=!0){console.error(t)}let wi=!1,Va=!1;const Ge=[];let Nt=0;const ms=[];let Wt=null,On=0;const _d=Promise.resolve();let xl=null;function wd(t){const e=xl||_d;return t?e.then(this?t.bind(this):t):e}function ey(t){let e=Nt+1,n=Ge.length;for(;e<n;){const s=e+n>>>1;Ei(Ge[s])<t?e=s+1:n=s}return e}function Ll(t){(!Ge.length||!Ge.includes(t,wi&&t.allowRecurse?Nt+1:Nt))&&(t.id==null?Ge.push(t):Ge.splice(ey(t.id),0,t),Ed())}function Ed(){!wi&&!Va&&(Va=!0,xl=_d.then(Id))}function ty(t){const e=Ge.indexOf(t);e>Nt&&Ge.splice(e,1)}function ny(t){j(t)?ms.push(...t):(!Wt||!Wt.includes(t,t.allowRecurse?On+1:On))&&ms.push(t),Ed()}function Zc(t,e=wi?Nt+1:0){for(;e<Ge.length;e++){const n=Ge[e];n&&n.pre&&(Ge.splice(e,1),e--,n())}}function bd(t){if(ms.length){const e=[...new Set(ms)];if(ms.length=0,Wt){Wt.push(...e);return}for(Wt=e,Wt.sort((n,s)=>Ei(n)-Ei(s)),On=0;On<Wt.length;On++)Wt[On]();Wt=null,On=0}}const Ei=t=>t.id==null?1/0:t.id,sy=(t,e)=>{const n=Ei(t)-Ei(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Id(t){Va=!1,wi=!0,Ge.sort(sy);const e=Tt;try{for(Nt=0;Nt<Ge.length;Nt++){const n=Ge[Nt];n&&n.active!==!1&&mn(n,null,14)}}finally{Nt=0,Ge.length=0,bd(),wi=!1,xl=null,(Ge.length||ms.length)&&Id()}}function iy(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||pe;let i=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in s){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:g}=s[u]||pe;g&&(i=n.map(y=>Ce(y)?y.trim():y)),h&&(i=n.map(xa))}let a,l=s[a=aa(e)]||s[a=aa(jt(e))];!l&&r&&(l=s[a=aa(Fs(e))]),l&&At(l,t,6,i);const c=s[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,At(c,t,6,i)}}function Td(t,e,n=!1){const s=e.emitsCache,i=s.get(t);if(i!==void 0)return i;const r=t.emits;let o={},a=!1;if(!W(t)){const l=c=>{const u=Td(c,e,!0);u&&(a=!0,De(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!r&&!a?(de(t)&&s.set(t,null),null):(j(r)?r.forEach(l=>o[l]=null):De(o,r),de(t)&&s.set(t,o),o)}function Ao(t,e){return!t||!wo(e)?!1:(e=e.slice(2).replace(/Once$/,""),Z(t,e[0].toLowerCase()+e.slice(1))||Z(t,Fs(e))||Z(t,e))}let mt=null,Ad=null;function jr(t){const e=mt;return mt=t,Ad=t&&t.type.__scopeId||null,e}function ry(t,e=mt,n){if(!e||t._n)return t;const s=(...i)=>{s._d&&uu(-1);const r=jr(e);let o;try{o=t(...i)}finally{jr(r),s._d&&uu(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function la(t){const{type:e,vnode:n,proxy:s,withProxy:i,props:r,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:h,data:g,setupState:y,ctx:I,inheritAttrs:C}=t;let D,N;const x=jr(t);try{if(n.shapeFlag&4){const L=i||s;D=Dt(u.call(L,L,h,r,y,g,I)),N=l}else{const L=e;D=Dt(L.length>1?L(r,{attrs:l,slots:a,emit:c}):L(r,null)),N=e.props?l:oy(l)}}catch(L){li.length=0,To(L,t,1),D=we(Hn)}let G=D;if(N&&C!==!1){const L=Object.keys(N),{shapeFlag:Ee}=G;L.length&&Ee&7&&(o&&L.some(Tl)&&(N=ay(N,o)),G=As(G,N))}return n.dirs&&(G=As(G),G.dirs=G.dirs?G.dirs.concat(n.dirs):n.dirs),n.transition&&(G.transition=n.transition),D=G,jr(x),D}const oy=t=>{let e;for(const n in t)(n==="class"||n==="style"||wo(n))&&((e||(e={}))[n]=t[n]);return e},ay=(t,e)=>{const n={};for(const s in t)(!Tl(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function ly(t,e,n){const{props:s,children:i,component:r}=t,{props:o,children:a,patchFlag:l}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return s?eu(s,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const g=u[h];if(o[g]!==s[g]&&!Ao(c,g))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?eu(s,o,c):!0:!!o;return!1}function eu(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(e[r]!==t[r]&&!Ao(n,r))return!0}return!1}function cy({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const uy=t=>t.__isSuspense;function hy(t,e){e&&e.pendingBranch?j(t)?e.effects.push(...t):e.effects.push(t):ny(t)}const gr={};function kr(t,e,n){return Sd(t,e,n)}function Sd(t,e,{immediate:n,deep:s,flush:i,onTrack:r,onTrigger:o}=pe){var a;const l=wm()===((a=$e)==null?void 0:a.scope)?$e:null;let c,u=!1,h=!1;if(Ye(t)?(c=()=>t.value,u=Vr(t)):ps(t)?(c=()=>t,s=!0):j(t)?(h=!0,u=t.some(L=>ps(L)||Vr(L)),c=()=>t.map(L=>{if(Ye(L))return L.value;if(ps(L))return Mn(L);if(W(L))return mn(L,l,2)})):W(t)?e?c=()=>mn(t,l,2):c=()=>{if(!(l&&l.isUnmounted))return g&&g(),At(t,l,3,[y])}:c=Tt,e&&s){const L=c;c=()=>Mn(L())}let g,y=L=>{g=x.onStop=()=>{mn(L,l,4)}},I;if(Ii)if(y=Tt,e?n&&At(e,l,3,[c(),h?[]:void 0,y]):c(),i==="sync"){const L=iv();I=L.__watcherHandles||(L.__watcherHandles=[])}else return Tt;let C=h?new Array(t.length).fill(gr):gr;const D=()=>{if(x.active)if(e){const L=x.run();(s||u||(h?L.some((Ee,ye)=>vi(Ee,C[ye])):vi(L,C)))&&(g&&g(),At(e,l,3,[L,C===gr?void 0:h&&C[0]===gr?[]:C,y]),C=L)}else x.run()};D.allowRecurse=!!e;let N;i==="sync"?N=D:i==="post"?N=()=>rt(D,l&&l.suspense):(D.pre=!0,l&&(D.id=l.uid),N=()=>Ll(D));const x=new Rl(c,N);e?n?D():C=x.run():i==="post"?rt(x.run.bind(x),l&&l.suspense):x.run();const G=()=>{x.stop(),l&&l.scope&&Al(l.scope.effects,x)};return I&&I.push(G),G}function dy(t,e,n){const s=this.proxy,i=Ce(t)?t.includes(".")?Cd(s,t):()=>s[t]:t.bind(s,s);let r;W(e)?r=e:(r=e.handler,n=e);const o=$e;Ss(this);const a=Sd(i,r.bind(s),n);return o?Ss(o):$n(),a}function Cd(t,e){const n=e.split(".");return()=>{let s=t;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}function Mn(t,e){if(!de(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Ye(t))Mn(t.value,e);else if(j(t))for(let n=0;n<t.length;n++)Mn(t[n],e);else if(Qh(t)||fs(t))t.forEach(n=>{Mn(n,e)});else if(Xh(t))for(const n in t)Mn(t[n],e);return t}function fe(t,e){const n=mt;if(n===null)return t;const s=Oo(n)||n.proxy,i=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[o,a,l,c=pe]=e[r];o&&(W(o)&&(o={mounted:o,updated:o}),o.deep&&Mn(a),i.push({dir:o,instance:s,value:a,oldValue:void 0,arg:l,modifiers:c}))}return t}function kn(t,e,n,s){const i=t.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let l=a.dir[s];l&&($s(),At(l,n,8,[t.el,a,t,e]),Bs())}}function kd(t,e){return W(t)?(()=>De({name:t.name},e,{setup:t}))():t}const Rr=t=>!!t.type.__asyncLoader,Rd=t=>t.type.__isKeepAlive;function fy(t,e){Pd(t,"a",e)}function py(t,e){Pd(t,"da",e)}function Pd(t,e,n=$e){const s=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(So(e,s,n),n){let i=n.parent;for(;i&&i.parent;)Rd(i.parent.vnode)&&gy(s,e,n,i),i=i.parent}}function gy(t,e,n,s){const i=So(e,t,s,!0);Dd(()=>{Al(s[e],i)},n)}function So(t,e,n=$e,s=!1){if(n){const i=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;$s(),Ss(n);const a=At(e,n,t,o);return $n(),Bs(),a});return s?i.unshift(r):i.push(r),r}}const tn=t=>(e,n=$e)=>(!Ii||t==="sp")&&So(t,(...s)=>e(...s),n),my=tn("bm"),Od=tn("m"),yy=tn("bu"),vy=tn("u"),_y=tn("bum"),Dd=tn("um"),wy=tn("sp"),Ey=tn("rtg"),by=tn("rtc");function Iy(t,e=$e){So("ec",t,e)}const Nd="components";function ys(t,e){return Ay(Nd,t,!0,e)||t}const Ty=Symbol.for("v-ndc");function Ay(t,e,n=!0,s=!1){const i=mt||$e;if(i){const r=i.type;if(t===Nd){const a=tv(r,!1);if(a&&(a===e||a===jt(e)||a===bo(jt(e))))return r}const o=tu(i[t]||r[t],e)||tu(i.appContext[t],e);return!o&&s?r:o}}function tu(t,e){return t&&(t[e]||t[jt(e)]||t[bo(jt(e))])}function Co(t,e,n,s){let i;const r=n&&n[s];if(j(t)||Ce(t)){i=new Array(t.length);for(let o=0,a=t.length;o<a;o++)i[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r&&r[o])}else if(de(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,r&&r[a]));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];i[a]=e(t[c],c,a,r&&r[a])}}else i=[];return n&&(n[s]=i),i}const ja=t=>t?qd(t)?Oo(t)||t.proxy:ja(t.parent):null,ai=De(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>ja(t.parent),$root:t=>ja(t.root),$emit:t=>t.emit,$options:t=>Ul(t),$forceUpdate:t=>t.f||(t.f=()=>Ll(t.update)),$nextTick:t=>t.n||(t.n=wd.bind(t.proxy)),$watch:t=>dy.bind(t)}),ca=(t,e)=>t!==pe&&!t.__isScriptSetup&&Z(t,e),Sy={get({_:t},e){const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const y=o[e];if(y!==void 0)switch(y){case 1:return s[e];case 2:return i[e];case 4:return n[e];case 3:return r[e]}else{if(ca(s,e))return o[e]=1,s[e];if(i!==pe&&Z(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&Z(c,e))return o[e]=3,r[e];if(n!==pe&&Z(n,e))return o[e]=4,n[e];Ha&&(o[e]=0)}}const u=ai[e];let h,g;if(u)return e==="$attrs"&&ot(t,"get",e),u(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==pe&&Z(n,e))return o[e]=4,n[e];if(g=l.config.globalProperties,Z(g,e))return g[e]},set({_:t},e,n){const{data:s,setupState:i,ctx:r}=t;return ca(i,e)?(i[e]=n,!0):s!==pe&&Z(s,e)?(s[e]=n,!0):Z(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:i,propsOptions:r}},o){let a;return!!n[o]||t!==pe&&Z(t,o)||ca(e,o)||(a=r[0])&&Z(a,o)||Z(s,o)||Z(ai,o)||Z(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:Z(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function nu(t){return j(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let Ha=!0;function Cy(t){const e=Ul(t),n=t.proxy,s=t.ctx;Ha=!1,e.beforeCreate&&su(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:h,mounted:g,beforeUpdate:y,updated:I,activated:C,deactivated:D,beforeDestroy:N,beforeUnmount:x,destroyed:G,unmounted:L,render:Ee,renderTracked:ye,renderTriggered:je,errorCaptured:ct,serverPrefetch:ut,expose:ft,inheritAttrs:sn,components:Cn,directives:kt,filters:Qs}=e;if(c&&ky(c,s,null),o)for(const ce in o){const ie=o[ce];W(ie)&&(s[ce]=ie.bind(n))}if(i){const ce=i.call(n,n);de(ce)&&(t.data=Hi(ce))}if(Ha=!0,r)for(const ce in r){const ie=r[ce],zt=W(ie)?ie.bind(n,n):W(ie.get)?ie.get.bind(n,n):Tt,rn=!W(ie)&&W(ie.set)?ie.set.bind(n):Tt,Rt=pt({get:zt,set:rn});Object.defineProperty(s,ce,{enumerable:!0,configurable:!0,get:()=>Rt.value,set:it=>Rt.value=it})}if(a)for(const ce in a)Md(a[ce],s,n,ce);if(l){const ce=W(l)?l.call(n):l;Reflect.ownKeys(ce).forEach(ie=>{Pr(ie,ce[ie])})}u&&su(u,t,"c");function ke(ce,ie){j(ie)?ie.forEach(zt=>ce(zt.bind(n))):ie&&ce(ie.bind(n))}if(ke(my,h),ke(Od,g),ke(yy,y),ke(vy,I),ke(fy,C),ke(py,D),ke(Iy,ct),ke(by,ye),ke(Ey,je),ke(_y,x),ke(Dd,L),ke(wy,ut),j(ft))if(ft.length){const ce=t.exposed||(t.exposed={});ft.forEach(ie=>{Object.defineProperty(ce,ie,{get:()=>n[ie],set:zt=>n[ie]=zt})})}else t.exposed||(t.exposed={});Ee&&t.render===Tt&&(t.render=Ee),sn!=null&&(t.inheritAttrs=sn),Cn&&(t.components=Cn),kt&&(t.directives=kt)}function ky(t,e,n=Tt){j(t)&&(t=qa(t));for(const s in t){const i=t[s];let r;de(i)?"default"in i?r=Ut(i.from||s,i.default,!0):r=Ut(i.from||s):r=Ut(i),Ye(r)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[s]=r}}function su(t,e,n){At(j(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function Md(t,e,n,s){const i=s.includes(".")?Cd(n,s):()=>n[s];if(Ce(t)){const r=e[t];W(r)&&kr(i,r)}else if(W(t))kr(i,t.bind(n));else if(de(t))if(j(t))t.forEach(r=>Md(r,e,n,s));else{const r=W(t.handler)?t.handler.bind(n):e[t.handler];W(r)&&kr(i,r,t)}}function Ul(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,a=r.get(e);let l;return a?l=a:!i.length&&!n&&!s?l=e:(l={},i.length&&i.forEach(c=>Hr(l,c,o,!0)),Hr(l,e,o)),de(e)&&r.set(e,l),l}function Hr(t,e,n,s=!1){const{mixins:i,extends:r}=e;r&&Hr(t,r,n,!0),i&&i.forEach(o=>Hr(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const a=Ry[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Ry={data:iu,props:ru,emits:ru,methods:ni,computed:ni,beforeCreate:et,created:et,beforeMount:et,mounted:et,beforeUpdate:et,updated:et,beforeDestroy:et,beforeUnmount:et,destroyed:et,unmounted:et,activated:et,deactivated:et,errorCaptured:et,serverPrefetch:et,components:ni,directives:ni,watch:Oy,provide:iu,inject:Py};function iu(t,e){return e?t?function(){return De(W(t)?t.call(this,this):t,W(e)?e.call(this,this):e)}:e:t}function Py(t,e){return ni(qa(t),qa(e))}function qa(t){if(j(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function et(t,e){return t?[...new Set([].concat(t,e))]:e}function ni(t,e){return t?De(Object.create(null),t,e):e}function ru(t,e){return t?j(t)&&j(e)?[...new Set([...t,...e])]:De(Object.create(null),nu(t),nu(e??{})):e}function Oy(t,e){if(!t)return e;if(!e)return t;const n=De(Object.create(null),t);for(const s in e)n[s]=et(t[s],e[s]);return n}function xd(){return{app:null,config:{isNativeTag:rm,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Dy=0;function Ny(t,e){return function(s,i=null){W(s)||(s=De({},s)),i!=null&&!de(i)&&(i=null);const r=xd(),o=new Set;let a=!1;const l=r.app={_uid:Dy++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:rv,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&W(c.install)?(o.add(c),c.install(l,...u)):W(c)&&(o.add(c),c(l,...u))),l},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),l},component(c,u){return u?(r.components[c]=u,l):r.components[c]},directive(c,u){return u?(r.directives[c]=u,l):r.directives[c]},mount(c,u,h){if(!a){const g=we(s,i);return g.appContext=r,u&&e?e(g,c):t(g,c,h),a=!0,l._container=c,c.__vue_app__=l,Oo(g.component)||g.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return r.provides[c]=u,l},runWithContext(c){qr=l;try{return c()}finally{qr=null}}};return l}}let qr=null;function Pr(t,e){if($e){let n=$e.provides;const s=$e.parent&&$e.parent.provides;s===n&&(n=$e.provides=Object.create(s)),n[t]=e}}function Ut(t,e,n=!1){const s=$e||mt;if(s||qr){const i=s?s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:qr._context.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&W(e)?e.call(s&&s.proxy):e}}function My(t,e,n,s=!1){const i={},r={};$r(r,Ro,1),t.propsDefaults=Object.create(null),Ld(t,e,i,r);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=s?i:Wm(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function xy(t,e,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=t,a=se(i),[l]=t.propsOptions;let c=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let g=u[h];if(Ao(t.emitsOptions,g))continue;const y=e[g];if(l)if(Z(r,g))y!==r[g]&&(r[g]=y,c=!0);else{const I=jt(g);i[I]=za(l,a,I,y,t,!1)}else y!==r[g]&&(r[g]=y,c=!0)}}}else{Ld(t,e,i,r)&&(c=!0);let u;for(const h in a)(!e||!Z(e,h)&&((u=Fs(h))===h||!Z(e,u)))&&(l?n&&(n[h]!==void 0||n[u]!==void 0)&&(i[h]=za(l,a,h,void 0,t,!0)):delete i[h]);if(r!==a)for(const h in r)(!e||!Z(e,h))&&(delete r[h],c=!0)}c&&Jt(t,"set","$attrs")}function Ld(t,e,n,s){const[i,r]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Sr(l))continue;const c=e[l];let u;i&&Z(i,u=jt(l))?!r||!r.includes(u)?n[u]=c:(a||(a={}))[u]=c:Ao(t.emitsOptions,l)||(!(l in s)||c!==s[l])&&(s[l]=c,o=!0)}if(r){const l=se(n),c=a||pe;for(let u=0;u<r.length;u++){const h=r[u];n[h]=za(i,l,h,c[h],t,!Z(c,h))}}return o}function za(t,e,n,s,i,r){const o=t[n];if(o!=null){const a=Z(o,"default");if(a&&s===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&W(l)){const{propsDefaults:c}=i;n in c?s=c[n]:(Ss(i),s=c[n]=l.call(null,e),$n())}else s=l}o[0]&&(r&&!a?s=!1:o[1]&&(s===""||s===Fs(n))&&(s=!0))}return s}function Ud(t,e,n=!1){const s=e.propsCache,i=s.get(t);if(i)return i;const r=t.props,o={},a=[];let l=!1;if(!W(t)){const u=h=>{l=!0;const[g,y]=Ud(h,e,!0);De(o,g),y&&a.push(...y)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!l)return de(t)&&s.set(t,ds),ds;if(j(r))for(let u=0;u<r.length;u++){const h=jt(r[u]);ou(h)&&(o[h]=pe)}else if(r)for(const u in r){const h=jt(u);if(ou(h)){const g=r[u],y=o[h]=j(g)||W(g)?{type:g}:De({},g);if(y){const I=cu(Boolean,y.type),C=cu(String,y.type);y[0]=I>-1,y[1]=C<0||I<C,(I>-1||Z(y,"default"))&&a.push(h)}}}const c=[o,a];return de(t)&&s.set(t,c),c}function ou(t){return t[0]!=="$"}function au(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function lu(t,e){return au(t)===au(e)}function cu(t,e){return j(e)?e.findIndex(n=>lu(n,t)):W(e)&&lu(e,t)?0:-1}const Fd=t=>t[0]==="_"||t==="$stable",Fl=t=>j(t)?t.map(Dt):[Dt(t)],Ly=(t,e,n)=>{if(e._n)return e;const s=ry((...i)=>Fl(e(...i)),n);return s._c=!1,s},$d=(t,e,n)=>{const s=t._ctx;for(const i in t){if(Fd(i))continue;const r=t[i];if(W(r))e[i]=Ly(i,r,s);else if(r!=null){const o=Fl(r);e[i]=()=>o}}},Bd=(t,e)=>{const n=Fl(e);t.slots.default=()=>n},Uy=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=se(e),$r(e,"_",n)):$d(e,t.slots={})}else t.slots={},e&&Bd(t,e);$r(t.slots,Ro,1)},Fy=(t,e,n)=>{const{vnode:s,slots:i}=t;let r=!0,o=pe;if(s.shapeFlag&32){const a=e._;a?n&&a===1?r=!1:(De(i,e),!n&&a===1&&delete i._):(r=!e.$stable,$d(e,i)),o=e}else e&&(Bd(t,e),o={default:1});if(r)for(const a in i)!Fd(a)&&!(a in o)&&delete i[a]};function Ka(t,e,n,s,i=!1){if(j(t)){t.forEach((g,y)=>Ka(g,e&&(j(e)?e[y]:e),n,s,i));return}if(Rr(s)&&!i)return;const r=s.shapeFlag&4?Oo(s.component)||s.component.proxy:s.el,o=i?null:r,{i:a,r:l}=t,c=e&&e.r,u=a.refs===pe?a.refs={}:a.refs,h=a.setupState;if(c!=null&&c!==l&&(Ce(c)?(u[c]=null,Z(h,c)&&(h[c]=null)):Ye(c)&&(c.value=null)),W(l))mn(l,a,12,[o,u]);else{const g=Ce(l),y=Ye(l);if(g||y){const I=()=>{if(t.f){const C=g?Z(h,l)?h[l]:u[l]:l.value;i?j(C)&&Al(C,r):j(C)?C.includes(r)||C.push(r):g?(u[l]=[r],Z(h,l)&&(h[l]=u[l])):(l.value=[r],t.k&&(u[t.k]=l.value))}else g?(u[l]=o,Z(h,l)&&(h[l]=o)):y&&(l.value=o,t.k&&(u[t.k]=o))};o?(I.id=-1,rt(I,n)):I()}}}const rt=hy;function $y(t){return By(t)}function By(t,e){const n=La();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:h,nextSibling:g,setScopeId:y=Tt,insertStaticContent:I}=t,C=(d,p,m,v=null,w=null,E=null,O=!1,S=null,k=!!p.dynamicChildren)=>{if(d===p)return;d&&!Js(d,p)&&(v=_(d),it(d,w,E,!0),d=null),p.patchFlag===-2&&(k=!1,p.dynamicChildren=null);const{type:b,ref:$,shapeFlag:U}=p;switch(b){case ko:D(d,p,m,v);break;case Hn:N(d,p,m,v);break;case Or:d==null&&x(p,m,v,O);break;case Se:Cn(d,p,m,v,w,E,O,S,k);break;default:U&1?Ee(d,p,m,v,w,E,O,S,k):U&6?kt(d,p,m,v,w,E,O,S,k):(U&64||U&128)&&b.process(d,p,m,v,w,E,O,S,k,R)}$!=null&&w&&Ka($,d&&d.ref,E,p||d,!p)},D=(d,p,m,v)=>{if(d==null)s(p.el=a(p.children),m,v);else{const w=p.el=d.el;p.children!==d.children&&c(w,p.children)}},N=(d,p,m,v)=>{d==null?s(p.el=l(p.children||""),m,v):p.el=d.el},x=(d,p,m,v)=>{[d.el,d.anchor]=I(d.children,p,m,v,d.el,d.anchor)},G=({el:d,anchor:p},m,v)=>{let w;for(;d&&d!==p;)w=g(d),s(d,m,v),d=w;s(p,m,v)},L=({el:d,anchor:p})=>{let m;for(;d&&d!==p;)m=g(d),i(d),d=m;i(p)},Ee=(d,p,m,v,w,E,O,S,k)=>{O=O||p.type==="svg",d==null?ye(p,m,v,w,E,O,S,k):ut(d,p,w,E,O,S,k)},ye=(d,p,m,v,w,E,O,S)=>{let k,b;const{type:$,props:U,shapeFlag:B,transition:K,dirs:Y}=d;if(k=d.el=o(d.type,E,U&&U.is,U),B&8?u(k,d.children):B&16&&ct(d.children,k,null,v,w,E&&$!=="foreignObject",O,S),Y&&kn(d,null,v,"created"),je(k,d,d.scopeId,O,v),U){for(const le in U)le!=="value"&&!Sr(le)&&r(k,le,null,U[le],E,d.children,v,w,He);"value"in U&&r(k,"value",null,U.value),(b=U.onVnodeBeforeMount)&&Ot(b,v,d)}Y&&kn(d,null,v,"beforeMount");const ue=(!w||w&&!w.pendingBranch)&&K&&!K.persisted;ue&&K.beforeEnter(k),s(k,p,m),((b=U&&U.onVnodeMounted)||ue||Y)&&rt(()=>{b&&Ot(b,v,d),ue&&K.enter(k),Y&&kn(d,null,v,"mounted")},w)},je=(d,p,m,v,w)=>{if(m&&y(d,m),v)for(let E=0;E<v.length;E++)y(d,v[E]);if(w){let E=w.subTree;if(p===E){const O=w.vnode;je(d,O,O.scopeId,O.slotScopeIds,w.parent)}}},ct=(d,p,m,v,w,E,O,S,k=0)=>{for(let b=k;b<d.length;b++){const $=d[b]=S?cn(d[b]):Dt(d[b]);C(null,$,p,m,v,w,E,O,S)}},ut=(d,p,m,v,w,E,O)=>{const S=p.el=d.el;let{patchFlag:k,dynamicChildren:b,dirs:$}=p;k|=d.patchFlag&16;const U=d.props||pe,B=p.props||pe;let K;m&&Rn(m,!1),(K=B.onVnodeBeforeUpdate)&&Ot(K,m,p,d),$&&kn(p,d,m,"beforeUpdate"),m&&Rn(m,!0);const Y=w&&p.type!=="foreignObject";if(b?ft(d.dynamicChildren,b,S,m,v,Y,E):O||ie(d,p,S,null,m,v,Y,E,!1),k>0){if(k&16)sn(S,p,U,B,m,v,w);else if(k&2&&U.class!==B.class&&r(S,"class",null,B.class,w),k&4&&r(S,"style",U.style,B.style,w),k&8){const ue=p.dynamicProps;for(let le=0;le<ue.length;le++){const Te=ue[le],yt=U[Te],rs=B[Te];(rs!==yt||Te==="value")&&r(S,Te,yt,rs,w,d.children,m,v,He)}}k&1&&d.children!==p.children&&u(S,p.children)}else!O&&b==null&&sn(S,p,U,B,m,v,w);((K=B.onVnodeUpdated)||$)&&rt(()=>{K&&Ot(K,m,p,d),$&&kn(p,d,m,"updated")},v)},ft=(d,p,m,v,w,E,O)=>{for(let S=0;S<p.length;S++){const k=d[S],b=p[S],$=k.el&&(k.type===Se||!Js(k,b)||k.shapeFlag&70)?h(k.el):m;C(k,b,$,null,v,w,E,O,!0)}},sn=(d,p,m,v,w,E,O)=>{if(m!==v){if(m!==pe)for(const S in m)!Sr(S)&&!(S in v)&&r(d,S,m[S],null,O,p.children,w,E,He);for(const S in v){if(Sr(S))continue;const k=v[S],b=m[S];k!==b&&S!=="value"&&r(d,S,b,k,O,p.children,w,E,He)}"value"in v&&r(d,"value",m.value,v.value)}},Cn=(d,p,m,v,w,E,O,S,k)=>{const b=p.el=d?d.el:a(""),$=p.anchor=d?d.anchor:a("");let{patchFlag:U,dynamicChildren:B,slotScopeIds:K}=p;K&&(S=S?S.concat(K):K),d==null?(s(b,m,v),s($,m,v),ct(p.children,m,$,w,E,O,S,k)):U>0&&U&64&&B&&d.dynamicChildren?(ft(d.dynamicChildren,B,m,w,E,O,S),(p.key!=null||w&&p===w.subTree)&&Vd(d,p,!0)):ie(d,p,m,$,w,E,O,S,k)},kt=(d,p,m,v,w,E,O,S,k)=>{p.slotScopeIds=S,d==null?p.shapeFlag&512?w.ctx.activate(p,m,v,O,k):Qs(p,m,v,w,E,O,k):ns(d,p,k)},Qs=(d,p,m,v,w,E,O)=>{const S=d.component=Yy(d,v,w);if(Rd(d)&&(S.ctx.renderer=R),Jy(S),S.asyncDep){if(w&&w.registerDep(S,ke),!d.el){const k=S.subTree=we(Hn);N(null,k,p,m)}return}ke(S,d,p,m,w,E,O)},ns=(d,p,m)=>{const v=p.component=d.component;if(ly(d,p,m))if(v.asyncDep&&!v.asyncResolved){ce(v,p,m);return}else v.next=p,ty(v.update),v.update();else p.el=d.el,v.vnode=p},ke=(d,p,m,v,w,E,O)=>{const S=()=>{if(d.isMounted){let{next:$,bu:U,u:B,parent:K,vnode:Y}=d,ue=$,le;Rn(d,!1),$?($.el=Y.el,ce(d,$,O)):$=Y,U&&Cr(U),(le=$.props&&$.props.onVnodeBeforeUpdate)&&Ot(le,K,$,Y),Rn(d,!0);const Te=la(d),yt=d.subTree;d.subTree=Te,C(yt,Te,h(yt.el),_(yt),d,w,E),$.el=Te.el,ue===null&&cy(d,Te.el),B&&rt(B,w),(le=$.props&&$.props.onVnodeUpdated)&&rt(()=>Ot(le,K,$,Y),w)}else{let $;const{el:U,props:B}=p,{bm:K,m:Y,parent:ue}=d,le=Rr(p);if(Rn(d,!1),K&&Cr(K),!le&&($=B&&B.onVnodeBeforeMount)&&Ot($,ue,p),Rn(d,!0),U&&re){const Te=()=>{d.subTree=la(d),re(U,d.subTree,d,w,null)};le?p.type.__asyncLoader().then(()=>!d.isUnmounted&&Te()):Te()}else{const Te=d.subTree=la(d);C(null,Te,m,v,d,w,E),p.el=Te.el}if(Y&&rt(Y,w),!le&&($=B&&B.onVnodeMounted)){const Te=p;rt(()=>Ot($,ue,Te),w)}(p.shapeFlag&256||ue&&Rr(ue.vnode)&&ue.vnode.shapeFlag&256)&&d.a&&rt(d.a,w),d.isMounted=!0,p=m=v=null}},k=d.effect=new Rl(S,()=>Ll(b),d.scope),b=d.update=()=>k.run();b.id=d.uid,Rn(d,!0),b()},ce=(d,p,m)=>{p.component=d;const v=d.vnode.props;d.vnode=p,d.next=null,xy(d,p.props,v,m),Fy(d,p.children,m),$s(),Zc(),Bs()},ie=(d,p,m,v,w,E,O,S,k=!1)=>{const b=d&&d.children,$=d?d.shapeFlag:0,U=p.children,{patchFlag:B,shapeFlag:K}=p;if(B>0){if(B&128){rn(b,U,m,v,w,E,O,S,k);return}else if(B&256){zt(b,U,m,v,w,E,O,S,k);return}}K&8?($&16&&He(b,w,E),U!==b&&u(m,U)):$&16?K&16?rn(b,U,m,v,w,E,O,S,k):He(b,w,E,!0):($&8&&u(m,""),K&16&&ct(U,m,v,w,E,O,S,k))},zt=(d,p,m,v,w,E,O,S,k)=>{d=d||ds,p=p||ds;const b=d.length,$=p.length,U=Math.min(b,$);let B;for(B=0;B<U;B++){const K=p[B]=k?cn(p[B]):Dt(p[B]);C(d[B],K,m,null,w,E,O,S,k)}b>$?He(d,w,E,!0,!1,U):ct(p,m,v,w,E,O,S,k,U)},rn=(d,p,m,v,w,E,O,S,k)=>{let b=0;const $=p.length;let U=d.length-1,B=$-1;for(;b<=U&&b<=B;){const K=d[b],Y=p[b]=k?cn(p[b]):Dt(p[b]);if(Js(K,Y))C(K,Y,m,null,w,E,O,S,k);else break;b++}for(;b<=U&&b<=B;){const K=d[U],Y=p[B]=k?cn(p[B]):Dt(p[B]);if(Js(K,Y))C(K,Y,m,null,w,E,O,S,k);else break;U--,B--}if(b>U){if(b<=B){const K=B+1,Y=K<$?p[K].el:v;for(;b<=B;)C(null,p[b]=k?cn(p[b]):Dt(p[b]),m,Y,w,E,O,S,k),b++}}else if(b>B)for(;b<=U;)it(d[b],w,E,!0),b++;else{const K=b,Y=b,ue=new Map;for(b=Y;b<=B;b++){const ht=p[b]=k?cn(p[b]):Dt(p[b]);ht.key!=null&&ue.set(ht.key,b)}let le,Te=0;const yt=B-Y+1;let rs=!1,Vc=0;const Ys=new Array(yt);for(b=0;b<yt;b++)Ys[b]=0;for(b=K;b<=U;b++){const ht=d[b];if(Te>=yt){it(ht,w,E,!0);continue}let Pt;if(ht.key!=null)Pt=ue.get(ht.key);else for(le=Y;le<=B;le++)if(Ys[le-Y]===0&&Js(ht,p[le])){Pt=le;break}Pt===void 0?it(ht,w,E,!0):(Ys[Pt-Y]=b+1,Pt>=Vc?Vc=Pt:rs=!0,C(ht,p[Pt],m,null,w,E,O,S,k),Te++)}const jc=rs?Vy(Ys):ds;for(le=jc.length-1,b=yt-1;b>=0;b--){const ht=Y+b,Pt=p[ht],Hc=ht+1<$?p[ht+1].el:v;Ys[b]===0?C(null,Pt,m,Hc,w,E,O,S,k):rs&&(le<0||b!==jc[le]?Rt(Pt,m,Hc,2):le--)}}},Rt=(d,p,m,v,w=null)=>{const{el:E,type:O,transition:S,children:k,shapeFlag:b}=d;if(b&6){Rt(d.component.subTree,p,m,v);return}if(b&128){d.suspense.move(p,m,v);return}if(b&64){O.move(d,p,m,R);return}if(O===Se){s(E,p,m);for(let U=0;U<k.length;U++)Rt(k[U],p,m,v);s(d.anchor,p,m);return}if(O===Or){G(d,p,m);return}if(v!==2&&b&1&&S)if(v===0)S.beforeEnter(E),s(E,p,m),rt(()=>S.enter(E),w);else{const{leave:U,delayLeave:B,afterLeave:K}=S,Y=()=>s(E,p,m),ue=()=>{U(E,()=>{Y(),K&&K()})};B?B(E,Y,ue):ue()}else s(E,p,m)},it=(d,p,m,v=!1,w=!1)=>{const{type:E,props:O,ref:S,children:k,dynamicChildren:b,shapeFlag:$,patchFlag:U,dirs:B}=d;if(S!=null&&Ka(S,null,m,d,!0),$&256){p.ctx.deactivate(d);return}const K=$&1&&B,Y=!Rr(d);let ue;if(Y&&(ue=O&&O.onVnodeBeforeUnmount)&&Ot(ue,p,d),$&6)cr(d.component,m,v);else{if($&128){d.suspense.unmount(m,v);return}K&&kn(d,null,p,"beforeUnmount"),$&64?d.type.remove(d,p,m,w,R,v):b&&(E!==Se||U>0&&U&64)?He(b,p,m,!1,!0):(E===Se&&U&384||!w&&$&16)&&He(k,p,m),v&&ss(d)}(Y&&(ue=O&&O.onVnodeUnmounted)||K)&&rt(()=>{ue&&Ot(ue,p,d),K&&kn(d,null,p,"unmounted")},m)},ss=d=>{const{type:p,el:m,anchor:v,transition:w}=d;if(p===Se){is(m,v);return}if(p===Or){L(d);return}const E=()=>{i(m),w&&!w.persisted&&w.afterLeave&&w.afterLeave()};if(d.shapeFlag&1&&w&&!w.persisted){const{leave:O,delayLeave:S}=w,k=()=>O(m,E);S?S(d.el,E,k):k()}else E()},is=(d,p)=>{let m;for(;d!==p;)m=g(d),i(d),d=m;i(p)},cr=(d,p,m)=>{const{bum:v,scope:w,update:E,subTree:O,um:S}=d;v&&Cr(v),w.stop(),E&&(E.active=!1,it(O,d,p,m)),S&&rt(S,p),rt(()=>{d.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&d.asyncDep&&!d.asyncResolved&&d.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},He=(d,p,m,v=!1,w=!1,E=0)=>{for(let O=E;O<d.length;O++)it(d[O],p,m,v,w)},_=d=>d.shapeFlag&6?_(d.component.subTree):d.shapeFlag&128?d.suspense.next():g(d.anchor||d.el),M=(d,p,m)=>{d==null?p._vnode&&it(p._vnode,null,null,!0):C(p._vnode||null,d,p,null,null,null,m),Zc(),bd(),p._vnode=d},R={p:C,um:it,m:Rt,r:ss,mt:Qs,mc:ct,pc:ie,pbc:ft,n:_,o:t};let F,re;return e&&([F,re]=e(R)),{render:M,hydrate:F,createApp:Ny(M,F)}}function Rn({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Vd(t,e,n=!1){const s=t.children,i=e.children;if(j(s)&&j(i))for(let r=0;r<s.length;r++){const o=s[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=cn(i[r]),a.el=o.el),n||Vd(o,a)),a.type===ko&&(a.el=o.el)}}function Vy(t){const e=t.slice(),n=[0];let s,i,r,o,a;const l=t.length;for(s=0;s<l;s++){const c=t[s];if(c!==0){if(i=n[n.length-1],t[i]<c){e[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,t[n[a]]<c?r=a+1:o=a;c<t[n[r]]&&(r>0&&(e[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const jy=t=>t.__isTeleport,Se=Symbol.for("v-fgt"),ko=Symbol.for("v-txt"),Hn=Symbol.for("v-cmt"),Or=Symbol.for("v-stc"),li=[];let bt=null;function te(t=!1){li.push(bt=t?null:[])}function Hy(){li.pop(),bt=li[li.length-1]||null}let bi=1;function uu(t){bi+=t}function jd(t){return t.dynamicChildren=bi>0?bt||ds:null,Hy(),bi>0&&bt&&bt.push(t),t}function ne(t,e,n,s,i,r){return jd(f(t,e,n,s,i,r,!0))}function qy(t,e,n,s,i){return jd(we(t,e,n,s,i,!0))}function Wa(t){return t?t.__v_isVNode===!0:!1}function Js(t,e){return t.type===e.type&&t.key===e.key}const Ro="__vInternal",Hd=({key:t})=>t??null,Dr=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?Ce(t)||Ye(t)||W(t)?{i:mt,r:t,k:e,f:!!n}:t:null);function f(t,e=null,n=null,s=0,i=null,r=t===Se?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Hd(e),ref:e&&Dr(e),scopeId:Ad,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:mt};return a?($l(l,n),r&128&&t.normalize(l)):n&&(l.shapeFlag|=Ce(n)?8:16),bi>0&&!o&&bt&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&bt.push(l),l}const we=zy;function zy(t,e=null,n=null,s=0,i=null,r=!1){if((!t||t===Ty)&&(t=Hn),Wa(t)){const a=As(t,e,!0);return n&&$l(a,n),bi>0&&!r&&bt&&(a.shapeFlag&6?bt[bt.indexOf(t)]=a:bt.push(a)),a.patchFlag|=-2,a}if(nv(t)&&(t=t.__vccOpts),e){e=Ky(e);let{class:a,style:l}=e;a&&!Ce(a)&&(e.class=Jn(a)),de(l)&&(dd(l)&&!j(l)&&(l=De({},l)),e.style=Cl(l))}const o=Ce(t)?1:uy(t)?128:jy(t)?64:de(t)?4:W(t)?2:0;return f(t,e,n,s,i,o,r,!0)}function Ky(t){return t?dd(t)||Ro in t?De({},t):t:null}function As(t,e,n=!1){const{props:s,ref:i,patchFlag:r,children:o}=t,a=e?Wy(s||{},e):s;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Hd(a),ref:e&&e.ref?n&&i?j(i)?i.concat(Dr(e)):[i,Dr(e)]:Dr(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Se?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&As(t.ssContent),ssFallback:t.ssFallback&&As(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function Be(t=" ",e=0){return we(ko,null,t,e)}function Xn(t,e){const n=we(Or,null,t);return n.staticCount=e,n}function Po(t="",e=!1){return e?(te(),qy(Hn,null,t)):we(Hn,null,t)}function Dt(t){return t==null||typeof t=="boolean"?we(Hn):j(t)?we(Se,null,t.slice()):typeof t=="object"?cn(t):we(ko,null,String(t))}function cn(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:As(t)}function $l(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(j(e))n=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),$l(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(Ro in e)?e._ctx=mt:i===3&&mt&&(mt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else W(e)?(e={default:e,_ctx:mt},n=32):(e=String(e),s&64?(n=16,e=[Be(e)]):n=8);t.children=e,t.shapeFlag|=n}function Wy(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=Jn([e.class,s.class]));else if(i==="style")e.style=Cl([e.style,s.style]);else if(wo(i)){const r=e[i],o=s[i];o&&r!==o&&!(j(r)&&r.includes(o))&&(e[i]=r?[].concat(r,o):o)}else i!==""&&(e[i]=s[i])}return e}function Ot(t,e,n,s=null){At(t,e,7,[n,s])}const Gy=xd();let Qy=0;function Yy(t,e,n){const s=t.type,i=(e?e.appContext:t.appContext)||Gy,r={uid:Qy++,vnode:t,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new vm(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ud(s,i),emitsOptions:Td(s,i),emit:null,emitted:null,propsDefaults:pe,inheritAttrs:s.inheritAttrs,ctx:pe,data:pe,props:pe,attrs:pe,slots:pe,refs:pe,setupState:pe,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=iy.bind(null,r),t.ce&&t.ce(r),r}let $e=null,Bl,os,hu="__VUE_INSTANCE_SETTERS__";(os=La()[hu])||(os=La()[hu]=[]),os.push(t=>$e=t),Bl=t=>{os.length>1?os.forEach(e=>e(t)):os[0](t)};const Ss=t=>{Bl(t),t.scope.on()},$n=()=>{$e&&$e.scope.off(),Bl(null)};function qd(t){return t.vnode.shapeFlag&4}let Ii=!1;function Jy(t,e=!1){Ii=e;const{props:n,children:s}=t.vnode,i=qd(t);My(t,n,i,e),Uy(t,s);const r=i?Xy(t,e):void 0;return Ii=!1,r}function Xy(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=fd(new Proxy(t.ctx,Sy));const{setup:s}=n;if(s){const i=t.setupContext=s.length>1?ev(t):null;Ss(t),$s();const r=mn(s,t,0,[t.props,i]);if(Bs(),$n(),Yh(r)){if(r.then($n,$n),e)return r.then(o=>{du(t,o,e)}).catch(o=>{To(o,t,0)});t.asyncDep=r}else du(t,r,e)}else zd(t,e)}function du(t,e,n){W(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:de(e)&&(t.setupState=vd(e)),zd(t,n)}let fu;function zd(t,e,n){const s=t.type;if(!t.render){if(!e&&fu&&!s.render){const i=s.template||Ul(t).template;if(i){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=s,c=De(De({isCustomElement:r,delimiters:a},o),l);s.render=fu(i,c)}}t.render=s.render||Tt}Ss(t),$s(),Cy(t),Bs(),$n()}function Zy(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return ot(t,"get","$attrs"),e[n]}}))}function ev(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return Zy(t)},slots:t.slots,emit:t.emit,expose:e}}function Oo(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(vd(fd(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in ai)return ai[n](t)},has(e,n){return n in e||n in ai}}))}function tv(t,e=!0){return W(t)?t.displayName||t.name:t.name||e&&t.__name}function nv(t){return W(t)&&"__vccOpts"in t}const pt=(t,e)=>Xm(t,e,Ii);function Kd(t,e,n){const s=arguments.length;return s===2?de(e)&&!j(e)?Wa(e)?we(t,null,[e]):we(t,e):we(t,null,e):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&Wa(n)&&(n=[n]),we(t,e,n))}const sv=Symbol.for("v-scx"),iv=()=>Ut(sv),rv="3.3.4",ov="http://www.w3.org/2000/svg",Dn=typeof document<"u"?document:null,pu=Dn&&Dn.createElement("template"),av={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const i=e?Dn.createElementNS(ov,t):Dn.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:t=>Dn.createTextNode(t),createComment:t=>Dn.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Dn.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,s,i,r){const o=n?n.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{pu.innerHTML=s?`<svg>${t}</svg>`:t;const a=pu.content;if(s){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function lv(t,e,n){const s=t._vtc;s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function cv(t,e,n){const s=t.style,i=Ce(n);if(n&&!i){if(e&&!Ce(e))for(const r in e)n[r]==null&&Ga(s,r,"");for(const r in n)Ga(s,r,n[r])}else{const r=s.display;i?e!==n&&(s.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(s.display=r)}}const gu=/\s*!important$/;function Ga(t,e,n){if(j(n))n.forEach(s=>Ga(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=uv(t,e);gu.test(n)?t.setProperty(Fs(s),n.replace(gu,""),"important"):t[s]=n}}const mu=["Webkit","Moz","ms"],ua={};function uv(t,e){const n=ua[e];if(n)return n;let s=jt(e);if(s!=="filter"&&s in t)return ua[e]=s;s=bo(s);for(let i=0;i<mu.length;i++){const r=mu[i]+s;if(r in t)return ua[e]=r}return e}const yu="http://www.w3.org/1999/xlink";function hv(t,e,n,s,i){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(yu,e.slice(6,e.length)):t.setAttributeNS(yu,e,n);else{const r=mm(e);n==null||r&&!Zh(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function dv(t,e,n,s,i,r,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,i,r),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const c=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";c!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let l=!1;if(n===""||n==null){const c=typeof t[e];c==="boolean"?n=Zh(n):n==null&&c==="string"?(n="",l=!0):c==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}function Nn(t,e,n,s){t.addEventListener(e,n,s)}function fv(t,e,n,s){t.removeEventListener(e,n,s)}function pv(t,e,n,s,i=null){const r=t._vei||(t._vei={}),o=r[e];if(s&&o)o.value=s;else{const[a,l]=gv(e);if(s){const c=r[e]=vv(s,i);Nn(t,a,c,l)}else o&&(fv(t,a,o,l),r[e]=void 0)}}const vu=/(?:Once|Passive|Capture)$/;function gv(t){let e;if(vu.test(t)){e={};let s;for(;s=t.match(vu);)t=t.slice(0,t.length-s[0].length),e[s[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Fs(t.slice(2)),e]}let ha=0;const mv=Promise.resolve(),yv=()=>ha||(mv.then(()=>ha=0),ha=Date.now());function vv(t,e){const n=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=n.attached)return;At(_v(s,n.value),e,5,[s])};return n.value=t,n.attached=yv(),n}function _v(t,e){if(j(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>i=>!i._stopped&&s&&s(i))}else return e}const _u=/^on[a-z]/,wv=(t,e,n,s,i=!1,r,o,a,l)=>{e==="class"?lv(t,s,i):e==="style"?cv(t,n,s):wo(e)?Tl(e)||pv(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Ev(t,e,s,i))?dv(t,e,s,r,o,a,l):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),hv(t,e,s,i))};function Ev(t,e,n,s){return s?!!(e==="innerHTML"||e==="textContent"||e in t&&_u.test(e)&&W(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||_u.test(e)&&Ce(n)?!1:e in t}const zr=t=>{const e=t.props["onUpdate:modelValue"]||!1;return j(e)?n=>Cr(e,n):e};function bv(t){t.target.composing=!0}function wu(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ve={created(t,{modifiers:{lazy:e,trim:n,number:s}},i){t._assign=zr(i);const r=s||i.props&&i.props.type==="number";Nn(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),r&&(a=xa(a)),t._assign(a)}),n&&Nn(t,"change",()=>{t.value=t.value.trim()}),e||(Nn(t,"compositionstart",bv),Nn(t,"compositionend",wu),Nn(t,"change",wu))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:s,number:i}},r){if(t._assign=zr(r),t.composing||document.activeElement===t&&t.type!=="range"&&(n||s&&t.value.trim()===e||(i||t.type==="number")&&xa(t.value)===e))return;const o=e??"";t.value!==o&&(t.value=o)}},Eu={created(t,{value:e},n){t.checked=Br(e,n.props.value),t._assign=zr(n),Nn(t,"change",()=>{t._assign(Iv(t))})},beforeUpdate(t,{value:e,oldValue:n},s){t._assign=zr(s),e!==n&&(t.checked=Br(e,s.props.value))}};function Iv(t){return"_value"in t?t._value:t.value}const Tv=["ctrl","shift","alt","meta"],Av={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>Tv.some(n=>t[`${n}Key`]&&!e.includes(n))},Vl=(t,e)=>(n,...s)=>{for(let i=0;i<e.length;i++){const r=Av[e[i]];if(r&&r(n,e))return}return t(n,...s)},Sv=De({patchProp:wv},av);let bu;function Cv(){return bu||(bu=$y(Sv))}const kv=(...t)=>{const e=Cv().createApp(...t),{mount:n}=e;return e.mount=s=>{const i=Rv(s);if(!i)return;const r=e._component;!W(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function Rv(t){return Ce(t)?document.querySelector(t):t}/*!
  * vue-router v4.2.2
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const ls=typeof window<"u";function Pv(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const oe=Object.assign;function da(t,e){const n={};for(const s in e){const i=e[s];n[s]=St(i)?i.map(t):t(i)}return n}const ci=()=>{},St=Array.isArray,Ov=/\/$/,Dv=t=>t.replace(Ov,"");function fa(t,e,n="/"){let s,i={},r="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(s=e.slice(0,l),r=e.slice(l+1,a>-1?a:e.length),i=t(r)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=Lv(s??e,n),{fullPath:s+(r&&"?")+r+o,path:s,query:i,hash:o}}function Nv(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Iu(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function Mv(t,e,n){const s=e.matched.length-1,i=n.matched.length-1;return s>-1&&s===i&&Cs(e.matched[s],n.matched[i])&&Wd(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Cs(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Wd(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!xv(t[n],e[n]))return!1;return!0}function xv(t,e){return St(t)?Tu(t,e):St(e)?Tu(e,t):t===e}function Tu(t,e){return St(e)?t.length===e.length&&t.every((n,s)=>n===e[s]):t.length===1&&t[0]===e}function Lv(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),s=t.split("/"),i=s[s.length-1];(i===".."||i===".")&&s.push("");let r=n.length-1,o,a;for(o=0;o<s.length;o++)if(a=s[o],a!==".")if(a==="..")r>1&&r--;else break;return n.slice(0,r).join("/")+"/"+s.slice(o-(o===s.length?1:0)).join("/")}var Ti;(function(t){t.pop="pop",t.push="push"})(Ti||(Ti={}));var ui;(function(t){t.back="back",t.forward="forward",t.unknown=""})(ui||(ui={}));function Uv(t){if(!t)if(ls){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Dv(t)}const Fv=/^[^#]+#/;function $v(t,e){return t.replace(Fv,"#")+e}function Bv(t,e){const n=document.documentElement.getBoundingClientRect(),s=t.getBoundingClientRect();return{behavior:e.behavior,left:s.left-n.left-(e.left||0),top:s.top-n.top-(e.top||0)}}const Do=()=>({left:window.pageXOffset,top:window.pageYOffset});function Vv(t){let e;if("el"in t){const n=t.el,s=typeof n=="string"&&n.startsWith("#"),i=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;e=Bv(i,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Au(t,e){return(history.state?history.state.position-e:-1)+t}const Qa=new Map;function jv(t,e){Qa.set(t,e)}function Hv(t){const e=Qa.get(t);return Qa.delete(t),e}let qv=()=>location.protocol+"//"+location.host;function Gd(t,e){const{pathname:n,search:s,hash:i}=e,r=t.indexOf("#");if(r>-1){let a=i.includes(t.slice(r))?t.slice(r).length:1,l=i.slice(a);return l[0]!=="/"&&(l="/"+l),Iu(l,"")}return Iu(n,t)+s+i}function zv(t,e,n,s){let i=[],r=[],o=null;const a=({state:g})=>{const y=Gd(t,location),I=n.value,C=e.value;let D=0;if(g){if(n.value=y,e.value=g,o&&o===I){o=null;return}D=C?g.position-C.position:0}else s(y);i.forEach(N=>{N(n.value,I,{delta:D,type:Ti.pop,direction:D?D>0?ui.forward:ui.back:ui.unknown})})};function l(){o=n.value}function c(g){i.push(g);const y=()=>{const I=i.indexOf(g);I>-1&&i.splice(I,1)};return r.push(y),y}function u(){const{history:g}=window;g.state&&g.replaceState(oe({},g.state,{scroll:Do()}),"")}function h(){for(const g of r)g();r=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",u,{passive:!0}),{pauseListeners:l,listen:c,destroy:h}}function Su(t,e,n,s=!1,i=!1){return{back:t,current:e,forward:n,replaced:s,position:window.history.length,scroll:i?Do():null}}function Kv(t){const{history:e,location:n}=window,s={value:Gd(t,n)},i={value:e.state};i.value||r(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function r(l,c,u){const h=t.indexOf("#"),g=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+l:qv()+t+l;try{e[u?"replaceState":"pushState"](c,"",g),i.value=c}catch(y){console.error(y),n[u?"replace":"assign"](g)}}function o(l,c){const u=oe({},e.state,Su(i.value.back,l,i.value.forward,!0),c,{position:i.value.position});r(l,u,!0),s.value=l}function a(l,c){const u=oe({},i.value,e.state,{forward:l,scroll:Do()});r(u.current,u,!0);const h=oe({},Su(s.value,l,null),{position:u.position+1},c);r(l,h,!1),s.value=l}return{location:s,state:i,push:a,replace:o}}function Wv(t){t=Uv(t);const e=Kv(t),n=zv(t,e.state,e.location,e.replace);function s(r,o=!0){o||n.pauseListeners(),history.go(r)}const i=oe({location:"",base:t,go:s,createHref:$v.bind(null,t)},e,n);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>e.state.value}),i}function Gv(t){return typeof t=="string"||t&&typeof t=="object"}function Qd(t){return typeof t=="string"||typeof t=="symbol"}const an={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Yd=Symbol("");var Cu;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Cu||(Cu={}));function ks(t,e){return oe(new Error,{type:t,[Yd]:!0},e)}function Kt(t,e){return t instanceof Error&&Yd in t&&(e==null||!!(t.type&e))}const ku="[^/]+?",Qv={sensitive:!1,strict:!1,start:!0,end:!0},Yv=/[.+*?^${}()[\]/\\]/g;function Jv(t,e){const n=oe({},Qv,e),s=[];let i=n.start?"^":"";const r=[];for(const c of t){const u=c.length?[]:[90];n.strict&&!c.length&&(i+="/");for(let h=0;h<c.length;h++){const g=c[h];let y=40+(n.sensitive?.25:0);if(g.type===0)h||(i+="/"),i+=g.value.replace(Yv,"\\$&"),y+=40;else if(g.type===1){const{value:I,repeatable:C,optional:D,regexp:N}=g;r.push({name:I,repeatable:C,optional:D});const x=N||ku;if(x!==ku){y+=10;try{new RegExp(`(${x})`)}catch(L){throw new Error(`Invalid custom RegExp for param "${I}" (${x}): `+L.message)}}let G=C?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;h||(G=D&&c.length<2?`(?:/${G})`:"/"+G),D&&(G+="?"),i+=G,y+=20,D&&(y+=-8),C&&(y+=-20),x===".*"&&(y+=-50)}u.push(y)}s.push(u)}if(n.strict&&n.end){const c=s.length-1;s[c][s[c].length-1]+=.7000000000000001}n.strict||(i+="/?"),n.end?i+="$":n.strict&&(i+="(?:/|$)");const o=new RegExp(i,n.sensitive?"":"i");function a(c){const u=c.match(o),h={};if(!u)return null;for(let g=1;g<u.length;g++){const y=u[g]||"",I=r[g-1];h[I.name]=y&&I.repeatable?y.split("/"):y}return h}function l(c){let u="",h=!1;for(const g of t){(!h||!u.endsWith("/"))&&(u+="/"),h=!1;for(const y of g)if(y.type===0)u+=y.value;else if(y.type===1){const{value:I,repeatable:C,optional:D}=y,N=I in c?c[I]:"";if(St(N)&&!C)throw new Error(`Provided param "${I}" is an array but it is not repeatable (* or + modifiers)`);const x=St(N)?N.join("/"):N;if(!x)if(D)g.length<2&&(u.endsWith("/")?u=u.slice(0,-1):h=!0);else throw new Error(`Missing required param "${I}"`);u+=x}}return u||"/"}return{re:o,score:s,keys:r,parse:a,stringify:l}}function Xv(t,e){let n=0;for(;n<t.length&&n<e.length;){const s=e[n]-t[n];if(s)return s;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function Zv(t,e){let n=0;const s=t.score,i=e.score;for(;n<s.length&&n<i.length;){const r=Xv(s[n],i[n]);if(r)return r;n++}if(Math.abs(i.length-s.length)===1){if(Ru(s))return 1;if(Ru(i))return-1}return i.length-s.length}function Ru(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const e0={type:0,value:""},t0=/[a-zA-Z0-9_]/;function n0(t){if(!t)return[[]];if(t==="/")return[[e0]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(y){throw new Error(`ERR (${n})/"${c}": ${y}`)}let n=0,s=n;const i=[];let r;function o(){r&&i.push(r),r=[]}let a=0,l,c="",u="";function h(){c&&(n===0?r.push({type:0,value:c}):n===1||n===2||n===3?(r.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),r.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function g(){c+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){s=n,n=4;continue}switch(n){case 0:l==="/"?(c&&h(),o()):l===":"?(h(),n=1):g();break;case 4:g(),n=s;break;case 1:l==="("?n=2:t0.test(l)?g():(h(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:n=3:u+=l;break;case 3:h(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${c}"`),h(),o(),i}function s0(t,e,n){const s=Jv(n0(t.path),n),i=oe(s,{record:t,parent:e,children:[],alias:[]});return e&&!i.record.aliasOf==!e.record.aliasOf&&e.children.push(i),i}function i0(t,e){const n=[],s=new Map;e=Du({strict:!1,end:!0,sensitive:!1},e);function i(u){return s.get(u)}function r(u,h,g){const y=!g,I=r0(u);I.aliasOf=g&&g.record;const C=Du(e,u),D=[I];if("alias"in u){const G=typeof u.alias=="string"?[u.alias]:u.alias;for(const L of G)D.push(oe({},I,{components:g?g.record.components:I.components,path:L,aliasOf:g?g.record:I}))}let N,x;for(const G of D){const{path:L}=G;if(h&&L[0]!=="/"){const Ee=h.record.path,ye=Ee[Ee.length-1]==="/"?"":"/";G.path=h.record.path+(L&&ye+L)}if(N=s0(G,h,C),g?g.alias.push(N):(x=x||N,x!==N&&x.alias.push(N),y&&u.name&&!Ou(N)&&o(u.name)),I.children){const Ee=I.children;for(let ye=0;ye<Ee.length;ye++)r(Ee[ye],N,g&&g.children[ye])}g=g||N,(N.record.components&&Object.keys(N.record.components).length||N.record.name||N.record.redirect)&&l(N)}return x?()=>{o(x)}:ci}function o(u){if(Qd(u)){const h=s.get(u);h&&(s.delete(u),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(u);h>-1&&(n.splice(h,1),u.record.name&&s.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function l(u){let h=0;for(;h<n.length&&Zv(u,n[h])>=0&&(u.record.path!==n[h].record.path||!Jd(u,n[h]));)h++;n.splice(h,0,u),u.record.name&&!Ou(u)&&s.set(u.record.name,u)}function c(u,h){let g,y={},I,C;if("name"in u&&u.name){if(g=s.get(u.name),!g)throw ks(1,{location:u});C=g.record.name,y=oe(Pu(h.params,g.keys.filter(x=>!x.optional).map(x=>x.name)),u.params&&Pu(u.params,g.keys.map(x=>x.name))),I=g.stringify(y)}else if("path"in u)I=u.path,g=n.find(x=>x.re.test(I)),g&&(y=g.parse(I),C=g.record.name);else{if(g=h.name?s.get(h.name):n.find(x=>x.re.test(h.path)),!g)throw ks(1,{location:u,currentLocation:h});C=g.record.name,y=oe({},h.params,u.params),I=g.stringify(y)}const D=[];let N=g;for(;N;)D.unshift(N.record),N=N.parent;return{name:C,path:I,params:y,matched:D,meta:a0(D)}}return t.forEach(u=>r(u)),{addRoute:r,resolve:c,removeRoute:o,getRoutes:a,getRecordMatcher:i}}function Pu(t,e){const n={};for(const s of e)s in t&&(n[s]=t[s]);return n}function r0(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:o0(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function o0(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const s in t.components)e[s]=typeof n=="boolean"?n:n[s];return e}function Ou(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function a0(t){return t.reduce((e,n)=>oe(e,n.meta),{})}function Du(t,e){const n={};for(const s in t)n[s]=s in e?e[s]:t[s];return n}function Jd(t,e){return e.children.some(n=>n===t||Jd(t,n))}const Xd=/#/g,l0=/&/g,c0=/\//g,u0=/=/g,h0=/\?/g,Zd=/\+/g,d0=/%5B/g,f0=/%5D/g,ef=/%5E/g,p0=/%60/g,tf=/%7B/g,g0=/%7C/g,nf=/%7D/g,m0=/%20/g;function jl(t){return encodeURI(""+t).replace(g0,"|").replace(d0,"[").replace(f0,"]")}function y0(t){return jl(t).replace(tf,"{").replace(nf,"}").replace(ef,"^")}function Ya(t){return jl(t).replace(Zd,"%2B").replace(m0,"+").replace(Xd,"%23").replace(l0,"%26").replace(p0,"`").replace(tf,"{").replace(nf,"}").replace(ef,"^")}function v0(t){return Ya(t).replace(u0,"%3D")}function _0(t){return jl(t).replace(Xd,"%23").replace(h0,"%3F")}function w0(t){return t==null?"":_0(t).replace(c0,"%2F")}function Kr(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function E0(t){const e={};if(t===""||t==="?")return e;const s=(t[0]==="?"?t.slice(1):t).split("&");for(let i=0;i<s.length;++i){const r=s[i].replace(Zd," "),o=r.indexOf("="),a=Kr(o<0?r:r.slice(0,o)),l=o<0?null:Kr(r.slice(o+1));if(a in e){let c=e[a];St(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function Nu(t){let e="";for(let n in t){const s=t[n];if(n=v0(n),s==null){s!==void 0&&(e+=(e.length?"&":"")+n);continue}(St(s)?s.map(r=>r&&Ya(r)):[s&&Ya(s)]).forEach(r=>{r!==void 0&&(e+=(e.length?"&":"")+n,r!=null&&(e+="="+r))})}return e}function b0(t){const e={};for(const n in t){const s=t[n];s!==void 0&&(e[n]=St(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return e}const I0=Symbol(""),Mu=Symbol(""),No=Symbol(""),sf=Symbol(""),Ja=Symbol("");function Xs(){let t=[];function e(s){return t.push(s),()=>{const i=t.indexOf(s);i>-1&&t.splice(i,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function un(t,e,n,s,i){const r=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((o,a)=>{const l=h=>{h===!1?a(ks(4,{from:n,to:e})):h instanceof Error?a(h):Gv(h)?a(ks(2,{from:e,to:h})):(r&&s.enterCallbacks[i]===r&&typeof h=="function"&&r.push(h),o())},c=t.call(s&&s.instances[i],e,n,l);let u=Promise.resolve(c);t.length<3&&(u=u.then(l)),u.catch(h=>a(h))})}function pa(t,e,n,s){const i=[];for(const r of t)for(const o in r.components){let a=r.components[o];if(!(e!=="beforeRouteEnter"&&!r.instances[o]))if(T0(a)){const c=(a.__vccOpts||a)[e];c&&i.push(un(c,n,s,r,o))}else{let l=a();i.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${r.path}"`));const u=Pv(c)?c.default:c;r.components[o]=u;const g=(u.__vccOpts||u)[e];return g&&un(g,n,s,r,o)()}))}}return i}function T0(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function xu(t){const e=Ut(No),n=Ut(sf),s=pt(()=>e.resolve(gs(t.to))),i=pt(()=>{const{matched:l}=s.value,{length:c}=l,u=l[c-1],h=n.matched;if(!u||!h.length)return-1;const g=h.findIndex(Cs.bind(null,u));if(g>-1)return g;const y=Lu(l[c-2]);return c>1&&Lu(u)===y&&h[h.length-1].path!==y?h.findIndex(Cs.bind(null,l[c-2])):g}),r=pt(()=>i.value>-1&&k0(n.params,s.value.params)),o=pt(()=>i.value>-1&&i.value===n.matched.length-1&&Wd(n.params,s.value.params));function a(l={}){return C0(l)?e[gs(t.replace)?"replace":"push"](gs(t.to)).catch(ci):Promise.resolve()}return{route:s,href:pt(()=>s.value.href),isActive:r,isExactActive:o,navigate:a}}const A0=kd({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:xu,setup(t,{slots:e}){const n=Hi(xu(t)),{options:s}=Ut(No),i=pt(()=>({[Uu(t.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[Uu(t.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const r=e.default&&e.default(n);return t.custom?r:Kd("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},r)}}}),S0=A0;function C0(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function k0(t,e){for(const n in e){const s=e[n],i=t[n];if(typeof s=="string"){if(s!==i)return!1}else if(!St(i)||i.length!==s.length||s.some((r,o)=>r!==i[o]))return!1}return!0}function Lu(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const Uu=(t,e,n)=>t??e??n,R0=kd({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const s=Ut(Ja),i=pt(()=>t.route||s.value),r=Ut(Mu,0),o=pt(()=>{let c=gs(r);const{matched:u}=i.value;let h;for(;(h=u[c])&&!h.components;)c++;return c}),a=pt(()=>i.value.matched[o.value]);Pr(Mu,pt(()=>o.value+1)),Pr(I0,a),Pr(Ja,i);const l=md();return kr(()=>[l.value,a.value,t.name],([c,u,h],[g,y,I])=>{u&&(u.instances[h]=c,y&&y!==u&&c&&c===g&&(u.leaveGuards.size||(u.leaveGuards=y.leaveGuards),u.updateGuards.size||(u.updateGuards=y.updateGuards))),c&&u&&(!y||!Cs(u,y)||!g)&&(u.enterCallbacks[h]||[]).forEach(C=>C(c))},{flush:"post"}),()=>{const c=i.value,u=t.name,h=a.value,g=h&&h.components[u];if(!g)return Fu(n.default,{Component:g,route:c});const y=h.props[u],I=y?y===!0?c.params:typeof y=="function"?y(c):y:null,D=Kd(g,oe({},I,e,{onVnodeUnmounted:N=>{N.component.isUnmounted&&(h.instances[u]=null)},ref:l}));return Fu(n.default,{Component:D,route:c})||D}}});function Fu(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const P0=R0;function O0(t){const e=i0(t.routes,t),n=t.parseQuery||E0,s=t.stringifyQuery||Nu,i=t.history,r=Xs(),o=Xs(),a=Xs(),l=Gm(an);let c=an;ls&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=da.bind(null,_=>""+_),h=da.bind(null,w0),g=da.bind(null,Kr);function y(_,M){let R,F;return Qd(_)?(R=e.getRecordMatcher(_),F=M):F=_,e.addRoute(F,R)}function I(_){const M=e.getRecordMatcher(_);M&&e.removeRoute(M)}function C(){return e.getRoutes().map(_=>_.record)}function D(_){return!!e.getRecordMatcher(_)}function N(_,M){if(M=oe({},M||l.value),typeof _=="string"){const m=fa(n,_,M.path),v=e.resolve({path:m.path},M),w=i.createHref(m.fullPath);return oe(m,v,{params:g(v.params),hash:Kr(m.hash),redirectedFrom:void 0,href:w})}let R;if("path"in _)R=oe({},_,{path:fa(n,_.path,M.path).path});else{const m=oe({},_.params);for(const v in m)m[v]==null&&delete m[v];R=oe({},_,{params:h(m)}),M.params=h(M.params)}const F=e.resolve(R,M),re=_.hash||"";F.params=u(g(F.params));const d=Nv(s,oe({},_,{hash:y0(re),path:F.path})),p=i.createHref(d);return oe({fullPath:d,hash:re,query:s===Nu?b0(_.query):_.query||{}},F,{redirectedFrom:void 0,href:p})}function x(_){return typeof _=="string"?fa(n,_,l.value.path):oe({},_)}function G(_,M){if(c!==_)return ks(8,{from:M,to:_})}function L(_){return je(_)}function Ee(_){return L(oe(x(_),{replace:!0}))}function ye(_){const M=_.matched[_.matched.length-1];if(M&&M.redirect){const{redirect:R}=M;let F=typeof R=="function"?R(_):R;return typeof F=="string"&&(F=F.includes("?")||F.includes("#")?F=x(F):{path:F},F.params={}),oe({query:_.query,hash:_.hash,params:"path"in F?{}:_.params},F)}}function je(_,M){const R=c=N(_),F=l.value,re=_.state,d=_.force,p=_.replace===!0,m=ye(R);if(m)return je(oe(x(m),{state:typeof m=="object"?oe({},re,m.state):re,force:d,replace:p}),M||R);const v=R;v.redirectedFrom=M;let w;return!d&&Mv(s,F,R)&&(w=ks(16,{to:v,from:F}),Rt(F,F,!0,!1)),(w?Promise.resolve(w):ft(v,F)).catch(E=>Kt(E)?Kt(E,2)?E:rn(E):ie(E,v,F)).then(E=>{if(E){if(Kt(E,2))return je(oe({replace:p},x(E.to),{state:typeof E.to=="object"?oe({},re,E.to.state):re,force:d}),M||v)}else E=Cn(v,F,!0,p,re);return sn(v,F,E),E})}function ct(_,M){const R=G(_,M);return R?Promise.reject(R):Promise.resolve()}function ut(_){const M=is.values().next().value;return M&&typeof M.runWithContext=="function"?M.runWithContext(_):_()}function ft(_,M){let R;const[F,re,d]=D0(_,M);R=pa(F.reverse(),"beforeRouteLeave",_,M);for(const m of F)m.leaveGuards.forEach(v=>{R.push(un(v,_,M))});const p=ct.bind(null,_,M);return R.push(p),He(R).then(()=>{R=[];for(const m of r.list())R.push(un(m,_,M));return R.push(p),He(R)}).then(()=>{R=pa(re,"beforeRouteUpdate",_,M);for(const m of re)m.updateGuards.forEach(v=>{R.push(un(v,_,M))});return R.push(p),He(R)}).then(()=>{R=[];for(const m of _.matched)if(m.beforeEnter&&!M.matched.includes(m))if(St(m.beforeEnter))for(const v of m.beforeEnter)R.push(un(v,_,M));else R.push(un(m.beforeEnter,_,M));return R.push(p),He(R)}).then(()=>(_.matched.forEach(m=>m.enterCallbacks={}),R=pa(d,"beforeRouteEnter",_,M),R.push(p),He(R))).then(()=>{R=[];for(const m of o.list())R.push(un(m,_,M));return R.push(p),He(R)}).catch(m=>Kt(m,8)?m:Promise.reject(m))}function sn(_,M,R){for(const F of a.list())ut(()=>F(_,M,R))}function Cn(_,M,R,F,re){const d=G(_,M);if(d)return d;const p=M===an,m=ls?history.state:{};R&&(F||p?i.replace(_.fullPath,oe({scroll:p&&m&&m.scroll},re)):i.push(_.fullPath,re)),l.value=_,Rt(_,M,R,p),rn()}let kt;function Qs(){kt||(kt=i.listen((_,M,R)=>{if(!cr.listening)return;const F=N(_),re=ye(F);if(re){je(oe(re,{replace:!0}),F).catch(ci);return}c=F;const d=l.value;ls&&jv(Au(d.fullPath,R.delta),Do()),ft(F,d).catch(p=>Kt(p,12)?p:Kt(p,2)?(je(p.to,F).then(m=>{Kt(m,20)&&!R.delta&&R.type===Ti.pop&&i.go(-1,!1)}).catch(ci),Promise.reject()):(R.delta&&i.go(-R.delta,!1),ie(p,F,d))).then(p=>{p=p||Cn(F,d,!1),p&&(R.delta&&!Kt(p,8)?i.go(-R.delta,!1):R.type===Ti.pop&&Kt(p,20)&&i.go(-1,!1)),sn(F,d,p)}).catch(ci)}))}let ns=Xs(),ke=Xs(),ce;function ie(_,M,R){rn(_);const F=ke.list();return F.length?F.forEach(re=>re(_,M,R)):console.error(_),Promise.reject(_)}function zt(){return ce&&l.value!==an?Promise.resolve():new Promise((_,M)=>{ns.add([_,M])})}function rn(_){return ce||(ce=!_,Qs(),ns.list().forEach(([M,R])=>_?R(_):M()),ns.reset()),_}function Rt(_,M,R,F){const{scrollBehavior:re}=t;if(!ls||!re)return Promise.resolve();const d=!R&&Hv(Au(_.fullPath,0))||(F||!R)&&history.state&&history.state.scroll||null;return wd().then(()=>re(_,M,d)).then(p=>p&&Vv(p)).catch(p=>ie(p,_,M))}const it=_=>i.go(_);let ss;const is=new Set,cr={currentRoute:l,listening:!0,addRoute:y,removeRoute:I,hasRoute:D,getRoutes:C,resolve:N,options:t,push:L,replace:Ee,go:it,back:()=>it(-1),forward:()=>it(1),beforeEach:r.add,beforeResolve:o.add,afterEach:a.add,onError:ke.add,isReady:zt,install(_){const M=this;_.component("RouterLink",S0),_.component("RouterView",P0),_.config.globalProperties.$router=M,Object.defineProperty(_.config.globalProperties,"$route",{enumerable:!0,get:()=>gs(l)}),ls&&!ss&&l.value===an&&(ss=!0,L(i.location).catch(re=>{}));const R={};for(const re in an)R[re]=pt(()=>l.value[re]);_.provide(No,M),_.provide(sf,Hi(R)),_.provide(Ja,l);const F=_.unmount;is.add(_),_.unmount=function(){is.delete(_),is.size<1&&(c=an,kt&&kt(),kt=null,l.value=an,ss=!1,ce=!1),F()}}};function He(_){return _.reduce((M,R)=>M.then(()=>ut(R)),Promise.resolve())}return cr}function D0(t,e){const n=[],s=[],i=[],r=Math.max(e.matched.length,t.matched.length);for(let o=0;o<r;o++){const a=e.matched[o];a&&(t.matched.find(c=>Cs(c,a))?s.push(a):n.push(a));const l=t.matched[o];l&&(e.matched.find(c=>Cs(c,l))||i.push(l))}return[n,s,i]}function N0(){return Ut(No)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ze(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function q0(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ze())}function z0(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function K0(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function W0(){const t=Ze();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function G0(){try{return typeof indexedDB=="object"}catch{return!1}}function Q0(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y0="FirebaseError";class nn extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=Y0,Object.setPrototypeOf(this,nn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,qi.prototype.create)}}class qi{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?J0(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new nn(i,a,s)}}function J0(t,e){return t.replace(X0,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const X0=/\{\$([^}]+)}/g;function Z0(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Gr(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const i of n){if(!s.includes(i))return!1;const r=t[i],o=e[i];if($u(r)&&$u(o)){if(!Gr(r,o))return!1}else if(r!==o)return!1}for(const i of s)if(!n.includes(i))return!1;return!0}function $u(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zn=new ql("@firebase/app"),T_="@firebase/app-compat",A_="@firebase/analytics-compat",S_="@firebase/analytics",C_="@firebase/app-check-compat",k_="@firebase/app-check",R_="@firebase/auth",P_="@firebase/auth-compat",O_="@firebase/database",D_="@firebase/database-compat",N_="@firebase/functions",M_="@firebase/functions-compat",x_="@firebase/installations",L_="@firebase/installations-compat",U_="@firebase/messaging",F_="@firebase/messaging-compat",$_="@firebase/performance",B_="@firebase/performance-compat",V_="@firebase/remote-config",j_="@firebase/remote-config-compat",H_="@firebase/storage",q_="@firebase/storage-compat",z_="@firebase/firestore",K_="@firebase/firestore-compat",W_="firebase",G_="9.23.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=new Map,nl=new Map;function Y_(t,e){try{t.container.addComponent(e)}catch(n){zn.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Rs(t){const e=t.name;if(nl.has(e))return zn.debug(`There were multiple attempts to register component ${e}.`),!1;nl.set(e,t);for(const n of Qr.values())Y_(n,t);return!0}function Kl(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const J_={["no-app"]:"No Firebase App '{$appName}' has been created - call initializeApp() first",["bad-app-name"]:"Illegal App name: '{$appName}",["duplicate-app"]:"Firebase App named '{$appName}' already exists with different options or config",["app-deleted"]:"Firebase App named '{$appName}' already deleted",["no-options"]:"Need to provide options, when not being deployed to hosting via source.",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance.",["invalid-log-argument"]:"First argument to `onLog` must be null or a function.",["idb-open"]:"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.",["idb-get"]:"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.",["idb-set"]:"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.",["idb-delete"]:"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},vn=new qi("app","Firebase",J_);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z_="firebase-heartbeat-database",ew=1,Ai="firebase-heartbeat-store";let _a=null;function gf(){return _a||(_a=__(Z_,ew,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Ai)}}}).catch(t=>{throw vn.create("idb-open",{originalErrorMessage:t.message})})),_a}async function tw(t){try{return await(await gf()).transaction(Ai).objectStore(Ai).get(mf(t))}catch(e){if(e instanceof nn)zn.warn(e.message);else{const n=vn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});zn.warn(n.message)}}}async function qu(t,e){try{const s=(await gf()).transaction(Ai,"readwrite");await s.objectStore(Ai).put(e,mf(t)),await s.done}catch(n){if(n instanceof nn)zn.warn(n.message);else{const s=vn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});zn.warn(s.message)}}}function mf(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nw=1024,sw=30*24*60*60*1e3;class iw{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new ow(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=zu();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s)))return this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const r=new Date(i.date).valueOf();return Date.now()-r<=sw}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=zu(),{heartbeatsToSend:n,unsentEntries:s}=rw(this._heartbeatsCache.heartbeats),i=Wr(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function zu(){return new Date().toISOString().substring(0,10)}function rw(t,e=nw){const n=[];let s=t.slice();for(const i of t){const r=n.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),Ku(n)>e){r.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Ku(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class ow{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return G0()?Q0().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await tw(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return qu(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return qu(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Ku(t){return Wr(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr=new ql("@firebase/auth");function cw(t,...e){Yr.logLevel<=ee.WARN&&Yr.warn(`Auth (${Vs}): ${t}`,...e)}function Nr(t,...e){Yr.logLevel<=ee.ERROR&&Yr.error(`Auth (${Vs}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dw(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(hw()||z0()||"connection"in navigator)?navigator.onLine:!0}function fw(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ki{constructor(e,n){this.shortDelay=e,this.longDelay=n,Xt(n>e,"Short delay should be less than long delay!"),this.isMobile=q0()||K0()}get(){return dw()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yw(t,e){return Zn(t,"POST","/v1/accounts:delete",e)}async function vw(t,e){return Zn(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hi(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function _w(t,e=!1){const n=at(t),s=await n.getIdToken(e),i=Yl(s);q(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const r=typeof i.firebase=="object"?i.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:i,token:s,authTime:hi(wa(i.auth_time)),issuedAtTime:hi(wa(i.iat)),expirationTime:hi(wa(i.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function wa(t){return Number(t)*1e3}function Yl(t){const[e,n,s]=t.split(".");if(e===void 0||n===void 0||s===void 0)return Nr("JWT malformed, contained fewer than 3 sections"),null;try{const i=af(n);return i?JSON.parse(i):(Nr("Failed to decode base64 JWT payload"),null)}catch(i){return Nr("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function ww(t){const e=Yl(t);return q(e,"internal-error"),q(typeof e.exp<"u","internal-error"),q(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ps(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof nn&&Ew(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function Ew({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sw(t,e){const n=await wf(t,{},async()=>{const s=zi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:r}=t.config,o=Ef(t,i,"/v1/token",`key=${r}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",_f.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mr(t,e,n){return`firebase:${t}:${e}:${n}`}class vs{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:i,name:r}=this.auth;this.fullUserKey=Mr(this.userKey,i.apiKey,r),this.fullPersistenceKey=Mr("persistence",i.apiKey,r),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Bn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new vs(Qt(Qu),e,s);const i=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let r=i[0]||Qt(Qu);const o=Mr(s,e.config.apiKey,e.name);let a=null;for(const c of n)try{const u=await c._get(o);if(u){const h=Bn._fromJSON(e,u);c!==r&&(a=h),r=c;break}}catch{}const l=i.filter(c=>c._shouldAllowMigration);return!r._shouldAllowMigration||!l.length?new vs(r,e,s):(r=l[0],a&&await r._set(o,a.toJSON()),await Promise.all(n.map(async c=>{if(c!==r)try{await c._remove(o)}catch{}})),new vs(r,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Of(t,e=[]){let n;switch(t){case"Browser":n=Yu(Ze());break;case"Worker":n=`${Yu(Ze())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Vs}/${s}`}async function Df(t,e){return Zn(t,"GET","/v2/recaptchaConfig",js(t,e))}function Ju(t){return t!==void 0&&t.enterprise!==void 0}class Nf{constructor(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(n=>n.provider==="EMAIL_PASSWORD_PROVIDER"&&n.enforcementState!=="OFF")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ea(t,e){return Wi(t,"POST","/v1/accounts:signInWithPassword",js(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hw(t,e){return Wi(t,"POST","/v1/accounts:signInWithEmailLink",js(t,e))}async function qw(t,e){return Wi(t,"POST","/v1/accounts:signInWithEmailLink",js(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _s(t,e){return Wi(t,"POST","/v1/accounts:signInWithIdp",js(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kw(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Ww(t){const e=si(ii(t)).link,n=e?si(ii(e)).deep_link_id:null,s=si(ii(t)).deep_link_id;return(s?si(ii(s)).link:null)||s||n||e||t}class Zl{constructor(e){var n,s,i,r,o,a;const l=si(ii(e)),c=(n=l.apiKey)!==null&&n!==void 0?n:null,u=(s=l.oobCode)!==null&&s!==void 0?s:null,h=Kw((i=l.mode)!==null&&i!==void 0?i:null);q(c&&u&&h,"argument-error"),this.apiKey=c,this.operation=h,this.code=u,this.continueUrl=(r=l.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=l.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=Ww(e);try{return new Zl(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hn extends Gi{constructor(){super("facebook.com")}static credential(e){return Kn._fromParams({providerId:hn.PROVIDER_ID,signInMethod:hn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return hn.credentialFromTaggedObject(e)}static credentialFromError(e){return hn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return hn.credential(e.oauthAccessToken)}catch{return null}}}hn.FACEBOOK_SIGN_IN_METHOD="facebook.com";hn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fn extends Gi{constructor(){super("github.com")}static credential(e){return Kn._fromParams({providerId:fn.PROVIDER_ID,signInMethod:fn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return fn.credentialFromTaggedObject(e)}static credentialFromError(e){return fn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return fn.credential(e.oauthAccessToken)}catch{return null}}}fn.GITHUB_SIGN_IN_METHOD="github.com";fn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ba(t,e){return Wi(t,"POST","/v1/accounts:signUp",js(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zw(t,e){return Zn(t,"POST","/v1/accounts:update",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eE(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const s=at(t),r={idToken:await s.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await Ps(s,Zw(s.auth,r));s.displayName=o.displayName||null,s.photoURL=o.photoUrl||null;const a=s.providerData.find(({providerId:l})=>l==="password");a&&(a.displayName=s.displayName,a.photoURL=s.photoURL),await s._updateTokensIfNecessary(o)}function tE(t,e,n,s){return at(t).onIdTokenChanged(e,n,s)}function nE(t,e,n){return at(t).beforeAuthStateChanged(e,n)}function sE(t){return at(t).signOut()}const eo="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xE(t,e={}){return Zn(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HE=new Ki(5e3,15e3),qE="__/auth/iframe",zE="emulator/auth/iframe",KE={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},WE=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function GE(t){const e=t.config;q(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Ql(e,zE):`https://${t.config.authDomain}/${qE}`,s={apiKey:e.apiKey,appName:t.name,v:Vs},i=WE.get(t.config.apiHost);i&&(s.eid=i);const r=t._getFrameworks();return r.length&&(s.fw=r.join(",")),`${n}?${zi(s).slice(1)}`}async function QE(t){const e=await jE(t),n=$t().gapi;return q(n,t,"internal-error"),e.open({where:document.body,url:GE(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:KE,dontclear:!0},s=>new Promise(async(i,r)=>{await s.restyle({setHideOnLeave:!1});const o=Ft(t,"network-request-failed"),a=$t().setTimeout(()=>{r(o)},HE.get());function l(){$t().clearTimeout(a),i(s)}s.ping(l).then(l,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s1="__/auth/handler",i1="emulator/auth/handler",r1=encodeURIComponent("fac");async function oh(t,e,n,s,i,r){q(t.config.authDomain,t,"auth-domain-config-required"),q(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:s,v:Vs,eventId:i};if(e instanceof Uf){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Z0(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,h]of Object.entries(r||{}))o[u]=h}if(e instanceof Gi){const u=e.getScopes().filter(h=>h!=="");u.length>0&&(o.scopes=u.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const l=await t._getAppCheckToken(),c=l?`#${r1}=${encodeURIComponent(l)}`:"";return`${o1(t)}?${zi(a).slice(1)}${c}`}function o1({config:t}){return t.emulator?Ql(t,i1):`https://${t.authDomain}/${s1}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u1(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function h1(t){Rs(new qn("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=s.options;q(o&&!o.includes(":"),"invalid-api-key",{appName:s.name});const l={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Of(t)},c=new Lw(s,i,r,l);return Fw(c,n),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),Rs(new qn("auth-internal",e=>{const n=Hs(e.getProvider("auth").getImmediate());return(s=>new c1(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),_n(ah,lh,u1(t)),_n(ah,lh,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d1=5*60,f1=uf("authIdTokenMaxAge")||d1;let ch=null;const p1=t=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>f1)return;const i=n==null?void 0:n.token;ch!==i&&(ch=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function g1(t=pf()){const e=Kl(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Uw(t,{popupRedirectResolver:l1,persistence:[_E,aE,Hf]}),s=uf("authTokenSyncURL");if(s){const r=p1(s);nE(n,r,()=>r(n.currentUser)),tE(n,o=>r(o))}const i=lf("auth");return i&&$w(n,`http://${i}`),n}h1("Browser");var m1=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},P,nc=nc||{},z=m1||self;function Uo(t){var e=typeof t;return e=e!="object"?e:t?Array.isArray(t)?"array":e:"null",e=="array"||e=="object"&&typeof t.length=="number"}function Yi(t){var e=typeof t;return e=="object"&&t!=null||e=="function"}function y1(t){return Object.prototype.hasOwnProperty.call(t,Ta)&&t[Ta]||(t[Ta]=++v1)}var Ta="closure_uid_"+(1e9*Math.random()>>>0),v1=0;function _1(t,e,n){return t.call.apply(t.bind,arguments)}function w1(t,e,n){if(!t)throw Error();if(2<arguments.length){var s=Array.prototype.slice.call(arguments,2);return function(){var i=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(i,s),t.apply(e,i)}}return function(){return t.apply(e,arguments)}}function Je(t,e,n){return Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?Je=_1:Je=w1,Je.apply(null,arguments)}function yr(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var s=n.slice();return s.push.apply(s,arguments),t.apply(this,s)}}function xe(t,e){function n(){}n.prototype=e.prototype,t.$=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.ac=function(s,i,r){for(var o=Array(arguments.length-2),a=2;a<arguments.length;a++)o[a-2]=arguments[a];return e.prototype[i].apply(s,o)}}function An(){this.s=this.s,this.o=this.o}var E1=0;An.prototype.s=!1;An.prototype.sa=function(){!this.s&&(this.s=!0,this.N(),E1!=0)&&y1(this)};An.prototype.N=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const Yf=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(typeof t=="string")return typeof e!="string"||e.length!=1?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return-1};function sc(t){const e=t.length;if(0<e){const n=Array(e);for(let s=0;s<e;s++)n[s]=t[s];return n}return[]}function uh(t,e){for(let n=1;n<arguments.length;n++){const s=arguments[n];if(Uo(s)){const i=t.length||0,r=s.length||0;t.length=i+r;for(let o=0;o<r;o++)t[i+o]=s[o]}else t.push(s)}}function Xe(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}Xe.prototype.h=function(){this.defaultPrevented=!0};var b1=function(){if(!z.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{z.addEventListener("test",()=>{},e),z.removeEventListener("test",()=>{},e)}catch{}return t}();function ki(t){return/^[\s\xa0]*$/.test(t)}function Fo(){var t=z.navigator;return t&&(t=t.userAgent)?t:""}function Mt(t){return Fo().indexOf(t)!=-1}function ic(t){return ic[" "](t),t}ic[" "]=function(){};function I1(t,e){var n=gb;return Object.prototype.hasOwnProperty.call(n,t)?n[t]:n[t]=e(t)}var T1=Mt("Opera"),Os=Mt("Trident")||Mt("MSIE"),Jf=Mt("Edge"),rl=Jf||Os,Xf=Mt("Gecko")&&!(Fo().toLowerCase().indexOf("webkit")!=-1&&!Mt("Edge"))&&!(Mt("Trident")||Mt("MSIE"))&&!Mt("Edge"),A1=Fo().toLowerCase().indexOf("webkit")!=-1&&!Mt("Edge");function Zf(){var t=z.document;return t?t.documentMode:void 0}var ol;e:{var Aa="",Sa=function(){var t=Fo();if(Xf)return/rv:([^\);]+)(\)|;)/.exec(t);if(Jf)return/Edge\/([\d\.]+)/.exec(t);if(Os)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(t);if(A1)return/WebKit\/(\S+)/.exec(t);if(T1)return/(?:Version)[ \/]?(\S+)/.exec(t)}();if(Sa&&(Aa=Sa?Sa[1]:""),Os){var Ca=Zf();if(Ca!=null&&Ca>parseFloat(Aa)){ol=String(Ca);break e}}ol=Aa}var al;if(z.document&&Os){var hh=Zf();al=hh||parseInt(ol,10)||void 0}else al=void 0;var S1=al;function Ri(t,e){if(Xe.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,s=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(Xf){e:{try{ic(e.nodeName);var i=!0;break e}catch{}i=!1}i||(e=null)}}else n=="mouseover"?e=t.fromElement:n=="mouseout"&&(e=t.toElement);this.relatedTarget=e,s?(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=typeof t.pointerType=="string"?t.pointerType:C1[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&Ri.$.h.call(this)}}xe(Ri,Xe);var C1={2:"touch",3:"pen",4:"mouse"};Ri.prototype.h=function(){Ri.$.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var Ji="closure_listenable_"+(1e6*Math.random()|0),k1=0;function R1(t,e,n,s,i){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!s,this.la=i,this.key=++k1,this.fa=this.ia=!1}function $o(t){t.fa=!0,t.listener=null,t.proxy=null,t.src=null,t.la=null}function rc(t,e,n){for(const s in t)e.call(n,t[s],s,t)}function P1(t,e){for(const n in t)e.call(void 0,t[n],n,t)}function ep(t){const e={};for(const n in t)e[n]=t[n];return e}const dh="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function tp(t,e){let n,s;for(let i=1;i<arguments.length;i++){s=arguments[i];for(n in s)t[n]=s[n];for(let r=0;r<dh.length;r++)n=dh[r],Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}}function Bo(t){this.src=t,this.g={},this.h=0}Bo.prototype.add=function(t,e,n,s,i){var r=t.toString();t=this.g[r],t||(t=this.g[r]=[],this.h++);var o=cl(t,e,s,i);return-1<o?(e=t[o],n||(e.ia=!1)):(e=new R1(e,this.src,r,!!s,i),e.ia=n,t.push(e)),e};function ll(t,e){var n=e.type;if(n in t.g){var s=t.g[n],i=Yf(s,e),r;(r=0<=i)&&Array.prototype.splice.call(s,i,1),r&&($o(e),t.g[n].length==0&&(delete t.g[n],t.h--))}}function cl(t,e,n,s){for(var i=0;i<t.length;++i){var r=t[i];if(!r.fa&&r.listener==e&&r.capture==!!n&&r.la==s)return i}return-1}var oc="closure_lm_"+(1e6*Math.random()|0),ka={};function np(t,e,n,s,i){if(s&&s.once)return ip(t,e,n,s,i);if(Array.isArray(e)){for(var r=0;r<e.length;r++)np(t,e[r],n,s,i);return null}return n=cc(n),t&&t[Ji]?t.O(e,n,Yi(s)?!!s.capture:!!s,i):sp(t,e,n,!1,s,i)}function sp(t,e,n,s,i,r){if(!e)throw Error("Invalid event type");var o=Yi(i)?!!i.capture:!!i,a=lc(t);if(a||(t[oc]=a=new Bo(t)),n=a.add(e,n,s,o,r),n.proxy)return n;if(s=O1(),n.proxy=s,s.src=t,s.listener=n,t.addEventListener)b1||(i=o),i===void 0&&(i=!1),t.addEventListener(e.toString(),s,i);else if(t.attachEvent)t.attachEvent(op(e.toString()),s);else if(t.addListener&&t.removeListener)t.addListener(s);else throw Error("addEventListener and attachEvent are unavailable.");return n}function O1(){function t(n){return e.call(t.src,t.listener,n)}const e=D1;return t}function ip(t,e,n,s,i){if(Array.isArray(e)){for(var r=0;r<e.length;r++)ip(t,e[r],n,s,i);return null}return n=cc(n),t&&t[Ji]?t.P(e,n,Yi(s)?!!s.capture:!!s,i):sp(t,e,n,!0,s,i)}function rp(t,e,n,s,i){if(Array.isArray(e))for(var r=0;r<e.length;r++)rp(t,e[r],n,s,i);else s=Yi(s)?!!s.capture:!!s,n=cc(n),t&&t[Ji]?(t=t.i,e=String(e).toString(),e in t.g&&(r=t.g[e],n=cl(r,n,s,i),-1<n&&($o(r[n]),Array.prototype.splice.call(r,n,1),r.length==0&&(delete t.g[e],t.h--)))):t&&(t=lc(t))&&(e=t.g[e.toString()],t=-1,e&&(t=cl(e,n,s,i)),(n=-1<t?e[t]:null)&&ac(n))}function ac(t){if(typeof t!="number"&&t&&!t.fa){var e=t.src;if(e&&e[Ji])ll(e.i,t);else{var n=t.type,s=t.proxy;e.removeEventListener?e.removeEventListener(n,s,t.capture):e.detachEvent?e.detachEvent(op(n),s):e.addListener&&e.removeListener&&e.removeListener(s),(n=lc(e))?(ll(n,t),n.h==0&&(n.src=null,e[oc]=null)):$o(t)}}}function op(t){return t in ka?ka[t]:ka[t]="on"+t}function D1(t,e){if(t.fa)t=!0;else{e=new Ri(e,this);var n=t.listener,s=t.la||t.src;t.ia&&ac(t),t=n.call(s,e)}return t}function lc(t){return t=t[oc],t instanceof Bo?t:null}var Ra="__closure_events_fn_"+(1e9*Math.random()>>>0);function cc(t){return typeof t=="function"?t:(t[Ra]||(t[Ra]=function(e){return t.handleEvent(e)}),t[Ra])}function Ne(){An.call(this),this.i=new Bo(this),this.S=this,this.J=null}xe(Ne,An);Ne.prototype[Ji]=!0;Ne.prototype.removeEventListener=function(t,e,n,s){rp(this,t,e,n,s)};function Ve(t,e){var n,s=t.J;if(s)for(n=[];s;s=s.J)n.push(s);if(t=t.S,s=e.type||e,typeof e=="string")e=new Xe(e,t);else if(e instanceof Xe)e.target=e.target||t;else{var i=e;e=new Xe(s,t),tp(e,i)}if(i=!0,n)for(var r=n.length-1;0<=r;r--){var o=e.g=n[r];i=vr(o,s,!0,e)&&i}if(o=e.g=t,i=vr(o,s,!0,e)&&i,i=vr(o,s,!1,e)&&i,n)for(r=0;r<n.length;r++)o=e.g=n[r],i=vr(o,s,!1,e)&&i}Ne.prototype.N=function(){if(Ne.$.N.call(this),this.i){var t=this.i,e;for(e in t.g){for(var n=t.g[e],s=0;s<n.length;s++)$o(n[s]);delete t.g[e],t.h--}}this.J=null};Ne.prototype.O=function(t,e,n,s){return this.i.add(String(t),e,!1,n,s)};Ne.prototype.P=function(t,e,n,s){return this.i.add(String(t),e,!0,n,s)};function vr(t,e,n,s){if(e=t.i.g[String(e)],!e)return!0;e=e.concat();for(var i=!0,r=0;r<e.length;++r){var o=e[r];if(o&&!o.fa&&o.capture==n){var a=o.listener,l=o.la||o.src;o.ia&&ll(t.i,o),i=a.call(l,s)!==!1&&i}}return i&&!s.defaultPrevented}var uc=z.JSON.stringify;class N1{constructor(e,n){this.i=e,this.j=n,this.h=0,this.g=null}get(){let e;return 0<this.h?(this.h--,e=this.g,this.g=e.next,e.next=null):e=this.i(),e}}function M1(){var t=hc;let e=null;return t.g&&(e=t.g,t.g=t.g.next,t.g||(t.h=null),e.next=null),e}class x1{constructor(){this.h=this.g=null}add(e,n){const s=ap.get();s.set(e,n),this.h?this.h.next=s:this.g=s,this.h=s}}var ap=new N1(()=>new L1,t=>t.reset());class L1{constructor(){this.next=this.g=this.h=null}set(e,n){this.h=e,this.g=n,this.next=null}reset(){this.next=this.g=this.h=null}}function U1(t){var e=1;t=t.split(":");const n=[];for(;0<e&&t.length;)n.push(t.shift()),e--;return t.length&&n.push(t.join(":")),n}function F1(t){z.setTimeout(()=>{throw t},0)}let Pi,Oi=!1,hc=new x1,lp=()=>{const t=z.Promise.resolve(void 0);Pi=()=>{t.then($1)}};var $1=()=>{for(var t;t=M1();){try{t.h.call(t.g)}catch(n){F1(n)}var e=ap;e.j(t),100>e.h&&(e.h++,t.next=e.g,e.g=t)}Oi=!1};function Vo(t,e){Ne.call(this),this.h=t||1,this.g=e||z,this.j=Je(this.qb,this),this.l=Date.now()}xe(Vo,Ne);P=Vo.prototype;P.ga=!1;P.T=null;P.qb=function(){if(this.ga){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.T=this.g.setTimeout(this.j,this.h-t):(this.T&&(this.g.clearTimeout(this.T),this.T=null),Ve(this,"tick"),this.ga&&(dc(this),this.start()))}};P.start=function(){this.ga=!0,this.T||(this.T=this.g.setTimeout(this.j,this.h),this.l=Date.now())};function dc(t){t.ga=!1,t.T&&(t.g.clearTimeout(t.T),t.T=null)}P.N=function(){Vo.$.N.call(this),dc(this),delete this.g};function fc(t,e,n){if(typeof t=="function")n&&(t=Je(t,n));else if(t&&typeof t.handleEvent=="function")t=Je(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:z.setTimeout(t,e||0)}function cp(t){t.g=fc(()=>{t.g=null,t.i&&(t.i=!1,cp(t))},t.j);const e=t.h;t.h=null,t.m.apply(null,e)}class B1 extends An{constructor(e,n){super(),this.m=e,this.j=n,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:cp(this)}N(){super.N(),this.g&&(z.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Di(t){An.call(this),this.h=t,this.g={}}xe(Di,An);var fh=[];function up(t,e,n,s){Array.isArray(n)||(n&&(fh[0]=n.toString()),n=fh);for(var i=0;i<n.length;i++){var r=np(e,n[i],s||t.handleEvent,!1,t.h||t);if(!r)break;t.g[r.key]=r}}function hp(t){rc(t.g,function(e,n){this.g.hasOwnProperty(n)&&ac(e)},t),t.g={}}Di.prototype.N=function(){Di.$.N.call(this),hp(this)};Di.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};function jo(){this.g=!0}jo.prototype.Ea=function(){this.g=!1};function V1(t,e,n,s,i,r){t.info(function(){if(t.g)if(r)for(var o="",a=r.split("&"),l=0;l<a.length;l++){var c=a[l].split("=");if(1<c.length){var u=c[0];c=c[1];var h=u.split("_");o=2<=h.length&&h[1]=="type"?o+(u+"="+c+"&"):o+(u+"=redacted&")}}else o=null;else o=r;return"XMLHTTP REQ ("+s+") [attempt "+i+"]: "+e+`
`+n+`
`+o})}function j1(t,e,n,s,i,r,o){t.info(function(){return"XMLHTTP RESP ("+s+") [ attempt "+i+"]: "+e+`
`+n+`
`+r+" "+o})}function hs(t,e,n,s){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+q1(t,n)+(s?" "+s:"")})}function H1(t,e){t.info(function(){return"TIMEOUT: "+e})}jo.prototype.info=function(){};function q1(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var s=n[t];if(!(2>s.length)){var i=s[1];if(Array.isArray(i)&&!(1>i.length)){var r=i[0];if(r!="noop"&&r!="stop"&&r!="close")for(var o=1;o<i.length;o++)i[o]=""}}}}return uc(n)}catch{return e}}var es={},ph=null;function Ho(){return ph=ph||new Ne}es.Ta="serverreachability";function dp(t){Xe.call(this,es.Ta,t)}xe(dp,Xe);function Ni(t){const e=Ho();Ve(e,new dp(e))}es.STAT_EVENT="statevent";function fp(t,e){Xe.call(this,es.STAT_EVENT,t),this.stat=e}xe(fp,Xe);function tt(t){const e=Ho();Ve(e,new fp(e,t))}es.Ua="timingevent";function pp(t,e){Xe.call(this,es.Ua,t),this.size=e}xe(pp,Xe);function Xi(t,e){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return z.setTimeout(function(){t()},e)}var qo={NO_ERROR:0,rb:1,Eb:2,Db:3,yb:4,Cb:5,Fb:6,Qa:7,TIMEOUT:8,Ib:9},gp={wb:"complete",Sb:"success",Ra:"error",Qa:"abort",Kb:"ready",Lb:"readystatechange",TIMEOUT:"timeout",Gb:"incrementaldata",Jb:"progress",zb:"downloadprogress",$b:"uploadprogress"};function pc(){}pc.prototype.h=null;function gh(t){return t.h||(t.h=t.i())}function mp(){}var Zi={OPEN:"a",vb:"b",Ra:"c",Hb:"d"};function gc(){Xe.call(this,"d")}xe(gc,Xe);function mc(){Xe.call(this,"c")}xe(mc,Xe);var ul;function zo(){}xe(zo,pc);zo.prototype.g=function(){return new XMLHttpRequest};zo.prototype.i=function(){return{}};ul=new zo;function er(t,e,n,s){this.l=t,this.j=e,this.m=n,this.W=s||1,this.U=new Di(this),this.P=z1,t=rl?125:void 0,this.V=new Vo(t),this.I=null,this.i=!1,this.s=this.A=this.v=this.L=this.G=this.Y=this.B=null,this.F=[],this.g=null,this.C=0,this.o=this.u=null,this.ca=-1,this.J=!1,this.O=0,this.M=null,this.ba=this.K=this.aa=this.S=!1,this.h=new yp}function yp(){this.i=null,this.g="",this.h=!1}var z1=45e3,hl={},no={};P=er.prototype;P.setTimeout=function(t){this.P=t};function dl(t,e,n){t.L=1,t.v=Wo(Zt(e)),t.s=n,t.S=!0,vp(t,null)}function vp(t,e){t.G=Date.now(),tr(t),t.A=Zt(t.v);var n=t.A,s=t.W;Array.isArray(s)||(s=[String(s)]),Sp(n.i,"t",s),t.C=0,n=t.l.J,t.h=new yp,t.g=Wp(t.l,n?e:null,!t.s),0<t.O&&(t.M=new B1(Je(t.Pa,t,t.g),t.O)),up(t.U,t.g,"readystatechange",t.nb),e=t.I?ep(t.I):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.ha(t.A,t.u,t.s,e)):(t.u="GET",t.g.ha(t.A,t.u,null,e)),Ni(),V1(t.j,t.u,t.A,t.m,t.W,t.s)}P.nb=function(t){t=t.target;const e=this.M;e&&xt(t)==3?e.l():this.Pa(t)};P.Pa=function(t){try{if(t==this.g)e:{const u=xt(this.g);var e=this.g.Ia();const h=this.g.da();if(!(3>u)&&(u!=3||rl||this.g&&(this.h.h||this.g.ja()||_h(this.g)))){this.J||u!=4||e==7||(e==8||0>=h?Ni(3):Ni(2)),Ko(this);var n=this.g.da();this.ca=n;t:if(_p(this)){var s=_h(this.g);t="";var i=s.length,r=xt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){xn(this),di(this);var o="";break t}this.h.i=new z.TextDecoder}for(e=0;e<i;e++)this.h.h=!0,t+=this.h.i.decode(s[e],{stream:r&&e==i-1});s.splice(0,i),this.h.g+=t,this.C=0,o=this.h.g}else o=this.g.ja();if(this.i=n==200,j1(this.j,this.u,this.A,this.m,this.W,u,n),this.i){if(this.aa&&!this.K){t:{if(this.g){var a,l=this.g;if((a=l.g?l.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!ki(a)){var c=a;break t}}c=null}if(n=c)hs(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,fl(this,n);else{this.i=!1,this.o=3,tt(12),xn(this),di(this);break e}}this.S?(wp(this,u,o),rl&&this.i&&u==3&&(up(this.U,this.V,"tick",this.mb),this.V.start())):(hs(this.j,this.m,o,null),fl(this,o)),u==4&&xn(this),this.i&&!this.J&&(u==4?Hp(this.l,this):(this.i=!1,tr(this)))}else db(this.g),n==400&&0<o.indexOf("Unknown SID")?(this.o=3,tt(12)):(this.o=0,tt(13)),xn(this),di(this)}}}catch{}finally{}};function _p(t){return t.g?t.u=="GET"&&t.L!=2&&t.l.Ha:!1}function wp(t,e,n){let s=!0,i;for(;!t.J&&t.C<n.length;)if(i=K1(t,n),i==no){e==4&&(t.o=4,tt(14),s=!1),hs(t.j,t.m,null,"[Incomplete Response]");break}else if(i==hl){t.o=4,tt(15),hs(t.j,t.m,n,"[Invalid Chunk]"),s=!1;break}else hs(t.j,t.m,i,null),fl(t,i);_p(t)&&i!=no&&i!=hl&&(t.h.g="",t.C=0),e!=4||n.length!=0||t.h.h||(t.o=1,tt(16),s=!1),t.i=t.i&&s,s?0<n.length&&!t.ba&&(t.ba=!0,e=t.l,e.g==t&&e.ca&&!e.M&&(e.l.info("Great, no buffering proxy detected. Bytes received: "+n.length),bc(e),e.M=!0,tt(11))):(hs(t.j,t.m,n,"[Invalid Chunked Response]"),xn(t),di(t))}P.mb=function(){if(this.g){var t=xt(this.g),e=this.g.ja();this.C<e.length&&(Ko(this),wp(this,t,e),this.i&&t!=4&&tr(this))}};function K1(t,e){var n=t.C,s=e.indexOf(`
`,n);return s==-1?no:(n=Number(e.substring(n,s)),isNaN(n)?hl:(s+=1,s+n>e.length?no:(e=e.slice(s,s+n),t.C=s+n,e)))}P.cancel=function(){this.J=!0,xn(this)};function tr(t){t.Y=Date.now()+t.P,Ep(t,t.P)}function Ep(t,e){if(t.B!=null)throw Error("WatchDog timer not null");t.B=Xi(Je(t.lb,t),e)}function Ko(t){t.B&&(z.clearTimeout(t.B),t.B=null)}P.lb=function(){this.B=null;const t=Date.now();0<=t-this.Y?(H1(this.j,this.A),this.L!=2&&(Ni(),tt(17)),xn(this),this.o=2,di(this)):Ep(this,this.Y-t)};function di(t){t.l.H==0||t.J||Hp(t.l,t)}function xn(t){Ko(t);var e=t.M;e&&typeof e.sa=="function"&&e.sa(),t.M=null,dc(t.V),hp(t.U),t.g&&(e=t.g,t.g=null,e.abort(),e.sa())}function fl(t,e){try{var n=t.l;if(n.H!=0&&(n.g==t||pl(n.i,t))){if(!t.K&&pl(n.i,t)&&n.H==3){try{var s=n.Ja.g.parse(e)}catch{s=null}if(Array.isArray(s)&&s.length==3){var i=s;if(i[0]==0){e:if(!n.u){if(n.g)if(n.g.G+3e3<t.G)ro(n),Yo(n);else break e;Ec(n),tt(18)}}else n.Fa=i[1],0<n.Fa-n.V&&37500>i[2]&&n.G&&n.A==0&&!n.v&&(n.v=Xi(Je(n.ib,n),6e3));if(1>=Rp(n.i)&&n.oa){try{n.oa()}catch{}n.oa=void 0}}else Ln(n,11)}else if((t.K||n.g==t)&&ro(n),!ki(e))for(i=n.Ja.g.parse(e),e=0;e<i.length;e++){let c=i[e];if(n.V=c[0],c=c[1],n.H==2)if(c[0]=="c"){n.K=c[1],n.pa=c[2];const u=c[3];u!=null&&(n.ra=u,n.l.info("VER="+n.ra));const h=c[4];h!=null&&(n.Ga=h,n.l.info("SVER="+n.Ga));const g=c[5];g!=null&&typeof g=="number"&&0<g&&(s=1.5*g,n.L=s,n.l.info("backChannelRequestTimeoutMs_="+s)),s=n;const y=t.g;if(y){const I=y.g?y.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(I){var r=s.i;r.g||I.indexOf("spdy")==-1&&I.indexOf("quic")==-1&&I.indexOf("h2")==-1||(r.j=r.l,r.g=new Set,r.h&&(yc(r,r.h),r.h=null))}if(s.F){const C=y.g?y.g.getResponseHeader("X-HTTP-Session-Id"):null;C&&(s.Da=C,ge(s.I,s.F,C))}}n.H=3,n.h&&n.h.Ba(),n.ca&&(n.S=Date.now()-t.G,n.l.info("Handshake RTT: "+n.S+"ms")),s=n;var o=t;if(s.wa=Kp(s,s.J?s.pa:null,s.Y),o.K){Pp(s.i,o);var a=o,l=s.L;l&&a.setTimeout(l),a.B&&(Ko(a),tr(a)),s.g=o}else Vp(s);0<n.j.length&&Jo(n)}else c[0]!="stop"&&c[0]!="close"||Ln(n,7);else n.H==3&&(c[0]=="stop"||c[0]=="close"?c[0]=="stop"?Ln(n,7):wc(n):c[0]!="noop"&&n.h&&n.h.Aa(c),n.A=0)}}Ni(4)}catch{}}function W1(t){if(t.Z&&typeof t.Z=="function")return t.Z();if(typeof Map<"u"&&t instanceof Map||typeof Set<"u"&&t instanceof Set)return Array.from(t.values());if(typeof t=="string")return t.split("");if(Uo(t)){for(var e=[],n=t.length,s=0;s<n;s++)e.push(t[s]);return e}e=[],n=0;for(s in t)e[n++]=t[s];return e}function G1(t){if(t.ta&&typeof t.ta=="function")return t.ta();if(!t.Z||typeof t.Z!="function"){if(typeof Map<"u"&&t instanceof Map)return Array.from(t.keys());if(!(typeof Set<"u"&&t instanceof Set)){if(Uo(t)||typeof t=="string"){var e=[];t=t.length;for(var n=0;n<t;n++)e.push(n);return e}e=[],n=0;for(const s in t)e[n++]=s;return e}}}function bp(t,e){if(t.forEach&&typeof t.forEach=="function")t.forEach(e,void 0);else if(Uo(t)||typeof t=="string")Array.prototype.forEach.call(t,e,void 0);else for(var n=G1(t),s=W1(t),i=s.length,r=0;r<i;r++)e.call(void 0,s[r],n&&n[r],t)}var Ip=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Q1(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var s=t[n].indexOf("="),i=null;if(0<=s){var r=t[n].substring(0,s);i=t[n].substring(s+1)}else r=t[n];e(r,i?decodeURIComponent(i.replace(/\+/g," ")):"")}}}function Vn(t){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,t instanceof Vn){this.h=t.h,so(this,t.j),this.s=t.s,this.g=t.g,io(this,t.m),this.l=t.l;var e=t.i,n=new Mi;n.i=e.i,e.g&&(n.g=new Map(e.g),n.h=e.h),mh(this,n),this.o=t.o}else t&&(e=String(t).match(Ip))?(this.h=!1,so(this,e[1]||"",!0),this.s=ri(e[2]||""),this.g=ri(e[3]||"",!0),io(this,e[4]),this.l=ri(e[5]||"",!0),mh(this,e[6]||"",!0),this.o=ri(e[7]||"")):(this.h=!1,this.i=new Mi(null,this.h))}Vn.prototype.toString=function(){var t=[],e=this.j;e&&t.push(oi(e,yh,!0),":");var n=this.g;return(n||e=="file")&&(t.push("//"),(e=this.s)&&t.push(oi(e,yh,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),n=this.m,n!=null&&t.push(":",String(n))),(n=this.l)&&(this.g&&n.charAt(0)!="/"&&t.push("/"),t.push(oi(n,n.charAt(0)=="/"?X1:J1,!0))),(n=this.i.toString())&&t.push("?",n),(n=this.o)&&t.push("#",oi(n,eb)),t.join("")};function Zt(t){return new Vn(t)}function so(t,e,n){t.j=n?ri(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function io(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function mh(t,e,n){e instanceof Mi?(t.i=e,tb(t.i,t.h)):(n||(e=oi(e,Z1)),t.i=new Mi(e,t.h))}function ge(t,e,n){t.i.set(e,n)}function Wo(t){return ge(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function ri(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function oi(t,e,n){return typeof t=="string"?(t=encodeURI(t).replace(e,Y1),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function Y1(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var yh=/[#\/\?@]/g,J1=/[#\?:]/g,X1=/[#\?]/g,Z1=/[#\?@]/g,eb=/#/g;function Mi(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function Sn(t){t.g||(t.g=new Map,t.h=0,t.i&&Q1(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}P=Mi.prototype;P.add=function(t,e){Sn(this),this.i=null,t=zs(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this};function Tp(t,e){Sn(t),e=zs(t,e),t.g.has(e)&&(t.i=null,t.h-=t.g.get(e).length,t.g.delete(e))}function Ap(t,e){return Sn(t),e=zs(t,e),t.g.has(e)}P.forEach=function(t,e){Sn(this),this.g.forEach(function(n,s){n.forEach(function(i){t.call(e,i,s,this)},this)},this)};P.ta=function(){Sn(this);const t=Array.from(this.g.values()),e=Array.from(this.g.keys()),n=[];for(let s=0;s<e.length;s++){const i=t[s];for(let r=0;r<i.length;r++)n.push(e[s])}return n};P.Z=function(t){Sn(this);let e=[];if(typeof t=="string")Ap(this,t)&&(e=e.concat(this.g.get(zs(this,t))));else{t=Array.from(this.g.values());for(let n=0;n<t.length;n++)e=e.concat(t[n])}return e};P.set=function(t,e){return Sn(this),this.i=null,t=zs(this,t),Ap(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this};P.get=function(t,e){return t?(t=this.Z(t),0<t.length?String(t[0]):e):e};function Sp(t,e,n){Tp(t,e),0<n.length&&(t.i=null,t.g.set(zs(t,e),sc(n)),t.h+=n.length)}P.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],e=Array.from(this.g.keys());for(var n=0;n<e.length;n++){var s=e[n];const r=encodeURIComponent(String(s)),o=this.Z(s);for(s=0;s<o.length;s++){var i=r;o[s]!==""&&(i+="="+encodeURIComponent(String(o[s]))),t.push(i)}}return this.i=t.join("&")};function zs(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}function tb(t,e){e&&!t.j&&(Sn(t),t.i=null,t.g.forEach(function(n,s){var i=s.toLowerCase();s!=i&&(Tp(this,s),Sp(this,i,n))},t)),t.j=e}var nb=class{constructor(t,e){this.g=t,this.map=e}};function Cp(t){this.l=t||sb,z.PerformanceNavigationTiming?(t=z.performance.getEntriesByType("navigation"),t=0<t.length&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(z.g&&z.g.Ka&&z.g.Ka()&&z.g.Ka().ec),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var sb=10;function kp(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function Rp(t){return t.h?1:t.g?t.g.size:0}function pl(t,e){return t.h?t.h==e:t.g?t.g.has(e):!1}function yc(t,e){t.g?t.g.add(e):t.h=e}function Pp(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}Cp.prototype.cancel=function(){if(this.i=Op(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function Op(t){if(t.h!=null)return t.i.concat(t.h.F);if(t.g!=null&&t.g.size!==0){let e=t.i;for(const n of t.g.values())e=e.concat(n.F);return e}return sc(t.i)}var ib=class{stringify(t){return z.JSON.stringify(t,void 0)}parse(t){return z.JSON.parse(t,void 0)}};function rb(){this.g=new ib}function ob(t,e,n){const s=n||"";try{bp(t,function(i,r){let o=i;Yi(i)&&(o=uc(i)),e.push(s+r+"="+encodeURIComponent(o))})}catch(i){throw e.push(s+"type="+encodeURIComponent("_badmap")),i}}function ab(t,e){const n=new jo;if(z.Image){const s=new Image;s.onload=yr(_r,n,s,"TestLoadImage: loaded",!0,e),s.onerror=yr(_r,n,s,"TestLoadImage: error",!1,e),s.onabort=yr(_r,n,s,"TestLoadImage: abort",!1,e),s.ontimeout=yr(_r,n,s,"TestLoadImage: timeout",!1,e),z.setTimeout(function(){s.ontimeout&&s.ontimeout()},1e4),s.src=t}else e(!1)}function _r(t,e,n,s,i){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,i(s)}catch{}}function nr(t){this.l=t.fc||null,this.j=t.ob||!1}xe(nr,pc);nr.prototype.g=function(){return new Go(this.l,this.j)};nr.prototype.i=function(t){return function(){return t}}({});function Go(t,e){Ne.call(this),this.F=t,this.u=e,this.m=void 0,this.readyState=vc,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}xe(Go,Ne);var vc=0;P=Go.prototype;P.open=function(t,e){if(this.readyState!=vc)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,xi(this)};P.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.F||z).fetch(new Request(this.B,e)).then(this.$a.bind(this),this.ka.bind(this))};P.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,sr(this)),this.readyState=vc};P.$a=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,xi(this)),this.g&&(this.readyState=3,xi(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Ya.bind(this),this.ka.bind(this));else if(typeof z.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;Dp(this)}else t.text().then(this.Za.bind(this),this.ka.bind(this))};function Dp(t){t.j.read().then(t.Xa.bind(t)).catch(t.ka.bind(t))}P.Xa=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?sr(this):xi(this),this.readyState==3&&Dp(this)}};P.Za=function(t){this.g&&(this.response=this.responseText=t,sr(this))};P.Ya=function(t){this.g&&(this.response=t,sr(this))};P.ka=function(){this.g&&sr(this)};function sr(t){t.readyState=4,t.l=null,t.j=null,t.A=null,xi(t)}P.setRequestHeader=function(t,e){this.v.append(t,e)};P.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""};P.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],e=this.h.entries();for(var n=e.next();!n.done;)n=n.value,t.push(n[0]+": "+n[1]),n=e.next();return t.join(`\r
`)};function xi(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(Go.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});var lb=z.JSON.parse;function Ie(t){Ne.call(this),this.headers=new Map,this.u=t||null,this.h=!1,this.C=this.g=null,this.I="",this.m=0,this.j="",this.l=this.G=this.v=this.F=!1,this.B=0,this.A=null,this.K=Np,this.L=this.M=!1}xe(Ie,Ne);var Np="",cb=/^https?$/i,ub=["POST","PUT"];P=Ie.prototype;P.Oa=function(t){this.M=t};P.ha=function(t,e,n,s){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.I+"; newUri="+t);e=e?e.toUpperCase():"GET",this.I=t,this.j="",this.m=0,this.F=!1,this.h=!0,this.g=this.u?this.u.g():ul.g(),this.C=this.u?gh(this.u):gh(ul),this.g.onreadystatechange=Je(this.La,this);try{this.G=!0,this.g.open(e,String(t),!0),this.G=!1}catch(r){vh(this,r);return}if(t=n||"",n=new Map(this.headers),s)if(Object.getPrototypeOf(s)===Object.prototype)for(var i in s)n.set(i,s[i]);else if(typeof s.keys=="function"&&typeof s.get=="function")for(const r of s.keys())n.set(r,s.get(r));else throw Error("Unknown input type for opt_headers: "+String(s));s=Array.from(n.keys()).find(r=>r.toLowerCase()=="content-type"),i=z.FormData&&t instanceof z.FormData,!(0<=Yf(ub,e))||s||i||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[r,o]of n)this.g.setRequestHeader(r,o);this.K&&(this.g.responseType=this.K),"withCredentials"in this.g&&this.g.withCredentials!==this.M&&(this.g.withCredentials=this.M);try{Lp(this),0<this.B&&((this.L=hb(this.g))?(this.g.timeout=this.B,this.g.ontimeout=Je(this.ua,this)):this.A=fc(this.ua,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(r){vh(this,r)}};function hb(t){return Os&&typeof t.timeout=="number"&&t.ontimeout!==void 0}P.ua=function(){typeof nc<"u"&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,Ve(this,"timeout"),this.abort(8))};function vh(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,Mp(t),Qo(t)}function Mp(t){t.F||(t.F=!0,Ve(t,"complete"),Ve(t,"error"))}P.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,Ve(this,"complete"),Ve(this,"abort"),Qo(this))};P.N=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Qo(this,!0)),Ie.$.N.call(this)};P.La=function(){this.s||(this.G||this.v||this.l?xp(this):this.kb())};P.kb=function(){xp(this)};function xp(t){if(t.h&&typeof nc<"u"&&(!t.C[1]||xt(t)!=4||t.da()!=2)){if(t.v&&xt(t)==4)fc(t.La,0,t);else if(Ve(t,"readystatechange"),xt(t)==4){t.h=!1;try{const o=t.da();e:switch(o){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e=!0;break e;default:e=!1}var n;if(!(n=e)){var s;if(s=o===0){var i=String(t.I).match(Ip)[1]||null;!i&&z.self&&z.self.location&&(i=z.self.location.protocol.slice(0,-1)),s=!cb.test(i?i.toLowerCase():"")}n=s}if(n)Ve(t,"complete"),Ve(t,"success");else{t.m=6;try{var r=2<xt(t)?t.g.statusText:""}catch{r=""}t.j=r+" ["+t.da()+"]",Mp(t)}}finally{Qo(t)}}}}function Qo(t,e){if(t.g){Lp(t);const n=t.g,s=t.C[0]?()=>{}:null;t.g=null,t.C=null,e||Ve(t,"ready");try{n.onreadystatechange=s}catch{}}}function Lp(t){t.g&&t.L&&(t.g.ontimeout=null),t.A&&(z.clearTimeout(t.A),t.A=null)}P.isActive=function(){return!!this.g};function xt(t){return t.g?t.g.readyState:0}P.da=function(){try{return 2<xt(this)?this.g.status:-1}catch{return-1}};P.ja=function(){try{return this.g?this.g.responseText:""}catch{return""}};P.Wa=function(t){if(this.g){var e=this.g.responseText;return t&&e.indexOf(t)==0&&(e=e.substring(t.length)),lb(e)}};function _h(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.K){case Np:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}function db(t){const e={};t=(t.g&&2<=xt(t)&&t.g.getAllResponseHeaders()||"").split(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gn=new ql("@firebase/firestore");function Ah(){return Gn.logLevel}function V(t,...e){if(Gn.logLevel<=ee.DEBUG){const n=e.map(Tc);Gn.debug(`Firestore (${Ws}): ${t}`,...n)}}function Qn(t,...e){if(Gn.logLevel<=ee.ERROR){const n=e.map(Tc);Gn.error(`Firestore (${Ws}): ${t}`,...n)}}function co(t,...e){if(Gn.logLevel<=ee.WARN){const n=e.map(Tc);Gn.warn(`Firestore (${Ws}): ${t}`,...n)}}function Tc(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(t="Unexpected state"){const e=`FIRESTORE (${Ws}) INTERNAL ASSERTION FAILED: `+t;throw Qn(e),new Error(e)}function Me(t,e){t||J()}function me(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xp{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Ib{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(ze.UNAUTHENTICATED))}shutdown(){}}class Tb{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class Ab{constructor(e){this.t=e,this.currentUser=ze.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let s=this.i;const i=l=>this.i!==s?(s=this.i,n(l)):Promise.resolve();let r=new jn;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new jn,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const l=r;e.enqueueRetryable(async()=>{await l.promise,await i(this.currentUser)})},a=l=>{V("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(V("FirebaseAuthCredentialsProvider","Auth not yet detected"),r.resolve(),r=new jn)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(s=>this.i!==e?(V("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(Me(typeof s.accessToken=="string"),new Xp(s.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Me(e===null||typeof e=="string"),new ze(e)}}class Sb{constructor(e,n,s){this.h=e,this.l=n,this.m=s,this.type="FirstParty",this.user=ze.FIRST_PARTY,this.g=new Map}p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const e=this.p();return e&&this.g.set("Authorization",e),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}}class Cb{constructor(e,n,s){this.h=e,this.l=n,this.m=s}getToken(){return Promise.resolve(new Sb(this.h,this.l,this.m))}start(e,n){e.enqueueRetryable(()=>n(ze.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class kb{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Rb{constructor(e){this.I=e,this.forceRefresh=!1,this.appCheck=null,this.T=null}start(e,n){const s=r=>{r.error!=null&&V("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${r.error.message}`);const o=r.token!==this.T;return this.T=r.token,V("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(r.token):Promise.resolve()};this.o=r=>{e.enqueueRetryable(()=>s(r))};const i=r=>{V("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=r,this.appCheck.addTokenListener(this.o)};this.I.onInit(r=>i(r)),setTimeout(()=>{if(!this.appCheck){const r=this.I.getImmediate({optional:!0});r?i(r):V("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Me(typeof n.token=="string"),this.T=n.token,new kb(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sc(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function sg(t){const e=t.mapValue.fields.__previous_value__;return Sc(e)?sg(e):e}function ho(t){const e=Yn(t.mapValue.fields.__local_write_time__.timestampValue);return new Oe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ir={mapValue:{fields:{__type__:{stringValue:"__max__"}}}};function Ns(t){return"nullValue"in t?0:"booleanValue"in t?1:"integerValue"in t||"doubleValue"in t?2:"timestampValue"in t?3:"stringValue"in t?5:"bytesValue"in t?6:"referenceValue"in t?7:"geoPointValue"in t?8:"arrayValue"in t?9:"mapValue"in t?Sc(t)?4:Vb(t)?9007199254740991:10:J()}function qt(t,e){if(t===e)return!0;const n=Ns(t);if(n!==Ns(e))return!1;switch(n){case 0:case 9007199254740991:return!0;case 1:return t.booleanValue===e.booleanValue;case 4:return ho(t).isEqual(ho(e));case 3:return function(s,i){if(typeof s.timestampValue=="string"&&typeof i.timestampValue=="string"&&s.timestampValue.length===i.timestampValue.length)return s.timestampValue===i.timestampValue;const r=Yn(s.timestampValue),o=Yn(i.timestampValue);return r.seconds===o.seconds&&r.nanos===o.nanos}(t,e);case 5:return t.stringValue===e.stringValue;case 6:return function(s,i){return Ui(s.bytesValue).isEqual(Ui(i.bytesValue))}(t,e);case 7:return t.referenceValue===e.referenceValue;case 8:return function(s,i){return Ue(s.geoPointValue.latitude)===Ue(i.geoPointValue.latitude)&&Ue(s.geoPointValue.longitude)===Ue(i.geoPointValue.longitude)}(t,e);case 2:return function(s,i){if("integerValue"in s&&"integerValue"in i)return Ue(s.integerValue)===Ue(i.integerValue);if("doubleValue"in s&&"doubleValue"in i){const r=Ue(s.doubleValue),o=Ue(i.doubleValue);return r===o?uo(r)===uo(o):isNaN(r)&&isNaN(o)}return!1}(t,e);case 9:return Ds(t.arrayValue.values||[],e.arrayValue.values||[],qt);case 10:return function(s,i){const r=s.mapValue.fields||{},o=i.mapValue.fields||{};if(Sh(r)!==Sh(o))return!1;for(const a in r)if(r.hasOwnProperty(a)&&(o[a]===void 0||!qt(r[a],o[a])))return!1;return!0}(t,e);default:return J()}}function Fi(t,e){return(t.values||[]).find(n=>qt(n,e))!==void 0}function Ms(t,e){if(t===e)return 0;const n=Ns(t),s=Ns(e);if(n!==s)return he(n,s);switch(n){case 0:case 9007199254740991:return 0;case 1:return he(t.booleanValue,e.booleanValue);case 2:return function(i,r){const o=Ue(i.integerValue||i.doubleValue),a=Ue(r.integerValue||r.doubleValue);return o<a?-1:o>a?1:o===a?0:isNaN(o)?isNaN(a)?0:-1:1}(t,e);case 3:return kh(t.timestampValue,e.timestampValue);case 4:return kh(ho(t),ho(e));case 5:return he(t.stringValue,e.stringValue);case 6:return function(i,r){const o=Ui(i),a=Ui(r);return o.compareTo(a)}(t.bytesValue,e.bytesValue);case 7:return function(i,r){const o=i.split("/"),a=r.split("/");for(let l=0;l<o.length&&l<a.length;l++){const c=he(o[l],a[l]);if(c!==0)return c}return he(o.length,a.length)}(t.referenceValue,e.referenceValue);case 8:return function(i,r){const o=he(Ue(i.latitude),Ue(r.latitude));return o!==0?o:he(Ue(i.longitude),Ue(r.longitude))}(t.geoPointValue,e.geoPointValue);case 9:return function(i,r){const o=i.values||[],a=r.values||[];for(let l=0;l<o.length&&l<a.length;++l){const c=Ms(o[l],a[l]);if(c)return c}return he(o.length,a.length)}(t.arrayValue,e.arrayValue);case 10:return function(i,r){if(i===Ir.mapValue&&r===Ir.mapValue)return 0;if(i===Ir.mapValue)return 1;if(r===Ir.mapValue)return-1;const o=i.fields||{},a=Object.keys(o),l=r.fields||{},c=Object.keys(l);a.sort(),c.sort();for(let u=0;u<a.length&&u<c.length;++u){const h=he(a[u],c[u]);if(h!==0)return h;const g=Ms(o[a[u]],l[c[u]]);if(g!==0)return g}return he(a.length,c.length)}(t.mapValue,e.mapValue);default:throw J()}}function kh(t,e){if(typeof t=="string"&&typeof e=="string"&&t.length===e.length)return he(t,e);const n=Yn(t),s=Yn(e),i=he(n.seconds,s.seconds);return i!==0?i:he(n.nanos,s.nanos)}function xs(t){return yl(t)}function yl(t){return"nullValue"in t?"null":"booleanValue"in t?""+t.booleanValue:"integerValue"in t?""+t.integerValue:"doubleValue"in t?""+t.doubleValue:"timestampValue"in t?function(s){const i=Yn(s);return`time(${i.seconds},${i.nanos})`}(t.timestampValue):"stringValue"in t?t.stringValue:"bytesValue"in t?Ui(t.bytesValue).toBase64():"referenceValue"in t?(n=t.referenceValue,Q.fromName(n).toString()):"geoPointValue"in t?`geo(${(e=t.geoPointValue).latitude},${e.longitude})`:"arrayValue"in t?function(s){let i="[",r=!0;for(const o of s.values||[])r?r=!1:i+=",",i+=yl(o);return i+"]"}(t.arrayValue):"mapValue"in t?function(s){const i=Object.keys(s.fields||{}).sort();let r="{",o=!0;for(const a of i)o?o=!1:r+=",",r+=`${a}:${yl(s.fields[a])}`;return r+"}"}(t.mapValue):J();var e,n}function vl(t){return!!t&&"integerValue"in t}function Cc(t){return!!t&&"arrayValue"in t}function Ur(t){return!!t&&"mapValue"in t}function fi(t){if(t.geoPointValue)return{geoPointValue:Object.assign({},t.geoPointValue)};if(t.timestampValue&&typeof t.timestampValue=="object")return{timestampValue:Object.assign({},t.timestampValue)};if(t.mapValue){const e={mapValue:{fields:{}}};return rr(t.mapValue.fields,(n,s)=>e.mapValue.fields[n]=fi(s)),e}if(t.arrayValue){const e={arrayValue:{values:[]}};for(let n=0;n<(t.arrayValue.values||[]).length;++n)e.arrayValue.values[n]=fi(t.arrayValue.values[n]);return e}return Object.assign({},t)}function Vb(t){return(((t.mapValue||{}).fields||{}).__type__||{}).stringValue==="__max__"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pi{constructor(e,n="asc"){this.field=e,this.dir=n}}function jb(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jb{constructor(e,n=null,s=[],i=[],r=null,o=null,a=null){this.path=e,this.collectionGroup=n,this.orderBy=s,this.filters=i,this.limit=r,this.startAt=o,this.endAt=a,this.dt=null}}function Oh(t,e=null,n=[],s=[],i=null,r=null,o=null){return new Jb(t,e,n,s,i,r,o)}function kc(t){const e=me(t);if(e.dt===null){let n=e.path.canonicalString();e.collectionGroup!==null&&(n+="|cg:"+e.collectionGroup),n+="|f:",n+=e.filters.map(s=>_l(s)).join(","),n+="|ob:",n+=e.orderBy.map(s=>function(i){return i.field.canonicalString()+i.dir}(s)).join(","),Ac(e.limit)||(n+="|l:",n+=e.limit),e.startAt&&(n+="|lb:",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(s=>xs(s)).join(",")),e.endAt&&(n+="|ub:",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(s=>xs(s)).join(",")),e.dt=n}return e.dt}function Rc(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!jb(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!lg(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!Ph(t.startAt,e.startAt)&&Ph(t.endAt,e.endAt)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rI=new lt(Q.comparator);function go(){return rI}const fg=new lt(Q.comparator);function Tr(...t){let e=fg;for(const n of t)e=e.insert(n.key,n);return e}function pg(t){let e=fg;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function Un(){return gi()}function gg(){return gi()}function gi(){return new Gs(t=>t.toString(),(t,e)=>t.isEqual(e))}const oI=new lt(Q.comparator),aI=new nt(Q.comparator);function Ke(...t){let e=aI;for(const n of t)e=e.add(n);return e}const lI=new nt(he);function cI(){return lI}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FI{constructor(){this.changes=new Gs(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,_t.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const s=this.changes.get(n);return s!==void 0?A.resolve(s):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VI{constructor(e){this.serializer=e,this.cs=new Map,this.hs=new Map}getBundleMetadata(e,n){return A.resolve(this.cs.get(n))}saveBundleMetadata(e,n){var s;return this.cs.set(n.id,{id:(s=n).id,version:s.version,createTime:bs(s.createTime)}),A.resolve()}getNamedQuery(e,n){return A.resolve(this.hs.get(n))}saveNamedQuery(e,n){return this.hs.set(n.name,function(s){return{name:s.name,query:xI(s.bundledQuery),readTime:bs(s.readTime)}}(n)),A.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dc{constructor(){this.fs=new nt(Re.ds),this.ws=new nt(Re._s)}isEmpty(){return this.fs.isEmpty()}addReference(e,n){const s=new Re(e,n);this.fs=this.fs.add(s),this.ws=this.ws.add(s)}gs(e,n){e.forEach(s=>this.addReference(s,n))}removeReference(e,n){this.ys(new Re(e,n))}ps(e,n){e.forEach(s=>this.removeReference(s,n))}Is(e){const n=new Q(new be([])),s=new Re(n,e),i=new Re(n,e+1),r=[];return this.ws.forEachInRange([s,i],o=>{this.ys(o),r.push(o.key)}),r}Ts(){this.fs.forEach(e=>this.ys(e))}ys(e){this.fs=this.fs.delete(e),this.ws=this.ws.delete(e)}Es(e){const n=new Q(new be([])),s=new Re(n,e),i=new Re(n,e+1);let r=Ke();return this.ws.forEachInRange([s,i],o=>{r=r.add(o.key)}),r}containsKey(e){const n=new Re(e,0),s=this.fs.firstAfterOrEqual(n);return s!==null&&e.isEqual(s.key)}}class Re{constructor(e,n){this.key=e,this.As=n}static ds(e,n){return Q.comparator(e.key,n.key)||he(e.As,n.As)}static _s(e,n){return he(e.As,n.As)||Q.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WI{constructor(e,n){this.$s={},this.overlays={},this.Os=new tg(0),this.Fs=!1,this.Fs=!0,this.referenceDelegate=e(this),this.Bs=new KI(this),this.indexManager=new LI,this.remoteDocumentCache=function(s){return new qI(s)}(s=>this.referenceDelegate.Ls(s)),this.serializer=new MI(n),this.qs=new VI(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Fs=!1,Promise.resolve()}get started(){return this.Fs}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let n=this.overlays[e.toKey()];return n||(n=new jI,this.overlays[e.toKey()]=n),n}getMutationQueue(e,n){let s=this.$s[e.toKey()];return s||(s=new HI(n,this.referenceDelegate),this.$s[e.toKey()]=s),s}getTargetCache(){return this.Bs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.qs}runTransaction(e,n,s){V("MemoryPersistence","Starting transaction:",e);const i=new GI(this.Os.next());return this.referenceDelegate.Us(),s(i).next(r=>this.referenceDelegate.Ks(i).next(()=>r)).toPromise().then(r=>(i.raiseOnCommittedEvent(),r))}Gs(e,n){return A.or(Object.values(this.$s).map(s=>()=>s.containsKey(e,n)))}}class GI extends Lb{constructor(e){super(),this.currentSequenceNumber=e}}class Nc{constructor(e){this.persistence=e,this.Qs=new Dc,this.js=null}static zs(e){return new Nc(e)}get Ws(){if(this.js)return this.js;throw J()}addReference(e,n,s){return this.Qs.addReference(s,n),this.Ws.delete(s.toString()),A.resolve()}removeReference(e,n,s){return this.Qs.removeReference(s,n),this.Ws.add(s.toString()),A.resolve()}markPotentiallyOrphaned(e,n){return this.Ws.add(n.toString()),A.resolve()}removeTarget(e,n){this.Qs.Is(n.targetId).forEach(i=>this.Ws.add(i.toString()));const s=this.persistence.getTargetCache();return s.getMatchingKeysForTargetId(e,n.targetId).next(i=>{i.forEach(r=>this.Ws.add(r.toString()))}).next(()=>s.removeTargetData(e,n))}Us(){this.js=new Set}Ks(e){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return A.forEach(this.Ws,s=>{const i=Q.fromPath(s);return this.Hs(e,i).next(r=>{r||n.removeEntry(i,_e.min())})}).next(()=>(this.js=null,n.apply(e)))}updateLimboDocument(e,n){return this.Hs(e,n).next(s=>{s?this.Ws.delete(n.toString()):this.Ws.add(n.toString())})}Ls(e){return 0}Hs(e,n){return A.or([()=>A.resolve(this.Qs.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(e,n),()=>this.persistence.Gs(e,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yg(t,e,n){let s;return s=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,s}function qT(t,e,n){t=vo(t,Vt);const s=vo(t.firestore,Fc),i=Yg(t.converter,e,n);return Jg(s,[zg(qg(s),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Bt.none())])}function zT(t,e){const n=vo(t.firestore,Fc),s=Fg(t),i=Yg(t.converter,e);return Jg(n,[zg(qg(t.firestore),"addDoc",s._key,i,t.converter!==null,{}).toMutation(s._key,Bt.exists(!1))]).then(()=>s)}function Jg(t,e){return function(n,s){const i=new jn;return n.asyncQueue.enqueueAndForget(async()=>ET(await OT(n),s,i)),i.promise}(LT(t),e)}(function(t,e=!0){(function(n){Ws=n})(Vs),Rs(new qn("firestore",(n,{instanceIdentifier:s,options:i})=>{const r=n.getProvider("app").getImmediate(),o=new Fc(new Ab(n.getProvider("auth-internal")),new Rb(n.getProvider("app-check-internal")),function(a,l){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new H(T.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new fo(a.options.projectId,l)}(r,s),r);return i=Object.assign({useFetchStreams:e},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),_n(Th,"3.13.0",t),_n(Th,"3.13.0","esm2017")})();var KT="firebase",WT="9.23.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */_n(KT,WT,"app");const GT={apiKey:"AIzaSyDSFUoWNmdlw4OyCK89i5DCX1MvSkZyo6E",authDomain:"blood-bank-vue.firebaseapp.com",databaseURL:"https://blood-bank-vue-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"blood-bank-vue",storageBucket:"blood-bank-vue.appspot.com",messagingSenderId:"1005473572226",appId:"1:1005473572226:web:2c6519c0684db8307e1b9b"},Xg=ff(GT);$c(Xg);const Is=g1(Xg);const st=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},QT={emits:["loggedIn"],data(){return{username:"",email:"",password:"",phone:"",gender:"",notification:""}},methods:{signUp(){const t=/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/;if(this.password.length<=7||!t.test(this.password)){this.notification="The password must be more than 7 characters long and at least one punctuation such as @#$%.";return}Jw(Is,this.email,this.password).then(e=>{eE(e.user,{displayName:this.username}).then(()=>{const n={displayName:this.username,email:this.email,phone:this.phone,gender:this.gender},s=$c();qT(Fg(s,"Sign Up Details",e.user.uid),n)}).then(()=>{this.$emit("loggedIn")})}).catch(e=>{switch(e.code){case"auth/email-already-in-use":this.notification="This email is already registered";break;case"auth/invalid-email":this.notification="This email address is not valid.";break;case"auth/operation-not-allowed":this.notification="Email/Password accounts are not enabled";break;case"auth/weak-password":this.notification="The password is too weak,please include at least punctuation.";break;default:console.log(e.message)}})}}},YT={class:"signupform"},JT=f("br",null,null,-1),XT=f("br",null,null,-1),ZT=f("br",null,null,-1),eA=f("br",null,null,-1),tA=f("label",{for:"male",style:{"font-size":"14px"}}," Male",-1),nA=f("label",{for:"female",style:{"font-size":"14px"}}," Female",-1),sA=f("button",{class:"signupbut",style:{"font-weight":"bold"}},"Sign Up",-1),iA={key:0,class:"notification"};function rA(t,e,n,s,i,r){return te(),ne(Se,null,[f("form",{onSubmit:e[6]||(e[6]=Vl((...o)=>r.signUp&&r.signUp(...o),["prevent"])),class:"signup"},[f("div",YT,[fe(f("input",{type:"text",class:"input",placeholder:"Username",required:"","onUpdate:modelValue":e[0]||(e[0]=o=>i.username=o),style:{"border-radius":"10px"}},null,512),[[ve,i.username]]),JT,fe(f("input",{type:"email",class:"input",placeholder:"Email",required:"","onUpdate:modelValue":e[1]||(e[1]=o=>i.email=o),style:{"border-radius":"10px"}},null,512),[[ve,i.email]]),XT,fe(f("input",{type:"password",class:"input",placeholder:"Password",required:"","onUpdate:modelValue":e[2]||(e[2]=o=>i.password=o),style:{"border-radius":"10px"}},null,512),[[ve,i.password]]),ZT,fe(f("input",{type:"tel",class:"input",placeholder:"Phone Number",required:"","onUpdate:modelValue":e[3]||(e[3]=o=>i.phone=o),style:{"border-radius":"10px"}},null,512),[[ve,i.phone]]),eA,f("div",null,[fe(f("input",{type:"radio",id:"male",value:"Male","onUpdate:modelValue":e[4]||(e[4]=o=>i.gender=o)},null,512),[[Eu,i.gender]]),tA,Be("    "),fe(f("input",{type:"radio",id:"female",value:"Female","onUpdate:modelValue":e[5]||(e[5]=o=>i.gender=o)},null,512),[[Eu,i.gender]]),nA]),sA])],32),i.notification?(te(),ne("div",iA,We(i.notification),1)):Po("",!0)],64)}const Zg=st(QT,[["render",rA]]),oA="/vitevue-project/assets/appicon-93e9f5f4.png";const aA={data(){return{email:"",password:"",notification:"",imagePaths:{appicon:oA}}},methods:{login(){Xw(Is,this.email,this.password).then(()=>{this.$emit("loggedIn")}).catch(t=>{switch(t.code){case"auth/user-not-found":this.notification="This email is still not yet register. Please register before login";break;case"auth/wrong-password":this.notification="The email or password is incorrect. Please try again.";break;default:console.error("Login error:",t)}})}}},lA=["src"],cA=f("br",null,null,-1),uA=f("br",null,null,-1),hA=f("br",null,null,-1),dA=f("br",null,null,-1),fA=f("button",{class:"loginbut",style:{"font-weight":"bold"}},"Log in",-1),pA={key:0,class:"notification"};function gA(t,e,n,s,i,r){return te(),ne(Se,null,[f("form",{onSubmit:e[2]||(e[2]=Vl((...o)=>r.login&&r.login(...o),["prevent"])),class:"login"},[f("img",{src:i.imagePaths.appicon,alt:"community logo",width:"50"},null,8,lA),cA,uA,fe(f("input",{type:"email",class:"input",placeholder:"What's your email?",required:"","onUpdate:modelValue":e[0]||(e[0]=o=>i.email=o),style:{"border-radius":"10px"}},null,512),[[ve,i.email]]),hA,fe(f("input",{type:"password",class:"input",placeholder:"Password",required:"","onUpdate:modelValue":e[1]||(e[1]=o=>i.password=o),style:{"border-radius":"10px"}},null,512),[[ve,i.password]]),dA,fA],32),i.notification?(te(),ne("div",pA,We(i.notification),1)):Po("",!0)],64)}const em=st(aA,[["render",gA]]);const mA={name:"Discover"},yA={class:"discover"},vA=Xn('<h1>Hightlights</h1><div class="section"><a href="https://www.freemalaysiatoday.com/category/leisure/2021/08/10/a-guide-to-donating-blood-for-the-first-time/" target="_blank"><img src="https://media.freemalaysiatoday.com/wp-content/uploads/2021/06/03-BLOOD-DONATION-.jpg" width="100%" height="100%"></a><h2>A guide to donating blood for the first time</h2><p><a href="https://www.freemalaysiatoday.com/category/leisure/2021/08/10/a-guide-to-donating-blood-for-the-first-time/" target="_blank"> PETALING JAYA: Drawing blood may seem daunting to first-time donors, but rest assured it is a simple, quick and safe process that is capable of saving lives. While blood banks have continued to operate as an essential service in the past two years, National Blood Centre director Dr Noryati Abu Amin said there were additional safety measures in place to minimise the risk of Covid-19. <p><span class="click">(Click to read more)</span></p></a></p></div><div class="section"><a href="https://www.thestar.com.my/news/nation/2023/06/18/gift-of-life-more-than-700000-bags-of-blood-donated-in-2022-says-health-dg" target="_blank"><img src="https://apicms.thestar.com.my/uploads/images/2023/06/18/2131729.jpg" width="100%" height="100%"></a><h2>Gift of life: More than 700,000 bags of blood donated in 2022, says Health DG</h2><p><a href="https://www.thestar.com.my/news/nation/2023/06/18/gift-of-life-more-than-700000-bags-of-blood-donated-in-2022-says-health-dg" target="_blank"> JOHOR BARU: More than 700,000 bags of blood were donated to blood banks nationwide last year, says Datuk Dr Muhammad Radzi Abu Hassan. The Health director-general said this was an increase of about 13.7% from previous years. <p><span class="click">(Click to read more)</span></p></a></p></div><div class="section"><a href="https://www.nst.com.my/news/nation/2022/12/859167/retired-teacher-70-makes-final-blood-donation-356th-time" target="_blank"><img src="https://assets.nst.com.my/images/articles/315890948_510411854460227_6907366706555040351_n_1670548888.jpg" width="100%" height="100%"></a><h2>Retired teacher, 70, makes final blood donation for 356th time</h2><p><a href="https://www.nst.com.my/news/nation/2022/12/859167/retired-teacher-70-makes-final-blood-donation-356th-time" target="_blank"> KUALA LUMPUR: Retired teacher Lum Kien Seng went to donate his blood for the the 356th time last week, and the final one for he can no longer do so due to his age. Lum, now aged 70, said he felt proud to be able to help save many lives through his effort for the past 34 years. <p><span class="click">(Click to read more)</span></p></a></p></div><div class="section"><a href="https://www.nst.com.my/news/nation/2023/06/921576/health-ministry-sets-blood-donation-rate-35-40-donors-1000-population" target="_blank"><img src="https://assets.nst.com.my/images/articles/zonblood2_1687096260.jpg" width="100%" height="100%"></a><h2>Health Ministry sets blood donation rate of 35 to 40 donors per 1,000 population by 2030</h2><p><a href="https://www.nst.com.my/news/nation/2023/06/921576/health-ministry-sets-blood-donation-rate-35-40-donors-1000-population" target="_blank"> JOHOR BARU: The Health Ministry through its Transfusion Medicine Services is targeting a national blood donation rate of 35 to 40 donors per 1,000 population by the year 2030. Health director-general Datuk Dr Muhammad Radzi Abu Hassan said the target was to meet patient care needs in line with the annual population growth rate in Malaysia. <p><span class="click">(Click to read more)</span></p></a></p></div><div class="section"><a href="https://www.thestar.com.my/metro/metro-news/2023/04/06/on-mission-to-boost-blood-donor-numbers" target="_blank"><img src="https://apicms.thestar.com.my/uploads/images/2023/04/06/2011293.jpg" width="100%" height="100%"></a><h2>On mission to boost blood donor numbers</h2><p><a href="https://www.thestar.com.my/metro/metro-news/2023/04/06/on-mission-to-boost-blood-donor-numbers" target="_blank"> Petaling Jaya City Council (MBPJ) and the National Blood Centre (PDN) launched their first blood donation campaign with the theme “Donating blood is a noble practice” at the city council’s headquarters. <p><span class="click">(Click to read more)</span></p></a></p></div>',6),_A=[vA];function wA(t,e,n,s,i,r){return te(),ne("div",yA,_A)}const tm=st(mA,[["render",wA]]),EA="/vitevue-project/assets/edu-bloodtype-f9f6fcd8.jpg",bA="/vitevue-project/assets/edu-eligibility-56e0be29.jpg",IA="/vitevue-project/assets/edu-perks-72313c18.jpg";const TA={methods:{goToBloodType(){this.$router.push("/education/bloodtype")},goToEligibility(){this.$router.push("/education/eligibility")},goToPerks(){this.$router.push("/education/perks")},goToFAQ(){this.$router.push("/education/faq")}},data(){return{imagePaths:{bloodType:EA,eligibility:bA,perks:IA}}}},AA={class:"education"},SA=f("h2",null,"WHY BLOOD?",-1),CA={class:"edu-div"},kA=["src"],RA={class:"edu-div-content"},PA=f("p",null,[f("b",null,"WHAT BLOOD TYPES MATCH?"),f("br"),Be(" There are four main blood types: A, B, AB and O. Combinations of proteins and sugars, called antigens, on the surface of red blood cells are what makes the blood type either compatible or incompatible with other blood types.")],-1),OA={class:"edu-div"},DA=["src"],NA={class:"edu-div-content"},MA=f("p",null,[f("b",null,"AM I ELIGIBLE TO DONATE?"),f("br"),Be(" Curious about your eligibility to donate blood? Find out if you meet the criteria to make a life-saving contribution.")],-1),xA={class:"edu-div"},LA=["src"],UA={class:"edu-div-content"},FA=f("p",null,[f("b",null,"MALAYSIAN BLOOD DONOR PRIVILEGES"),f("br"),Be(" Donating blood just once can save up to 3 lives but did you know regular blood donors get special medical privileges in Malaysia? Click 'Learn More' to explore the health benefits and medical privileges given to blood donors in Malaysia.")],-1),$A={class:"edu-div"},BA={class:"edu-div-content"},VA=f("p",null,[f("b",null,"FREQUENTLY ASKED QUESTIONS"),f("br"),Be(" Answers to our most frequently asked questions are just one click away.")],-1);function jA(t,e,n,s,i,r){return te(),ne("div",AA,[SA,f("div",CA,[f("img",{src:i.imagePaths.bloodType,alt:"Blood Type Image"},null,8,kA),f("div",RA,[PA,f("div",null,[f("button",{onClick:e[0]||(e[0]=(...o)=>r.goToBloodType&&r.goToBloodType(...o))},"Learn More")])])]),f("div",OA,[f("img",{src:i.imagePaths.eligibility,alt:"Blood Donation Image"},null,8,DA),f("div",NA,[MA,f("div",null,[f("button",{onClick:e[1]||(e[1]=(...o)=>r.goToEligibility&&r.goToEligibility(...o))},"Learn More")])])]),f("div",xA,[f("img",{src:i.imagePaths.perks,alt:"Body Checkup Image"},null,8,LA),f("div",UA,[FA,f("div",null,[f("button",{onClick:e[2]||(e[2]=(...o)=>r.goToPerks&&r.goToPerks(...o))},"Learn More")])])]),f("div",$A,[f("div",BA,[VA,f("div",null,[f("button",{onClick:e[3]||(e[3]=(...o)=>r.goToFAQ&&r.goToFAQ(...o))},"Go to FAQ")])])])])}const nm=st(TA,[["render",jA]]);const HA={name:"Map",setup(){const t=md(null),e=[{lat:3.06484594571016,lng:101.61692563544386},{lat:2.970786212821712,lng:101.7137324675521},{lat:3.1856896992217107,lng:101.63501319960115},{lat:3.05032462984594,lng:101.6709347088716},{lat:3.072168678003126,lng:101.60651263901032}],n=()=>{const i={lat:37.7749,lng:-122.4194};navigator.geolocation?navigator.geolocation.getCurrentPosition(r=>{i.lat=r.coords.latitude,i.lng=r.coords.longitude,s(i)},()=>{s(i),console.error("Error getting current location")}):(s(i),console.error("Geolocation is not supported by this browser"))},s=i=>{t.value=new google.maps.Map(document.getElementById("map"),{center:i,zoom:15}),e.forEach(r=>{new google.maps.Marker({position:r,map:t.value})})};return Od(()=>{const i=document.createElement("script");i.src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWddpINsAJJplhhkUxmc_qvenPkKVaQKY&callback=initMap",i.defer=!0,i.async=!0,window.initMap=n,document.head.appendChild(i)}),{map:t}}},qA=f("div",{id:"map"},null,-1),zA=[qA];function KA(t,e,n,s,i,r){return te(),ne("div",null,zA)}const WA=st(HA,[["render",KA]]);const GA={data(){return{searchQuery:"",searchDate:"",campaigns:[{id:1,name:"Blood Donation Week at Taylor's University",location:"1, Jln Taylors, 47500 Subang Jaya, Selangor",startDate:"2023-08-17",endDate:"2023-08-25",description:"PUSAT DARAH NEGARA"},{id:2,name:"Blood Donation Week at IOI City Mall",location:"City Sepang, 2AT-3A, Level 3, IOI City Mall, Lbh IRC, Ioi Resort, 62502 Putrajaya",startDate:"2023-07-22",endDate:"2023-07-29",description:"PUSAT KOMUNITI ST JOHN AMBULANS MALAYSIA"}]}},computed:{filteredCampaigns(){return this.campaigns.filter(t=>{const e=t.location.toLowerCase().includes(this.searchQuery.toLowerCase()),n=!this.searchDate||this.searchDate>=t.startDate&&this.searchDate<=t.endDate;return e&&n})}}},QA={class:"camptest"},YA=f("label",{style:{"font-size":"small"}},"Filter by date: ",-1),JA={class:"camporganizer"},XA=f("span",{class:"data"},"Address",-1),ZA=f("br",null,null,-1),eS=f("span",{class:"data"},"Date",-1),tS=f("br",null,null,-1),nS=f("div",{style:{width:"100%","text-align":"right","margin-bottom":"3px"}},[f("a",{class:"register",href:"https://forms.gle/znWG6ZWZZXfAoLXN6",target:"_blank"},"Register")],-1);function sS(t,e,n,s,i,r){return te(),ne("div",QA,[fe(f("input",{class:"search",type:"text","onUpdate:modelValue":e[0]||(e[0]=o=>i.searchQuery=o),placeholder:"Search by location"},null,512),[[ve,i.searchQuery]]),YA,fe(f("input",{class:"date",type:"date","onUpdate:modelValue":e[1]||(e[1]=o=>i.searchDate=o)},null,512),[[ve,i.searchDate]]),f("ul",null,[(te(!0),ne(Se,null,Co(r.filteredCampaigns,o=>(te(),ne("li",{key:o.id},[f("h3",null,We(o.name),1),f("p",JA,"by "+We(o.description),1),f("p",null,[XA,ZA,Be(" "+We(o.location),1)]),f("p",null,[eS,tS,Be(" "+We(o.startDate)+" to "+We(o.endDate),1)]),nS]))),128))])])}const iS=st(GA,[["render",sS]]);const rS={name:"Campaign",components:{MapTest:WA,CampTest:iS}},oS={class:"campaign"},aS=f("p",{style:{"font-family":"Times New Roman","font-size":"20px"}},"Blood donation campaigns",-1),lS=f("br",null,null,-1),cS=f("div",{class:"container"},[f("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.1117610863434!2d101.61423517467577!3d3.0647849969109493!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4c5f9450eaf9%3A0xe4c38bd5f7d440b1!2sTaylor's%20University%20Lakeside%20Campus!5e0!3m2!1sen!2smy!4v1688204067801!5m2!1sen!2smy",width:"100%",height:"450",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})],-1),uS=Xn('<div class="section"><p>Blood Donation Week at Taylor&#39;s University<br><span class="info">by PUSAT DARAH NEGARA</span></p><details><summary>Show Campaign Dates</summary><ul><li><span class="day">Aug 17, 2023 (Thu)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 18, 2023 (Fri)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 19, 2023 (Sat)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 20, 2023 (Sun)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 21, 2023 (Mon)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 22, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 23, 2023 (Wed)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 24, 2023 (Thu)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 25, 2023 (Fri)</span><span>10:00 AM - 05:00 PM</span></li></ul></details><a href="https://forms.gle/znWG6ZWZZXfAoLXN6" target="_blank">Click here to register</a></div>',1),hS=f("div",{class:"container"},[f("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.456807611912!2d101.7110931746754!3d2.970662997005473!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cdca0c21c76841%3A0x2c98384480140180!2sIOI%20City%20Mall!5e0!3m2!1sen!2smy!4v1688204094657!5m2!1sen!2smy",width:"100%",height:"450",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})],-1),dS=Xn('<div class="section"><p> Blood Donation Week at IOI City Mall<br><span class="info">by PUSAT KOMUNITI ST JOHN AMBULANS MALAYSIA</span></p><details><summary>Show Campaign Dates</summary><ul><li><span class="day">July 22, 2023 (Sat)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 23, 2023 (Sun)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 24, 2023 (Mon)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 25, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 26, 2023 (Wed)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 27, 2023 (Thu)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 28, 2023 (Fri)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">July 29, 2023 (Sat)</span><span>10:00 AM - 05:00 PM</span></li></ul></details><a href="https://forms.gle/6DCNrWcpjiiDTVZSA" target="_blank">Click here to register</a></div>',1),fS=f("div",{class:"container"},[f("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7967.308370541806!2d101.62684859001038!3d3.1853200371597294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc48a5d32f5fb7%3A0x1fbfb9bf04283220!2sDesa%20Parkcity%2C%2052200%20Kuala%20Lumpur%2C%20Federal%20Territory%20of%20Kuala%20Lumpur!5e0!3m2!1sen!2smy!4v1688204830497!5m2!1sen!2smy",width:"100%",height:"450",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})],-1),pS=Xn('<div class="section"><p> Blood Donation Hero at Desa ParkCity<br><span class="info">by BULAN SABIT MERAH MALAYSIA CAWANGAN SELANGOR</span></p><details><summary>Show Campaign Dates</summary><ul><li><span class="day">Aug 8, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 9, 2023 (Wed)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 10, 2023 (Thu)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 11, 2023 (Fri)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 12, 2023 (Sat)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 13, 2023 (Sun)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 14, 2023 (Mon)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Aug 15, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li></ul></details><a href="https://forms.gle/rfbBYvxGLepFSGPc7" target="_blank">Click here to register</a></div>',1),gS=f("div",{class:"container"},[f("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.1658017801956!2d101.66609207681692!3d3.050235388998303!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4ae7f2b662d5%3A0x24640a80dedccc95!2sPavilion%20Bukit%20Jalil!5e0!3m2!1sen!2smy!4v1688205098352!5m2!1sen!2smy",width:"100%",height:"450",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})],-1),mS=Xn('<div class="section"><p> Blood Donation Hero 2.0 at Pavillion Bukit Jalil<br><span class="info">by Vedo Wellness Sdn Bhd</span></p><details><summary>Show Campaign Dates</summary><ul><li><span class="day">Sep 5, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 6, 2023 (Wed)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 7, 2023 (Thu)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 8, 2023 (Fri)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 9, 2023 (Sat)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 10, 2023 (Sun)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 11, 2023 (Mon)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 12, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li></ul></details><a href="https://forms.gle/ppf4aaGm453Cx6Gy9" target="_blank">Click here to register</a></div>',1),yS=f("div",{class:"container"},[f("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.08455521837!2d101.60377057467578!3d3.0720836969036194!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4c8776586d9b%3A0x5e19a549d4f26f25!2sSunway%20Pyramid%20Shopping%20Mall!5e0!3m2!1sen!2smy!4v1688205306454!5m2!1sen!2smy",width:"100%",height:"450",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})],-1),vS=Xn('<div class="section"><p> Donate &amp; SaveALive at Sunway Pyramid<br><span class="info">by A-Med Clinic Sg Chua Kajang</span></p><details><summary>Show Campaign Dates</summary><ul><li><span class="day">Sep 15, 2023 (Sat)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 16, 2023 (Sun)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 17, 2023 (Mon)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 18, 2023 (Tue)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 19, 2023 (Wed)</span><span>10:00 AM - 05:00 PM</span></li><li><span class="day">Sep 20, 2023 (Thu)</span><span>10:00 AM - 05:00 PM</span></li></ul></details><a href="https://forms.gle/UnBSFTCa58vzhPCE9" target="_blank">Click here to register</a></div>',1);function _S(t,e,n,s,i,r){const o=ys("CampTest"),a=ys("MapTest");return te(),ne(Se,null,[we(o),f("div",oS,[aS,we(a),lS,cS,uS,hS,dS,fS,pS,gS,mS,yS,vS])],64)}const wS=st(rS,[["render",_S]]);const ES={data(){return{name:"",phone:"",email:"",street:"",city:"",state:"",postalcode:"",message:"",campname:"",info:"",startDate:"",endDate:"",time1:"",time2:"",venue:""}},methods:{async submitForm(){const t={Name:this.name,Phone:this.phone,Email:this.email,Street:this.street,City:this.city,State:this.state,PostalCode:this.postalcode,Message:this.message,CampName:this.campname,Information:this.info,StartDate:this.startDate,EndDate:this.endDate,StartTime:this.time1,EndTime:this.time2,Venue:this.venue};try{const e=$c();await zT(MT(e,"Apply2"),t),this.name="",this.phone="",this.email="",this.street="",this.city="",this.state="",this.postalcode="",this.message="",this.campname="",this.info="",this.startDate="",this.endDate="",this.time1="",this.time2="",this.venue=""}catch(e){console.error("Error writing document: ",e)}}}},bS={class:"organization"},IS=f("h2",null,"Create a Campaign",-1),TS=f("p",{class:"description"}," Fill in the form below to create a new blood donation campaign. Provide detailed information about your campaign and its objectives. This will help users understand the purpose and goals of your campaign. Make sure to fill in all the required fields. ",-1),AS=f("label",{for:"name"},"Hospital Name:",-1),SS=f("label",{for:"phone"},"Phone:",-1),CS=f("label",{for:"email"},"Email:",-1),kS=f("small",null,"example@example.com",-1),RS=f("p",{style:{"font-weight":"bold",margin:"0"}},"Location",-1),PS=f("label",{for:"street"},"Street:",-1),OS=f("label",{for:"city"},"City:",-1),DS=f("label",{for:"state"},"State:",-1),NS=f("label",{for:"postalCode"},"Postal Code:",-1),MS=f("label",{for:"message"},"Message:",-1),xS=f("p",{style:{"font-weight":"bold",margin:"0"}},"Campaign",-1),LS=f("label",{for:"campname"},"Camp Name:",-1),US=f("label",{for:"info"},"Camp Information:",-1),FS=f("label",{for:"startDate"},"Start Date of the Campaign:",-1),$S=f("label",{for:"endDate"},"End Date of the Campaign:",-1),BS=f("label",{for:"time1"},"Time Start:",-1),VS=f("label",{for:"time2"},"Time End:",-1),jS=f("label",{for:"venue"},"Campaign Venue:",-1),HS=f("div",{class:"button"},[f("button",{type:"submit",id:"submit"},"Submit")],-1);function qS(t,e,n,s,i,r){return te(),ne("div",bS,[IS,TS,f("form",{onSubmit:e[15]||(e[15]=Vl((...o)=>r.submitForm&&r.submitForm(...o),["prevent"])),class:"form"},[AS,fe(f("input",{type:"text",id:"name","onUpdate:modelValue":e[0]||(e[0]=o=>i.name=o),required:""},null,512),[[ve,i.name]]),SS,fe(f("input",{type:"tel",id:"phone","onUpdate:modelValue":e[1]||(e[1]=o=>i.phone=o),required:""},null,512),[[ve,i.phone]]),CS,fe(f("input",{type:"email",id:"email","onUpdate:modelValue":e[2]||(e[2]=o=>i.email=o),required:""},null,512),[[ve,i.email]]),kS,RS,PS,fe(f("input",{type:"text",id:"street","onUpdate:modelValue":e[3]||(e[3]=o=>i.street=o),required:""},null,512),[[ve,i.street]]),OS,fe(f("input",{type:"text",id:"city","onUpdate:modelValue":e[4]||(e[4]=o=>i.city=o),required:""},null,512),[[ve,i.city]]),DS,fe(f("input",{type:"text",id:"state","onUpdate:modelValue":e[5]||(e[5]=o=>i.state=o),required:""},null,512),[[ve,i.state]]),NS,fe(f("input",{type:"text",id:"postalCode","onUpdate:modelValue":e[6]||(e[6]=o=>i.postalcode=o),required:""},null,512),[[ve,i.postalcode]]),MS,fe(f("textarea",{id:"message","onUpdate:modelValue":e[7]||(e[7]=o=>i.message=o)},null,512),[[ve,i.message]]),xS,LS,fe(f("input",{type:"text",id:"campname","onUpdate:modelValue":e[8]||(e[8]=o=>i.campname=o),required:""},null,512),[[ve,i.campname]]),US,fe(f("input",{type:"text",id:"info","onUpdate:modelValue":e[9]||(e[9]=o=>i.info=o),required:""},null,512),[[ve,i.info]]),FS,fe(f("input",{type:"date",id:"startDate","onUpdate:modelValue":e[10]||(e[10]=o=>i.startDate=o),required:""},null,512),[[ve,i.startDate]]),$S,fe(f("input",{type:"date",id:"endDate","onUpdate:modelValue":e[11]||(e[11]=o=>i.endDate=o),required:""},null,512),[[ve,i.endDate]]),BS,fe(f("input",{type:"time",id:"time1","onUpdate:modelValue":e[12]||(e[12]=o=>i.time1=o),required:""},null,512),[[ve,i.time1]]),VS,fe(f("input",{type:"time",id:"time2","onUpdate:modelValue":e[13]||(e[13]=o=>i.time2=o),required:""},null,512),[[ve,i.time2]]),jS,fe(f("input",{type:"text",id:"venue","onUpdate:modelValue":e[14]||(e[14]=o=>i.venue=o),required:""},null,512),[[ve,i.venue]]),HS],32)])}const zS=st(ES,[["render",qS]]);const KS={props:{isLoggedIn:{type:Boolean,required:!0}},data(){return{isMenuOpen:!1}},methods:{toggleMenu(){this.isMenuOpen=!this.isMenuOpen},navigate(t){this.$router.push(t),this.isMenuOpen=!1},logOut(){this.$emit("logOut")}},created(){Is.onAuthStateChanged(t=>{this.isLoggedIn=t!==null})}},WS=f("div",{class:"line"},null,-1),GS=f("div",{class:"line"},null,-1),QS=f("div",{class:"line"},null,-1),YS=[WS,GS,QS];function JS(t,e,n,s,i,r){return te(),ne(Se,null,[f("div",{class:"hamburger",onClick:e[0]||(e[0]=(...o)=>r.toggleMenu&&r.toggleMenu(...o))},YS),f("div",{class:Jn(["sidebar",{open:i.isMenuOpen}])},[f("ul",null,[f("li",{onClick:e[1]||(e[1]=o=>r.navigate("/home"))},"Home"),f("li",{onClick:e[2]||(e[2]=o=>r.navigate("/highlight"))},"Highlights"),f("li",{onClick:e[3]||(e[3]=o=>r.navigate("/education"))},"Why Blood?"),f("li",{onClick:e[4]||(e[4]=o=>r.navigate("/campaign"))},"Campaign"),f("li",{onClick:e[5]||(e[5]=o=>r.navigate("/profile"))},"Profile"),n.isLoggedIn?(te(),ne("li",{key:0,onClick:e[6]||(e[6]=(...o)=>r.logOut&&r.logOut(...o))},"Sign Out")):Po("",!0)])],2)],64)}const sm=st(KS,[["render",JS]]);const XS={},ZS=Xn('<div class="community"><div class="transition-text1"><h1 style="font-size:15px;font-weight:bold;background-color:#990000;color:white;border-radius:10px;padding:10px;">Everyone have power, to save a life.</h1></div><div class="transition-text2"><h2 style="font-size:15px;font-weight:bold;">Engage in an interactive experience that empowers you to aid yourself and others every day.</h2></div></div><div class="announce"><div class="transition-text3"><h1 style="font-weight:bold;font-size:15px;"> Over 1 Million of funding for our local bank!</h1></div><div class="transition-text4"><h2 style="font-weight:bold;font-size:15px;">Dear community members,</h2><p>We are thrilled to announce a monumental achievement that would not have been possible without your incredible support. Thanks to your unwavering generosity, we have surpassed a significant milestone – over $1 million in funding for our beloved local blood bank!</p><br><p>Your contributions have directly impacted lives in our community and beyond. With these funds, our blood bank has been able to provide a constant supply of life-saving blood products to those in need, ensuring critical treatments, emergency transfusions, and surgeries can take place.</p><br><p>We want to thank you for your incredible support towards our local blood bank. Your generosity has been instrumental in helping us meet the demand for blood packs in our community.</p><br><p>However, we still need more blood packs to ensure we can adequately serve those in need. We require 20,000 more blood packs to fulfill the ongoing demand.</p><br><p>We kindly request you to consider donating blood or encouraging others to do so. Together, we can ensure our local blood bank remains well-equipped to support our community.</p><br><p>Let&#39;s come together and make a positive impact by reaching our goal</p><br><p>Community Name</p><p>Publised Date: <span style="font-style:italic;">26/06/2022</span></p></div></div>',2),eC=[ZS];function tC(t,e){return te(),ne("div",null,eC)}const nC=st(XS,[["render",tC]]);const sC={components:{Discover:tm,Education:nm,Community:nC},methods:{goToOrganization(){this.$router.push("/home/organization")}}},iC={class:"homecomm"},rC=f("h1",{class:""},"Welcome to the Blood Donation Community",-1),oC=f("p",{class:"description"},[Be(" This app is dedicated to promoting blood donation"),f("br"),Be("and raising awareness about its importance in saving lives. ")],-1),aC=f("p",{class:"join"},[Be(" Together, we can make a difference and help those in need."),f("br"),Be("Join us in the noble cause of donating blood! ")],-1),lC={class:"createcamp"},cC=f("p",{style:{"font-size":"medium","font-weight":"bold"}},"Blood Donation Campaign",-1),uC=f("p",null,"We welcome collaboration with any organization to do blood donation campaign",-1),hC=f("br",null,null,-1);function dC(t,e,n,s,i,r){const o=ys("Community"),a=ys("Discover"),l=ys("Education");return te(),ne("div",iC,[rC,oC,aC,we(o),f("div",lC,[cC,uC,f("button",{onClick:e[0]||(e[0]=(...c)=>r.goToOrganization&&r.goToOrganization(...c))},"Create Camp Now")]),hC,we(a),we(l)])}const fC=st(sC,[["render",dC]]);const pC={key:0},gC={style:{"text-align":"center"}},mC={style:{"text-align":"center"}},yC={key:1},vC=f("div",null,[f("div",{style:{position:"fixed",height:"50px",width:"100%","background-color":"red"}},"   ")],-1),_C={id:"app1"},wC={class:"welcome"},EC={name:"App",components:{SignupForm:Zg,LoginForm:em,HamburgerMenu:sm},data(){return{isLoggedIn:!1,showLogin:!0,displayName:""}},beforeUpdate(){Is.currentUser&&(this.displayName=Is.currentUser.displayName)},methods:{logInOrSignUp(){this.isLoggedIn=!0,this.$router.push("/home")},logOut(){sE(Is).then(()=>{this.isLoggedIn=!1,N0().push("/")})}}},bC=Object.assign(EC,{setup(t){return(e,n)=>{const s=ys("router-view");return e.isLoggedIn?(te(),ne("div",yC,[vC,f("div",_C,[f("h2",wC,"Welcome, "+We(e.displayName),1),we(s),we(sm,{isLoggedIn:e.isLoggedIn,onLogOut:e.logOut},null,8,["isLoggedIn","onLogOut"])])])):(te(),ne("div",pC,[e.showLogin?(te(),ne(Se,{key:0},[we(em,{onLoggedIn:e.logInOrSignUp,class:"login"},null,8,["onLoggedIn"]),f("p",gC,[Be("No account yet? "),f("span",{onClick:n[0]||(n[0]=i=>e.showLogin=!1),style:{"font-weight":"bold","text-decoration":"underline"}},"Sign Up"),Be(" instead.")])],64)):(te(),ne(Se,{key:1},[we(Zg,{onLoggedIn:e.logInOrSignUp,class:"signup"},null,8,["onLoggedIn"]),f("p",mC,[Be("Already registered? "),f("span",{onClick:n[1]||(n[1]=i=>e.showLogin=!0),style:{"font-weight":"bold","text-decoration":"underline"}},"Login"),Be(" instead.")])],64))]))}}}),IC="/vitevue-project/assets/faq-icon-bd5e6b45.png";const TC={data(){return{items:[{id:1,title:"1. What should I do if I need to claim my privilege as a blood donor?",content:"Kindly proceed to the nearest blood bank for verification in order to claim your privilege.",showContent:!1},{id:2,title:"2. Why should I donate blood?",content:"Every day blood is needed to save lives. Blood may be needed for surgery, accident victims or to treat patients with leukemia, cancer, heart disease, liver disease and hemophilia. Your contribution could save a life.",showContent:!1},{id:3,title:"3. Am I eligible to donate blood?",content:"Yes, if you are over 17 years old (age verification required) and weight more than 45kg. In general, taking medication is not an obstacle to donating blood because acceptance and rejection are based on medical reports. If you are taking any medication, please inform before donating blood.",showContent:!1},{id:4,title:"4. Am I healthy enough to donate blood?",content:"You must be healthy enough to donate blood. Your health and safety is very important to us. You will be asked to fill up a blood donation questionnaire where your medical history will be asked. Blood pressure and a drop of blood will be taken for a hemoglobin test. All information provided by you is confidential.",showContent:!1},{id:5,title:"5. How long does it take to donate blood?",content:"The process of donating blood will take between 7-10 minutes, but you are advised to be at the blood collection site for approximately one hour.",showContent:!1},{id:6,title:"6. Does the needle hurt?",content:"You only feel a little pain when the needle is inserted and nothing after.",showContent:!1},{id:7,title:"7. How much blood will be taken?",content:"A total of 450ml, which is less than 1 pint (586ml). Adults usually have about 5 liters (10-12 pints) of blood in the body.",showContent:!1},{id:8,title:"8. How does it feel after donating blood?",content:"Most people feel comfortable after donating blood. You are advised to have a light meal before donating blood.",showContent:!1},{id:9,title:"9. Can I do sports after donating blood?",content:"Yes. Just avoid doing heavy activities for 5 hours after donating blood. Drink plenty of water within 24 hours.",showContent:!1},{id:10,title:"10. How long does it take to replace the donated blood?",content:"Plasma is replaced within 24 hours. You need to drink 4 glasses of water without alcohol and do not do heavy work with your hands for a period of 5 hours. Red blood takes 4-8 weeks to be replaced and you can donate again after that.",showContent:!1},{id:11,title:"11. What will be done to the donated blood?",content:"Your blood will be tested to determine blood group, viral infwhich is used in 22 blood collection centers nationwideections such as syphilis, hepatitis (B & C) and AIDS (HIV). Then, stored for patient use. Blood can also be separated into several blood components and can be used to treat more than one patient.",showContent:!1}],imagePaths:{faqicon:IC}}},methods:{toggleContent(t){this.items.forEach(e=>{e.id===t?e.showContent=!e.showContent:e.showContent=!1})}}},AC={class:"faq"},SC=["src"],CC=f("br",null,null,-1),kC=f("b",null,"Frequently Asked Questions",-1),RC=["onClick"],PC={class:"toggleIcon"},OC={key:0,class:"content-edu"};function DC(t,e,n,s,i,r){return te(),ne("div",AC,[f("img",{src:i.imagePaths.faqicon,alt:"FAQ Icon"},null,8,SC),CC,kC,f("div",null,[(te(!0),ne(Se,null,Co(i.items,o=>(te(),ne("div",{key:o.id,class:"faqborder"},[f("div",{class:Jn(["title",{open:o.showContent}]),onClick:a=>r.toggleContent(o.id)},[Be(We(o.title)+" ",1),f("span",PC,We(o.showContent?"-":"+"),1)],10,RC),o.showContent?(te(),ne("div",OC,We(o.content),1)):Po("",!0)]))),128))])])}const NC=st(TC,[["render",DC]]),MC="/vitevue-project/assets/bt-icon-bc98eb4f.png";const xC={data(){return{tableData:[{column1:"A+",column2:"A+, AB+",column3:"A+, A-, O+, O-"},{column1:"O+",column2:"O+, A+, B+, AB+",column3:"O+, O-"},{column1:"B+",column2:"B+, AB+",column3:"B+, B-, O+, O-"},{column1:"AB+",column2:"AB+",column3:"ALL BLOOD TYPES"},{column1:"A-",column2:"A+, A-, AB+, AB-",column3:"A-, O-"},{column1:"O-",column2:"ALL BLOOD TYPES",column3:"O-"},{column1:"B-",column2:"B+, B-, AB+, AB-",column3:"B-, O-"},{column1:"AB-",column2:"AB+, AB-",column3:"AB-, A-, B-, O-"}],imagePaths:{bticon:MC}}}},LC={class:"bloodtype-table"},UC=["src"],FC=f("br",null,null,-1),$C=f("b",null,"Matching Blood Types",-1),BC=f("p",null,"A blood type is a classification of blood based on the presence or absence of antigens on the surface of red blood cells. Human blood is divided into one of four main blood types: A, B, AB, and O, and is further divided into Rh+ or Rh-.",-1),VC={class:"table-border"},jC=f("thead",null,[f("tr",null,[f("th",{class:"left-column"},"Type"),f("th",null,"You can give blood to"),f("th",{class:"right-column"},"You can receive blood from")])],-1),HC={class:"left-column"},qC={class:"right-column"};function zC(t,e,n,s,i,r){return te(),ne("div",LC,[f("img",{src:i.imagePaths.bticon,alt:"Blood Type Icon"},null,8,UC),FC,$C,BC,f("div",VC,[f("table",null,[jC,f("tbody",null,[(te(!0),ne(Se,null,Co(i.tableData,(o,a)=>(te(),ne("tr",{key:a,class:Jn({"odd-row":a%2!==0})},[f("td",HC,We(o.column1),1),f("td",null,We(o.column2),1),f("td",qC,We(o.column3),1)],2))),128))])])])])}const KC=st(xC,[["render",zC]]),WC="/vitevue-project/assets/eli-icon-57593af7.png",GC="/vitevue-project/assets/eli-age-13cb64b7.png",QC="/vitevue-project/assets/eli-alcohol-0406a1fc.png",YC="/vitevue-project/assets/eli-gender-d6b663ad.png",JC="/vitevue-project/assets/eli-healthy-53da1207.png",XC="/vitevue-project/assets/eli-malaysia-f0bace01.png",ZC="/vitevue-project/assets/eli-sleep-6f387f38.png",ek="/vitevue-project/assets/eli-weight-ba7e910a.png",tk="/vitevue-project/assets/eli-woman-8394ab2a.png";const nk={data(){return{imagePaths:{eliicon:WC,age:GC,alcohol:QC,gender:YC,healthy:JC,malaysia:XC,sleep:ZC,weight:ek,woman:tk}}}},sk={class:"eligibility"},ik=["src"],rk=f("br",null,null,-1),ok=f("b",null,"Blood Donation Eligibility Requirements",-1),ak={class:"eli-table"},lk={style:{width:"50%"}},ck=["src"],uk=f("p",{class:"type"},"AGE",-1),hk=f("p",{class:"eli"},"18-60 years old",-1),dk=f("p",{class:"desp"},"*Parental consent required for 17 years old and below",-1),fk={style:{width:"50%"}},pk=["src"],gk=f("p",{class:"type"},"MEDICINE & ALCOHOL",-1),mk=f("p",{class:"eli"},"Alcohol-free",-1),yk=f("p",{class:"desp"},"Avoid consuming alcohol a day before donating",-1),vk=["src"],_k=f("p",{class:"type"},"HEALTHY",-1),wk=f("p",{class:"eli"},"Physical & mental",-1),Ek=f("p",{class:"desp"},"No chronic diseases",-1),bk=["src"],Ik=f("p",{class:"type"},"WEIGHT",-1),Tk=f("p",{class:"eli"},"> 45kg",-1),Ak=["src"],Sk=f("p",{class:"type"},"SUFFICIENT SLEEP",-1),Ck=f("p",{class:"eli"},"> 5 hours",-1),kk=f("p",{class:"desp"},"Donors must have at least five hours of sleep before donating",-1),Rk=["src"],Pk=f("p",{class:"type"},"RESIDING IN MALAYSIA",-1),Ok=f("p",{class:"eli"},"> 1 year",-1),Dk=f("p",{class:"desp"},"for non-Malaysians",-1),Nk=["src"],Mk=f("p",{class:"type"},"HIGH-RISK ACTIVITIES",-1),xk=f("p",{class:"eli"},"Do not engage",-1),Lk=f("p",{class:"desp"},"Do not use drugs or engage in sexual intercourse with many partners",-1),Uk=["src"],Fk=f("p",{class:"type"},"WOMEN",-1),$k=f("p",{class:"eli"},"Not pregnant or during menstrual cycle",-1),Bk=f("p",{class:"desp"},"including breastfeeding",-1);function Vk(t,e,n,s,i,r){return te(),ne("div",sk,[f("img",{src:i.imagePaths.eliicon,alt:"Eligibility Icon"},null,8,ik),rk,ok,f("table",ak,[f("tr",null,[f("td",lk,[f("img",{src:i.imagePaths.age,alt:"Age Icon"},null,8,ck),uk,hk,dk]),f("td",fk,[f("img",{src:i.imagePaths.alcohol,alt:"Alcohol free Icon"},null,8,pk),gk,mk,yk])]),f("tr",null,[f("td",null,[f("img",{src:i.imagePaths.healthy,alt:"Healthy Icon"},null,8,vk),_k,wk,Ek]),f("td",null,[f("img",{src:i.imagePaths.weight,alt:"Weight Icon"},null,8,bk),Ik,Tk])]),f("tr",null,[f("td",null,[f("img",{src:i.imagePaths.sleep,alt:"Sleep Icon"},null,8,Ak),Sk,Ck,kk]),f("td",null,[f("img",{src:i.imagePaths.malaysia,alt:"Malaysia Icon"},null,8,Rk),Pk,Ok,Dk])]),f("tr",null,[f("td",null,[f("img",{src:i.imagePaths.gender,alt:"Gender Icon"},null,8,Nk),Mk,xk,Lk]),f("td",null,[f("img",{src:i.imagePaths.woman,alt:"Woman Icon"},null,8,Uk),Fk,$k,Bk])])])])}const jk=st(nk,[["render",Vk]]),Hk="/vitevue-project/assets/perks-privilege-0e47030c.png";const qk={data(){return{tableData:[{column1:"1 time",column2:"Free outpatient treatment and medical treatment (excluding X-ray and surgical charges) and second class wards for a period of * 4 months."},{column1:"2 times (within 12 months)",column2:"Free Hepatitis B preventive injection."},{column1:"2 ~ 5 times",column2:"Free outpatient treatment and medical treatment and second class wards for a period of * 4 months."},{column1:"6 ~ 10 times",column2:"Free * year outpatient treatment and second class medical treatment for a * 6 months period."},{column1:"11 ~ 15 times",column2:"Free * 2 year outpatient treatment and second class medical treatment for a * 6 month period."},{column1:"16 ~ 20 times",column2:"Free outpatient treatment and medical treatment and second class wards for a * 2 year period."},{column1:"21 ~ 30 times",column2:"Free outpatient treatment and medical treatment and second class wards for a period of * 3 years."},{column1:"31 ~ 40 times",column2:"Free outpatient treatment and medical treatment and first class wards for a period of * 4 years."},{column1:"41 ~ 50 times",column2:"Free outpatient treatment and medical treatment and first class wards for a period of * 6 years."},{column1:'Over 50 times (for "Whole Blood") and Over 150 times (for aferesis donors)',column2:"Free outpatient treatment and first-class medical treatment and wards for 10 years and second-class wards of life after 10 years in first-class ward."}],imagePaths:{privileges:Hk}}}},zk={class:"perks"},Kk=["src"],Wk=f("br",null,null,-1),Gk=f("b",null,"Malaysian Blood Donor Privileges",-1),Qk=f("p",null,"There are many health benefits to donating blood and those who donate blood in Malaysia can benefit from many medical perks offered by the Ministry of Health:",-1),Yk={class:"perks-table"},Jk=f("thead",null,[f("tr",null,[f("th",{class:"left-column"},"Donation Frequency"),f("th",{class:"right-column"},"Medical Privileges")])],-1),Xk={class:"left-column"},Zk={class:"right-column"};function e2(t,e,n,s,i,r){return te(),ne("div",zk,[f("img",{src:i.imagePaths.privileges,alt:"Privilege Icon"},null,8,Kk),Wk,Gk,Qk,f("div",Yk,[f("table",null,[Jk,f("tbody",null,[(te(!0),ne(Se,null,Co(i.tableData,(o,a)=>(te(),ne("tr",{key:a,class:Jn({"odd-row":a%2!==0})},[f("td",Xk,We(o.column1),1),f("td",Zk,We(o.column2),1)],2))),128))])])])])}const t2=st(qk,[["render",e2]]),n2=O0({history:Wv(),scrollBehavior(t,e,n){return n||{top:0}},routes:[{path:"/home",component:fC},{path:"/home/organization",component:zS},{path:"/highlight",component:tm},{path:"/education",component:nm},{path:"/education/bloodtype",component:KC},{path:"/education/faq",component:NC},{path:"/education/eligibility",component:jk},{path:"/education/perks",component:t2},{path:"/campaign",component:wS}]}),im=kv(bC);im.use(n2);im.mount("#app");
